...
<head>
	...
	<!--
		...
		{
			document.myform.action = "ProductList.asp";
			document.myform.submit();
		}
...
<!-- // 레프트 메뉴 END   -->
		...
		<!-- 메인 컨텐츠 START -->
			<form name="myform" method="post" action="Productlist.asp">
			<input type="hidden" name="page" value="">
			<table width="580" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td class="main_first" align="center" style="padding-top:15px">
						<table width="550" cellpadding="0" cellspacing="0" border="0">
							<tr><td><img src="images/title_product_info.gif"></td></tr>
						...
						<table width="550" cellpadding="0" cellspacing="0" border="0">
												...
												<table width="100%" cellpadding="0" cellspacing="0" border="0">
													...
													<tr>
														<td align="right" style="padding:0,10px,10px,0">
															...
															<a href="./ProductDetail.asp?id=86&page=1"><img src="images/btn_detail.gif" border="0"></a>
												...
												<table width="100%" cellpadding="0" cellspacing="0" border="0">
													...
													<tr>
														<td align="right" style="padding:0,10px,10px,0">
															...
															<a href="./ProductDetail.asp?id=81&page=1"><img src="images/btn_detail.gif" border="0"></a>
												...
												<table width="100%" cellpadding="0" cellspacing="0" border="0">
													...
													<tr>
														<td align="right" style="padding:0,10px,10px,0">
															...
															<a href="./ProductDetail.asp?id=84&page=1"><img src="images/btn_detail.gif" border="0"></a>
												...
												<table width="100%" cellpadding="0" cellspacing="0" border="0">
													...
													<tr>
														<td align="right" style="padding:0,10px,10px,0">
															...
															<a href="./ProductDetail.asp?id=83&page=1"><img src="images/btn_detail.gif" border="0"></a>
							...
							<tr>
								<td bgcolor="#707070" height="42" align="center">
									...
									<a href="javascript:MovePage(11)"; ><img src="/Common/images/btn_list_04.gif" border="0" hspace="3" align="absmiddle"></a>
