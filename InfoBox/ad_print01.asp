...
<table width="585" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <table width="533" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td></td>
                <td colspan="2"><span style="color: #FF622C;">전국서비스센터 구축완료</span></td>
            </tr>
            <tr>
                <td></td>
                <td colspan="2">-모두들 나중에 해도 된다고 삽니다. 팬택&큐리델은 먼저 해야한다고 생각합니다.</td>
            </tr>
            <tr>
            ...
            <tr>
                <td></td>
                <td align="center" bgcolor="#E2E2E2" style="padding: 18, 19, 13, 20;"><img src="images/print_img02.jpg" border="0"><Br>
