    ...
    <tr>
        ...
        <td> 
          ...
          <table width="533" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr> 
              <td><img src="images/cf04_img01.gif" border="0" usemap="#cf01Map" width="533" height="208"></td>
            </tr>
            <tr> 
              <td><img src="images/cf04_img02.gif" width="533" height="248"></td>
            </tr>
            <tr> 
              <td><img src="images/cf04_img03.gif" width="533" height="298"></td>
            </tr>
            <tr> 
              <td><img src="images/cf04_img04.gif" width="533" height="371"></td>
            </tr>
            <tr> 
              <td height="23"></td>
            </tr>
          ...
          <map name="cf01Map"> 
            <area alt="" shape="CIRCLE" coords="446,171,21" href="javascript: history.back(-1);"onFocus="this.blur()">
            <area alt="" shape="CIRCLE" coords="465,108,31" href="images/adtitle/3dsound.mpg"onFocus="this.blur()">
          </map>
          <!-- 한줄답변보기 -->
        ...
        <table width="533" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td align="right" style="padding-right: 9px;"><span style="color: #FF622C;">15개</span>의 한줄답변이 있습니다. 
                <a href="./Ad_Cf04.asp?mode=viewComment#oneline"><img src="images/btn_view_line.gif" border="0" align="absmiddle"></a></td>
            </tr>
        </table>
        <!-- 한줄답변보기 -->
