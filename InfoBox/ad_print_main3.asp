        ...
        <!-- contents -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <table width="533" border="0" cellpadding="0" cellspacing="0">
                  <tr> 
                    <td align="center" width="125" bgcolor="#E2E2E2" height="165"><a href="ad_print01.asp"><img src="images/print_img02_s.gif" border="0"></a></td>
                    <td width="53"></td>
                    <td width="125" height="165" align="center" style="padding: 8, 0;">&nbsp;</td>
                    <td width="53"></td>
                    <td width="126" height="165" align="center" style="padding: 8, 0;">&nbsp;</td>
                    <td width="51"></td>
                  </tr>
                  <tr> 
                  ...
                  <tr> 
                    <td colspan="2"><span style="color: #FF622C;">전국서비스센터 구축완</span><br>
                      신문광고</td>
                    <td colspan="2">&nbsp;</td>
                    <td colspan="2">&nbsp;</td>
                  </tr>
                  ...
                  <tr> 
                    <td colspan="2"><a href="ad_print01.asp"><img src="images/btn_large_view.gif" border="0" align="absmiddle"></a> 
                      <img src="images/num01.gif" border="0" align="absmiddle"></td>
                    <td colspan="2">&nbsp;</td>
                    <td colspan="2">&nbsp;</td>
                  </tr>
                </table>
				<table width="533" border="0" cellpadding="0" cellspacing="0">
                  <tr> 
                    <td align="center" width="125" height="165">&nbsp;</td>
                    <td width="53"></td>
                    <td width="125" height="165" align="center" style="padding: 8, 0;">&nbsp;</td>
                    <td width="53"></td>
                    <td width="126" height="165" align="center" style="padding: 8, 0;">&nbsp;</td>
			...
			<tr> 
                    <td height="30" align="center" bgcolor="#999999"> <a href="ad_print_main2.asp"><img src="/Common/images/btn_list_02.gif" border="0" hspace="3" align="absmiddle"></a> 
                      &nbsp; <span style="color: #FF622C;"><a href="ad_print_main.asp">1</a></span> 
                      <a href="ad_print_main2.asp">2</a> <span style="color: #FF622C;">3</span>&nbsp; 
                      &nbsp;<img src="/Common/images/btn_list_03.gif" border="0" hspace="3" align="absmiddle"> 
                    </td>
            </tr>
			<tr>
			<td height="20">&nbsp; </td>
