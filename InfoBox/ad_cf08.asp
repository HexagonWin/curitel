    ...
    <tr>
        ...
        <td> 
          ...
          <table width="533" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr> 
              <td><img src="images/cf08_img01.gif" border="0" usemap="#cf01Map" width="533" height="169"></td>
            </tr>
            <tr> 
              <td><img src="images/cf08_img02.gif" width="533" height="156"></td>
            </tr>
            <tr> 
              <td><img src="images/cf08_img03.gif" width="533" height="170"></td>
            </tr>
            <tr> 
              <td><img src="images/cf08_img04.gif" width="533" height="229"></td>
            </tr>
            <tr> 
              <td><img src="images/cf08_img05.gif" width="533" height="270"></td>
            </tr>
			<tr> 
              <td><img src="images/cf08_img06.gif" width="533" height="234"></td>
            </tr>
			<tr> 
              <td><img src="images/cf08_img07.gif" width="533" height="244"></td>
            </tr>
			<tr> 
              <td><img src="images/cf08_img08.gif" width="533" height="276"></td>
            </tr>
			<tr> 
              <td><img src="images/cf08_img09.gif" width="533" height="204"></td>
            </tr>
            <tr>
              <td height="23"><img src="images/cf08_img10.gif" width="533" height="224"></td>
            </tr>
            <tr> 
              <td height="23"></td>
            </tr>
          ...
          <map name="cf01Map"> 
            <area alt="" shape="CIRCLE" coords="446,148,21" href="javascript: history.back(-1);"onFocus="this.blur()">
            <area alt="" shape="CIRCLE" coords="465,101,29" href="images/adtitle/cf_08.mpg"onFocus="this.blur()">
          </map>
          <!-- 한줄답변보기 -->
        ...
        <table width="533" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td align="right" style="padding-right: 9px;"><span style="color: #FF622C;">0개</span>의 한줄답변이 있습니다. 
                <a href="./Ad_Cf05.asp?mode=viewComment#oneline"><img src="images/btn_view_line.gif" border="0" align="absmiddle"></a></td>
            </tr>
        </table>
        <!-- 한줄답변보기 -->
...
<input type="hidden" name="comment_content">
        ...
        <map name="cf01">
            <area alt="" shape="CIRCLE" coords="466,101,25" href="images/adtitle/curitel_socool.mpg"onFocus="this.blur()">
        <area alt="" shape="CIRCLE" coords="446,152,17" href="javascript: history.back(-1);"onFocus="this.blur()">
        </map>
