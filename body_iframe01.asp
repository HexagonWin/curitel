  ...
  <tr> 
    <td width="142" valign="top"> 
      <table cellspacing=1 cellpadding=0 width=122 bgcolor=#d4d0c8 border=0>
        <tbody> 
        <tr> 
          <td valign=center bgcolor=#ffffff><img height=96 hspace=1 src="/UploadData/CharacterDownload/보아광고서있는.jpg" width=120 vspace=1 border=0></td>
        </tr>
        </tbody> 
      </table>
    </td>
    <td width="103">                                         
      <table cellspacing=0 cellpadding=0 width=103 border=0>
        ...
        <tr> 
          ...
          <td><a href="javascript:download('폼잡는윤도현')">폼잡는윤도현</a></td>
        </tr>
        
        <tr> 
          <td height=18><img src="images/renewal_sms1b.gif" align=absMiddle border=0></td>
          <td><a href="javascript:download('팬택앤큐리텔')">팬택앤큐리텔</a></td>
        </tr>
        
        <tr> 
          <td height=18><img src="images/renewal_sms1b.gif" align=absMiddle border=0></td>
          <td><a href="javascript:download('점프윤도현')">점프윤도현</a></td>
        </tr>
        
        <tr> 
          <td height=18><img src="images/renewal_sms1b.gif" align=absMiddle border=0></td>
          <td><a href="javascript:download('환하게웃는윤도현')">환하게웃는윤도</a></td>
        </tr>
        
        <tr> 
          <td height=18><img src="images/renewal_sms1b.gif" align=absMiddle border=0></td>
          <td><a href="javascript:download('윤도현얼굴')">윤도현얼굴</a></td>
        </tr>
