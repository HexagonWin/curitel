...
<head>
	...
	function submitto2(){	
	  ...
	  if (!IsValidSocNumber(SN)) {
		...
		if (!form.duo_id.value){
		  alert("듀오 아이디를 확인해주세요.");
		  selectAll(document.myform.duo_id);
		  return false;
	  }
		else if (form.email.value.indexOf("@hanmail.net") > -1 || form.email.value.indexOf("@daum.net") >-1) {
			alert ("당사는 e-Mail로 고객에 대해 각종 정보를 제공하고 있으나, \n"+
		...
		i = confirm('확인을 누르시면 큐리텔 아이디가 듀오에 전달되며 천생연분 이벤트이 신청됩니다.');
		
		if(i)
		{
			form.action="MemberJoin_save_duo.asp";
			form.submit();
		}
	}
	//-->
...
통해 가입가능합니다. </font>
							...
							<tr>
								...
								<td style="padding-top:6px;padding-left:5px"><input type="text" name="email" size="25" maxlength="25" value=""> <font color="#FF6C00">(한메일(hanmail)은 등록하실 수 없습니다.)</font></td>
							</tr>
							<tr>
                           ...
                           <select name="jobs" style="width:150px">
							...
							<tr>
								<td></td>
								<td><font color="#FF6C00">
								천생연분 이벤트에 참여하시겠습니까?<br>
								참여하시려면, 듀오 사이트에 가입후 듀오 ID를 아래에 적어주세요.<br>
								<a href="http://duo.duonet.com/join/join_announce.asp?u_div=curitel_21120" target="_blank"><b>듀오가입</b></a><br>
								</td>
							</tr>
							<tr>
								<td align="right"><b>듀오 ID</b>&nbsp;&nbsp;</td>
								<td><input type="text" name="duo_id"></td>
							</tr>
							...
							<tr>
								<td align="center" colspan="2"><img src="images/btn_ok.gif" border="0" style="cursor:hand" onclick="javascript:submitto2();">&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/btn_cancel_2.gif" border="0" style="cursor:hand" onclick="javascript:document.myform.reset();"></td>
							</tr>
						</table>
		<!-- middle 컨텐츠 END -->
					</td>
