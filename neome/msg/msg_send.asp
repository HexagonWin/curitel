...
<head>
	...
	<script language="javascript" src="msgCheck.js"></script>
				...
				<tr>
					...
					<td width="139" background="../img/bg_hmain_left.gif" valign="top">
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							...
							<tr>
								<td align="center">
								<select name=""><option value="">나의 네오미 클럽</select>
								</td>
							</tr>			
					...
					<td width="601" align="right" valign="top" background="../../asset/img/bgline_sub_right.gif">
						<table cellpadding="0" cellspacing="0" border="0" width="586">		
							<tr>
								<td height="21" align="right"><img src="../../asset/img/ico_arr_03.gif" width="3" height="5" border="0" hspace="3"><a href="javascript:GoMenu('home')">Home</a> / <a href="javascript:GoMenu('neome')">해피네오미</a> / <b>문자메세지</b>&nbsp;&nbsp;&nbsp;</td>
							</tr>
							<tr>
							...
							<tr>
								<td>									
									<table cellpadding="0" cellspacing="0" border="0" width="565">										
										...
										<tr>
											<td colspan="2"><img src="img/img_club_01.gif" width="220" height="127" border="0" ><img src="img/title_club_01.gif" width="329" height="50" border="0" align="absmiddle"></td>
										</tr>
										<tr><td height="40"></td></tr>																							
										<tr>
											<td height="1" bgcolor="#d9d2ca" colspan="2"><img src="img/spacer.gif" width="1" height="1" alt="" border="0"></td>
										</tr>		
										<tr><td height="16"></td></tr>																							
										<tr>
											<td width="162" valign="top">
<!--												<form name="frmMessage" method="post" action="sendOk.asp" onSubmit="return sendCheck(this);">-->
												<form name="frmMessage" method="post" action="http://211.117.63.187/sms_cp/adplus.asp" onSubmit="return sendCheck(this);">
												<table cellpadding="0" cellspacing="0" border="0" width="100%" background="img/spacer.gif">
													<tr>
														<td colspan="3"><img src="img/img_msg_01.gif" width="162" height="131" border="0" alt=""></td>
													</tr>	
													<tr>
														<td width="21"><img src="img/img_msg_04.gif" width="21" height="92" border="0" alt=""></td>
														<td width="119" background="img/bg_msg_hp01.gif" height="92" align="center">														
														<textarea cols="13" rows="4" name="msg" maxlength="80" style="width:100px;height:85px; border:solid 1 #000000;font-size:9pt;color:black;background-color:#96e51c"></textarea>
														</td>
														<td width="21"><img src="img/img_msg_05.gif" width="22" height="92" border="0" alt=""></td>
													</tr>
													<tr>
														<td colspan="3"><img src="img/img_msg_02.gif" width="162" height="60" border="0" alt=""></td>
													</tr>
													<tr>
														<td width="21"><img src="img/img_msg_06.gif" width="21" height="181" border="0" alt=""></td>
														<td bgcolor="#e5e5e5" valign="top" width="119">
															<table cellpadding="0" cellspacing="0" border="0" width="100%">																		
																<tr>
																	<td align="center" class="tk-blue05" height="50">모든 통신서비스 가능<br>(무료)</td>
																</tr>					
																<tr>
																	<td align="center" height="20" valign="bottom"><font color="#353140"><b>받는이 :</b></font></td>
																</tr>
																<tr>
																	<td align="center"><input type="text" size="10" style="border:solid 1;" name="dest" maxlength="11"></td>
																</tr>		
																<tr>
																	<td align="center" height="20" valign="bottom"><font color="#353140"><b>보내는이 :</b></font></td>
																</tr>
																<tr>
																	<td align="center"><input type="text" size="10" name="callback" maxlength="11" style="border:solid 1;"></td>
																</tr>	
																<tr>
																	<td align="center" height="35">
																	<input type="image" src="img/btn_send_02.gif" width="49" height="18" border="0" alt="">
																	<a href="javascript:fnReset();"><img src="img/btn_clear.gif" width="49" height="18" border="0" alt=""></a>
																	</td>
																</tr>																																																																	
															</table>	
														</td>
														<td width="21"><img src="img/img_msg_07.gif" width="21" height="181" border="0" alt=""></td>
													</tr>
													<tr>
														<td colspan="3"><img src="img/img_msg_03.gif" width="162" height="41" border="0" alt=""></td>
													</tr>		
												</table>
												</form>
											</td>
											<td width="403" valign="top">
												<table cellpadding="0" cellspacing="0" border="0" width="100%">
													<tr>
														<td colspan="2"><img src="img/text_msg_01.gif" width="326" height="31" alt="" border="0" hspace="15"></td>
													</tr>
													...
													<tr>
														<td width="50%" valign="top" align="right">
															<table cellpadding="0" cellspacing="0" border="0" width="188">
																<tr>
																	<td bgcolor="#ffb657" height="17" class="tk-brown02" colspan="3"><img src="../../asset/himg/ico_square_brown.gif" width="7" height="7" border="0" alt="" align="absmiddle" hspace="5">이모티콘</td>
																</tr>
																<tr>
																	<td bgcolor="#7f7f7f" height="1" colspan="3"><img src="img/spacer.gif" width="1" height="1" alt="" border="0"></td>
																</tr>
																<tr>
																	<td width="1" bgcolor="#7f7f7f"><img src="img/spacer.gif" width="1" height="1" alt="" border="0"></td>
																	<td width="186">
																		<table cellpadding="0" cellspacing="0" border="0" width="100%">
																			<tr>
																				<td bgcolor="#ececec" height="21"><img src="../../asset/img/ico_arr_05.gif" width="7" height="5" border="0" alt="" hspace="5"><a href="javascript:shortKey(0);">즐거운 주말</a></td>
																			</tr>
																			<tr>
																				<td bgcolor="#f7f7f7" height="21"><img src="../../asset/img/ico_arr_05.gif" width="7" height="5" border="0" alt="" hspace="5"><a href="javascript:shortKey(1);">미안해</a></td>
																			</tr>
																			<tr>
																				<td bgcolor="#ececec" height="21"><img src="../../asset/img/ico_arr_05.gif" width="7" height="5" border="0" alt="" hspace="5"><a href="javascript:shortKey(2);">밥사죠^^*</a>  </td>
																			</tr>
																			<tr>
																				<td bgcolor="#f7f7f7" height="21"><img src="../../asset/img/ico_arr_05.gif" width="7" height="5" border="0" alt="" hspace="5"><a href="javascript:shortKey(3)">엉덩이춤  </a>  </td>
																			</tr>
																			<tr>
																				<td bgcolor="#ececec" height="21"><img src="../../asset/img/ico_arr_05.gif" width="7" height="5" border="0" alt="" hspace="5"><a href="javascript:shortKey(4);">따랑해 </a>  </td>
																			</tr>
																			<tr>
																				<td bgcolor="#f7f7f7" height="21"><img src="../../asset/img/ico_arr_05.gif" width="7" height="5" border="0" alt="" hspace="5"><a href="javascript:shortKey(5);">별똥별</a>  </td>
																			</tr>
																		</table>
																	</td>
																	<td width="1" bgcolor="#7f7f7f"><img src="img/spacer.gif" width="1" height="1" alt="" border="0"></td>
														...
														<td width="50%" align="right">
															<table cellpadding="0" cellspacing="0" border="0" width="188">
																<tr>
																	<td bgcolor="#ffb657" height="17" class="tk-brown02" colspan="3"><img src="../../asset/himg/ico_square_brown.gif" width="7" height="7" border="0" alt="" align="absmiddle" hspace="5">유머</td>
																</tr>
																<tr>
																	<td bgcolor="#7f7f7f" height="1" colspan="3"><img src="img/spacer.gif" width="1" height="1" alt="" border="0"></td>
																</tr>
																<tr>
																	...
																	<td width="186">
																		<table cellpadding="0" cellspacing="0" border="0" width="100%">
																			<tr>
																				<td bgcolor="#ececec" height="21"><img src="../../asset/img/ico_arr_05.gif" width="7" height="5" border="0" alt="" hspace="5"><a href="javascript:shortKey(6);">압류영장</a>  </td>
																			</tr>
																			<tr>
																				<td bgcolor="#f7f7f7" height="21"><img src="../../asset/img/ico_arr_05.gif" width="7" height="5" border="0" alt="" hspace="5"><a href="javascript:shortKey(7);">문자씹지마</a></td>
																			</tr>
																			<tr>
																				<td bgcolor="#ececec" height="21"><img src="../../asset/img/ico_arr_05.gif" width="7" height="5" border="0" alt="" hspace="5"><a href="javascript:shortKey(8);">너 죽을 준비해!</a>  </td>
																			</tr>
																			<tr>
																				<td bgcolor="#f7f7f7" height="21"><img src="../../asset/img/ico_arr_05.gif" width="7" height="5" border="0" alt="" hspace="5"><a href="javascript:shortKey(9);">나 미칠 것 같아</a>  </td>
																			</tr>
																			<tr>
																				<td bgcolor="#ececec" height="21"><img src="../../asset/img/ico_arr_05.gif" width="7" height="5" border="0" alt="" hspace="5"><a href="javascript:shortKey(10);">너무해 </a>  </td>
																			</tr>
																			<tr>
																				<td bgcolor="#f7f7f7" height="21"><img src="../../asset/img/ico_arr_05.gif" width="7" height="5" border="0" alt="" hspace="5"><a href="javascript:shortKey(11);">쌍코피</a></td>
																			</tr>
																		</table>
																	</td>
																	<td width="1" bgcolor="#7f7f7f"><img src="img/spacer.gif" width="1" height="1" alt="" border="0"></td>
													...
													<tr>
														<td width="50%" valign="top" align="right">
															<table cellpadding="0" cellspacing="0" border="0" width="188">
																<tr>
																	<td bgcolor="#ffb657" height="17" class="tk-brown02" colspan="3"><img src="../../asset/himg/ico_square_brown.gif" width="7" height="7" border="0" alt="" align="absmiddle" hspace="5">사랑</td>
																</tr>
																<tr>
																	<td bgcolor="#7f7f7f" height="1" colspan="3"><img src="img/spacer.gif" width="1" height="1" alt="" border="0"></td>
																</tr>
																<tr>
																	...
																	<td width="186">
																		<table cellpadding="0" cellspacing="0" border="0" width="100%">
																			<tr>
																				<td bgcolor="#ececec" height="21"><img src="../../asset/img/ico_arr_05.gif" width="7" height="5" border="0" alt="" hspace="5"><a href="javascript:shortKey(12);">백조탈출</a></td>
																			</tr>
																			<tr>
																				<td bgcolor="#f7f7f7" height="21"><img src="../../asset/img/ico_arr_05.gif" width="7" height="5" border="0" alt="" hspace="5"><a href="javascript:shortKey(13);">사랑해.. </a> </td>
																			</tr>
																			<tr>
																				<td bgcolor="#ececec" height="21"><img src="../../asset/img/ico_arr_05.gif" width="7" height="5" border="0" alt="" hspace="5"><a href="javascript:shortKey(14);">다운로드</a>  </td>
																			</tr>
																			<tr>
																				<td bgcolor="#f7f7f7" height="21"><img src="../../asset/img/ico_arr_05.gif" width="7" height="5" border="0" alt="" hspace="5"><a href="javascript:shortKey(15);">잠자는 중 </a>  </td>
																			</tr>
																			<tr>
																				<td bgcolor="#ececec" height="21"><img src="../../asset/img/ico_arr_05.gif" width="7" height="5" border="0" alt="" hspace="5"><a href="javascript:shortKey(16);">나의마음도.. </a>  </td>
																			</tr>
																			<tr>
																				<td bgcolor="#f7f7f7" height="21"><img src="../../asset/img/ico_arr_05.gif" width="7" height="5" border="0" alt="" hspace="5"><a href="javascript:shortKey(17);">뽀뽀</a>  </td>
																			</tr>
																			<!-- <tr>
																				<td bgcolor="#ececec" height="21"><img src="../../asset/img/ico_arr_05.gif" width="7" height="5" border="0" alt="" hspace="5"><a href="javascript:shortKey(18);">키싱구라미</a>  </td>
																			</tr> -->
																		</table>
																	</td>
																	<td width="1" bgcolor="#7f7f7f"><img src="img/spacer.gif" width="1" height="1" alt="" border="0"></td>
														...
														<td width="50%" align="right" valign="top">
															<table cellpadding="0" cellspacing="0" border="0" width="188">
																<tr>
																	<td bgcolor="#ffb657" height="17" class="tk-brown02" colspan="3"><img src="../../asset/himg/ico_square_brown.gif" width="7" height="7" border="0" alt="" align="absmiddle" hspace="5">기타</td>
																</tr>
																<tr>
																	<td bgcolor="#7f7f7f" height="1" colspan="3"><img src="img/spacer.gif" width="1" height="1" alt="" border="0"></td>
																</tr>
																<tr>
																	...
																	<td width="186" >
																		<table cellpadding="0" cellspacing="0" border="0" width="100%">
																			<tr>
																				<td bgcolor="#ececec" height="21"><img src="../../asset/img/ico_arr_05.gif" width="7" height="5" border="0" alt="" hspace="5"><a href="javascript:shortKey(19);">마무리</a>  </td>
																			</tr>
																			<tr>
																				<td bgcolor="#f7f7f7" height="21"><img src="../../asset/img/ico_arr_05.gif" width="7" height="5" border="0" alt="" hspace="5"><a href="javascript:shortKey(20);">너만을</a>  </td>
																			</tr>
																			<tr>
																				<td bgcolor="#ececec" height="21"><img src="../../asset/img/ico_arr_05.gif" width="7" height="5" border="0" alt="" hspace="5"><a href="javascript:shortKey(21);">펭귄줄다리기</a>  </td>
																			</tr>
																			<tr>
																				<td bgcolor="#f7f7f7" height="21"><img src="../../asset/img/ico_arr_05.gif" width="7" height="5" border="0" alt="" hspace="5"><a href="javascript:shortKey(22);">떡볶이 </a></td>
																			</tr>
																			<tr>
																				<td bgcolor="#ececec" height="21"><img src="../../asset/img/ico_arr_05.gif" width="7" height="5" border="0" alt="" hspace="5"><a href="javascript:shortKey(23);">이별은 무엇일까</a></td>
																			</tr>
																			<tr>
																				<td bgcolor="#f7f7f7" height="21"><img src="../../asset/img/ico_arr_05.gif" width="7" height="5" border="0" alt="" hspace="5"><a href="javascript:shortKey(24);">김남주 </a></td>
																			</tr>
																		</table>
																	</td>
																	<td width="1" bgcolor="#7f7f7f"><img src="img/spacer.gif" width="1" height="1" alt="" border="0"></td>
...
<map name="msg01">
<area alt="" coords="18,11,71,32" href="#" shape="RECT">
<area alt="" coords="123,11,72,32" href="#" shape="RECT">
</map>
