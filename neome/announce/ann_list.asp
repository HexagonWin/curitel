				...
				<tr>
					...
					<table  height="21" border="0" cellspacing="0" cellpadding="0" bgcolor="#c7c7c7">
						<tr>
							...
							<td><a href="javascript:GoMenu('notify')" onmouseover="MM_swapImage('document.layers[\'about1\'].document.c7','document.c7','../../asset/subimg/c_sub_07_on.gif')" onmouseout="MM_swapImage('document.layers[\'about1\'].document.c7','document.c7','../../asset/subimg/c_sub_07_off.gif')">
				...
				<tr>
							...
							<tr>
								...
								<td align="center">
									<table cellpadding="0" cellspacing="0" border="0" width="127">
										...
										<tr><td height="10"></td></tr>
										<tr>
											<td colspan="2" class="tk-red02" align="center"><a href="../memb/memb_ag.asp">[회원가입]</a> <a href="../idpwd_pop.html" onclick="javascript:winopen()" target="box">[ID,PW분실]</a></td>
										</tr>										
									</table>
								</td>
					...
					<td width="601" align="right" valign="top" background="../../asset/img/bgline_sub_right.gif">
						<table cellpadding="0" cellspacing="0" border="0" width="586">		
							<tr>
								<td height="21" align="right"><img src="../../asset/img/ico_arr_03.gif" width="3" height="5" border="0" hspace="3"><a href="javascript:GoMenu('home')">Home</a> / <a href="javascript:GoMenu('neome')">해피네오미</a> / <b>공지사항</b>&nbsp;&nbsp;&nbsp;</td>
							</tr>
							<tr>
							...
							<tr>
								<td>									
									<table cellpadding="0" cellspacing="0" border="0" width="565">
										<tr>
											<td><img src="img/img_ann_01.gif" width="220" height="122" border="0" alt=""><img src="img/title_ann_01.gif" width="314" height="64" border="0" align="absmiddle"></td>
										</tr>
										...
										<form name="frmBoardSch" action="ann_list_sch.asp" method="post" onSubmit="return boardSearch(this);">
										<tr>
											<td align="right">
												...
												<input type="image" src="../../asset/img/btn_go.gif" width="30" height="17" border="0" alt="">
												<input type="hidden" name="start" value="y">
												<input type="hidden" name="csRP" value="ann_list">
												  ...
												  <tr>
												  	<td bgcolor="#ffffff">
														<table border="0" cellpadding="0" cellspacing="0" width="100%">
															<tr bgcolor="#ffb657" align="center">
																<td height="27" class="tk-white" width="83"><b>번호</b></td>
																<td width="1" bgcolor="#ffffff" rowspan="99"><img src="img/spacer.gif" width="1" height="1" alt="" border="0"></td>
																<td height="27" class="tk-white" width="100"><b>날짜</b></td>
																<td width="1" bgcolor="#ffffff" rowspan="99"><img src="img/spacer.gif" width="1" height="1" alt="" border="0"></td>
																<td class="tk-white" width="300"><b>제목</b></td>
																<td width="1" bgcolor="#ffffff" rowspan="99"><img src="img/spacer.gif" width="1" height="1" alt="" border="0"></td>	
																<td class="tk-white" width="80"><b>조회</b></td>																
															</tr>


																	<tr height=24 align=center bgcolor="#ececec" 
																		onMouseOver="this.style.backgroundColor='#fcefcf'" onMouseOut="this.style.backgroundColor=''">
																		<td height="27" width="83">10</td>
																		<td height="27" width="100">&nbsp;2001-11-27</td>
																		<td width="300">

																				<a href="ann_list.asp?job=view&iIdx=28&page=1&csRP=ann_list">
																					<무서운 영화2 > 시사회 당첨자 발표!!!
																				</a>
																	...
																	<tr height=24 align=center bgcolor="#f7f7f7" 
																		onMouseOver="this.style.backgroundColor='#fcefcf'" onMouseOut="this.style.backgroundColor=''">
																		<td height="27" width="83">9</td>
																		<td height="27" width="100">&nbsp;2001-11-19</td>
																		<td width="300">

																				<a href="ann_list.asp?job=view&iIdx=25&page=1&csRP=ann_list">
																					<와니와 준하> 시사회 당첨자 발표!!!
																				</a>
																	...
																	<tr height=24 align=center bgcolor="#ececec" 
																		onMouseOver="this.style.backgroundColor='#fcefcf'" onMouseOut="this.style.backgroundColor=''">
																		<td height="27" width="83">8</td>
																		<td height="27" width="100">&nbsp;2001-10-08</td>
																		<td width="300">

																				<a href="ann_list.asp?job=view&iIdx=24&page=1&csRP=ann_list">
																					오픈 이벤트 당첨을 축하드립니다.
																				</a>
																	...
																	<tr height=24 align=center bgcolor="#f7f7f7" 
																		onMouseOver="this.style.backgroundColor='#fcefcf'" onMouseOut="this.style.backgroundColor=''">
																		<td height="27" width="83">7</td>
																		<td height="27" width="100">&nbsp;2001-10-04</td>
																		<td width="300">

																				<a href="ann_list.asp?job=view&iIdx=23&page=1&csRP=ann_list">
																					<킬러들의 수다> 시사회 당첨자 발표!!!
																				</a>
														...
														<table border="0" cellpadding="0" cellspacing="0" width="100%">
															<tr>
																<td align="center"><span class="tk-bk02">
																		...
																		<img src="../../asset/himg/btn_back_01.gif" width="22" height="18" border="0" alt="이전 2 pages" align="absmiddle">
																	...
																	&nbsp;&nbsp;&nbsp;
																			...
																			<a href="ann_list.asp?page=2"><font size=2>2</font></a>&nbsp;

																	&nbsp;&nbsp;&nbsp;
																		

																		<a href="ann_list.asp?page=2"><img src="../../asset/himg/btn_next_02.gif" width="43" height="18" border="0" alt="2" align="absmiddle"></a>

																		<a href="ann_list.asp?page=3&csRP=ann_list" title="이후 2 pages"><img src="../../asset/himg/btn_next_01.gif" width="22" height="18" border="0" alt="이후 2 pages" align="absmiddle"></a>
...
<map name="tab1">
<area alt="" coords="1,0,94,17"  shape="RECT" href="paper_send.html">
<area alt="" coords="95,0,203,16"  shape="RECT">
<area alt="" coords="204,0,293,17" href="send_box.html" shape="RECT">
</map>
