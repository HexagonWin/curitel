	...
	<table border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td><OBJECT classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0" WIDTH="197" HEIGHT="513" id="Untitled-2" ALIGN="top">
					<PARAM NAME=movie VALUE="/Common/menu/menu_curitel_zone_before1.swf">
					<PARAM NAME=quality VALUE=high>
					<PARAM NAME=salign VALUE=T>
					<PARAM NAME=bgcolor VALUE=#FFFFFF>
					<EMBED src="/Common/menu/menu_curitel_zone_before1.swf" quality=high salign=T  WIDTH="197" HEIGHT="513" NAME="Untitled-2" ALIGN="top"
					TYPE="application/x-shockwave-flash" PLUGINSPAGE="http://www.macromedia.com/go/getflashplayer" bgcolor=#FFFFFF></EMBED>
				</OBJECT></td>
		</tr>
	</table>
...
<!-- // 레프트 메뉴 END -->
	...
	<meta http-equiv='refresh' content="0; url=/Footer/Login.asp?REQUEST_METHOD=GET&
file=/opinionleader/opinion.asp&GetQueryStr=&oriReferer=">