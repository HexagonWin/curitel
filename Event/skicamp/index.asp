    ...
    <td align="center"><table border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="780"><table width="780" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td><img src="images/ski_main_01.gif" width="780" height="111" border="0"></td>
              </tr>
              <tr>
                <td><img src="images/ski_main_02.gif" width="780" height="246" border="0" usemap="#Map3"></td>
              </tr>
              <tr>
                <td><img src="images/ski_main_03.gif" width="780" height="244"></td>
              </tr>
              <tr>
                <td><img src="images/ski_main_04.gif" width="780" height="276"></td>
              </tr>
              <tr>
                <td><img src="images/ski_main_05.gif" width="780" height="253"></td>
              </tr>
			  <tr>
                <td><img src="images/ski_main_06.gif" width="780" height="176"></td>
              </tr>
              <tr>
                <td><img src="images/ski_footer.gif" width="780" border="0" usemap="#Map2"></td>
              </tr>
            </table></td>
          <td width="35" valign="top" background="images/ski_right_bg.gif"> <div id=divMenu style="Z-INDEX: 2; LEFT: 0px; WIDTH: 35; POSITION: relative; TOP: 0px; HEIGHT: 522px"> 
              <table border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <td valign="top"><a href="javascript:chk_coupon();"><img src="images/ski_btn_06.gif" width="35" border="0"></a></td>
                </tr>
                <tr> 
...
<map name="Map2">
  <area shape="rect" coords="258,16,339,74" href="/curitelzone">
  <area shape="rect" coords="179,16,257,74" href="/InfoBox">
  <area shape="rect" coords="93,15,179,76" href="/mycuritel">
  <area shape="rect" coords="340,18,420,75" href="/PhoneDeco">
</map>
<map name="Map3">
  <area shape="circle" coords="666,72,59" href="javascript:chk_id();">
  <area shape="rect" coords="322,77,444,101" href="http://www.pineresort.com" target="_blank">
</map>
</BODY>
</HTML>
<SCRIPT language=javascript>
