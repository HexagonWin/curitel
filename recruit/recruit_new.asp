...
<script language="javascript" src="autoJumin.js"></script>
<script language="javascript" src="../totalcheck.js"></script>
<script language="javascript" src="verify.js"></script></script>
...
<body topmargin="25" leftmargin="0" marginheight="25" marginwidth="0" bgcolor="#ffffff" onload="preloadImages(); document.all.jumin1.focus();">
<center>
...
<form method="post" name="frmSearch" action="../search/query.asp" onSubmit="return searchCheck(this);">
<tr>
...
<tr>
<td><img src="img/i_roll_03_on.gif" width="139" height="22" border="0"  name="r3"></td>
</tr>
<tr>
...
<tr>
<td height="21" align="right"><img src="../asset/img/ico_arr_03.gif" width="3" height="5" border="0" hspace="3"><a href="javascript:GoMenu('home')">Home</a> / <a href="javascript:GoMenu('reintro')">채용정보</a> / <b>온라인 지원</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
</tr>
<tr>
...
<tr>
<td colspan="5"><img src="img/img_recruit_01.gif" width="205" height="120" border="0" alt=""><img src="img/title_recruit_01.gif" width="337" height="91" border="0" align="absbottom"></td>
</tr>
...
<tr bgcolor="#e9e9e9">
<td  height="22"><img src="img/text_recruit_01.gif" width="73" height="13" border="0" alt="" hspace="7"></td>
</tr>
</table>
</td>
</tr>
<tr><td height="16" ><img src="img/spacer.gif" width="1" height="1"  border="0"></td></tr>
<tr>
<td class="tk">주민등록번호, 비밀번호(4~8자리 이내)를 기입하고 “지원서 작성”버튼을 누르십시요.<br>
지원서 작성시 기입된 비밀번호는 수정/전형결과 확인시 이용되므로 기억하시기 바랍니다.</td>
</tr>
<tr><td height="26"></td></tr>
<tr>
<td bgcolor="#999999">
<table cellpadding="0" cellspacing="1" border="0" width="100%">
<form method="post" name="frmVerify" action="recruit_new.asp" onSubmit="return verifyCheck(this);">
<tR bgcolor="#95B9DF">
<td class="tk-blue03" height="25" >&nbsp;</td>
</tr>
<tr>
<td bgcolor="#ffffff" align="center">
<table cellpadding="3" cellspacing="1" border="0" width="100%">
<tr bgcolor="#ECECEC" >
<td class="tk" width="150">&nbsp;&nbsp;<b>주민등록번호</b></td>
<td bgcolor="#f7f7f7">
<input type="text" name="jumin1" size="9" maxlength="6" onKeyUp="return autoTab(this, 6, event);"> -
<input type="text" name="jumin2" size="9" maxlength="7" onKeyUp="return autoTab(this, 7, event)">
</td>
</tr>
<tr bgcolor="#ECECEC" >
<td class="tk" width="150">&nbsp;&nbsp;<b>비밀번호</b></td>
<td bgcolor="#f7f7f7"><input type="password" name="pw" size="15" maxlength="10"></td>
</tr>
</table>
</td>
</tr>
<tr bgcolor="#B5D2F1"><!--          <a href="recruit_ip.html"><img src="../asset/img/btn_recruit.gif" width="104" height="18" alt="" border="0"></a>-->
<td  height="25" align="center"><input type="image" src="../asset/img/btn_recruit.gif" width="104" height="18" alt="" border="0"><input type="hidden" name="job" value="v"></td>
</tr>
</form>
</table>
