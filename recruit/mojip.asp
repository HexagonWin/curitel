				...
				<tr>
					...
					<td width="139" background="../asset/img/bg_sub_left.gif" valign="top">					
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							...
							<tr>
								<td><img src="img/i_roll_01_on.gif" width="139" height="23" border="0"  name="r1"></td>
							</tr>
							<tr>
					...
					<td width="601" align="right" valign="top" background="../asset/img/bgline_sub_right.gif">
						<table cellpadding="0" cellspacing="0" border="0" width="586">
							<tr>
								<td height="21" align="right"><img src="../asset/img/ico_arr_03.gif" width="3" height="5" border="0" hspace="3"><a href="javascript:GoMenu('home')">Home</a> / <a href="javascript:GoMenu('reintro')">채용정보</a> / <b>모집공고</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
							</tr>
							<tr>
							...
							<tr>
								<td>									
									<table cellpadding="0" cellspacing="0" border="0" width="565">														
										<tr>
											<td colspan="9"><img src="img/img_noti_01.gif" width="203" height="115" border="0" ><img src="img/title_noti_01.gif" width="274" height="65" border="0" align="absmiddle"></td>
										</tr>
										...
										<tr>
											<td bgcolor="#6d6e71">
												<table border="0" cellpadding="0" cellspacing="1" width="100%">
												  <tr bgcolor="#e9e9e9">
												  	<td  height="22"><img src="img/txt_mojip.gif" width="69" height="13" hspace="10" border="0" ></td>
												  </tr>									 
												</table>
											</td>
										</tr>	
													...
													<tr>
														<td bgcolor="#ffffff" align="center">
															<table cellpadding="0" cellspacing="0" border="0" width="100%">
																...
																<form name="frmMojip" action="mojip_sch.asp" method="post" onSubmit="return boardSearch(this);">
																<tr>
																	<td align="right" height="33">
																		...
																		<input type="hidden" name="csRP" value="mojip">
																	...
																	<td>
																		<table cellpadding="0" cellspacing="0" border="0" width="100%">
																			<tr align="center" bgcolor="#ececec">
																				<td width="60" height="25"><b>No.</b></td>
																				<td width="1" rowspan="99" bgcolor="#ffffff"><img src="img/spacer.gif" width="1" height="1" border="0"></td> 
																				<td width="381"><b>제목</b></td>
																				<td width="1" rowspan="99" bgcolor="#ffffff"><img src="img/spacer.gif" width="1" height="1"  border="0"></td>
																				<td width="80" height="25"><b>마감일</b></td>
																				<td width="1" rowspan="99" bgcolor="#ffffff"><img src="img/spacer.gif" width="1" height="1"  border="0"></td>
																				<td width="80"><b>조회수</b></td>																				
																					...
																					onMouseOver="this.style.backgroundColor='#f3f6fd'" onMouseOut="this.style.backgroundColor=''">
																						...
																						<td width="382">
																								...
																								<a href="mojip.asp?job=view&iIdx=19&page=1&csRP=mojip">
																								PM 담당자[경력]를 모십니다</a>

																						</td>
																						<td width="80" height="25" align="center">2002-8-17</td>
																						<td width="80"><font size=2>134</font></td>
<!--																					<td width="40"><input type=checkbox name=chkDel value="19"></td>-->
																					</tr>
																					...
																					onMouseOver="this.style.backgroundColor='#f3f6fd'" onMouseOut="this.style.backgroundColor=''">
																						...
																						<td width="382">
																								...
																								<a href="mojip.asp?job=view&iIdx=18&page=1&csRP=mojip">
																								연구개발직 [외주모델개발  S/W ] 경력사원을 모십니다</a>

																						</td>
																						<td width="80" height="25" align="center">2002-08-15</td>
																						<td width="80"><font size=2>401</font></td>
<!--																					<td width="40"><input type=checkbox name=chkDel value="18"></td>-->
																					</tr>
																					...
																					onMouseOver="this.style.backgroundColor='#f3f6fd'" onMouseOut="this.style.backgroundColor=''">
																						...
																						<td width="382">
																								...
																								<a href="mojip.asp?job=view&iIdx=17&page=1&csRP=mojip">
																								교육 / 인사  경력사원 모집</a>

																						</td>
																						<td width="80" height="25" align="center">2002-08-15</td>
																						<td width="80"><font size=2>970</font></td>
<!--																					<td width="40"><input type=checkbox name=chkDel value="17"></td>-->
																					</tr>
																					...
																					onMouseOver="this.style.backgroundColor='#f3f6fd'" onMouseOut="this.style.backgroundColor=''">
																						...
																						<td width="382">
																								...
																								<a href="mojip.asp?job=view&iIdx=16&page=1&csRP=mojip">
																								SVC center A/S관리/ 수리기사 모집 [서울/부산/광주]</a>

																						</td>
																						<td width="80" height="25" align="center">마감</td>
																						<td width="80"><font size=2>303</font></td>
<!--																					<td width="40"><input type=checkbox name=chkDel value="16"></td>-->
																					</tr>
															...
															<tr>
																<td align="center"><span class="tk-bk02">
																	...
																	&nbsp;&nbsp;&nbsp;
																			...
																			<a href="mojip.asp?page=2"><font size=2>2</font></a>&nbsp;

																			<a href="mojip.asp?page=3"><font size=2>3</font></a>&nbsp;

																			<a href="mojip.asp?page=4"><font size=2>4</font></a>&nbsp;

																			<a href="mojip.asp?page=5"><font size=2>5</font></a>&nbsp;

																	&nbsp;&nbsp;&nbsp;


																		<a href="mojip.asp?page=2"><img src="../asset/img/btn_nextblue_02.gif" width="43" height="18" border="0" alt="2" align="absmiddle"></a>
