...
<!----------------------------------------------------------------------------------------------------->
										...
										<tr>
											<td colspan="5">
												<table cellpadding="0" cellspacing="0" border="0" width="100%">
													<tr>								
														<td width="96"><img src="img/img_re_intro02.gif" width="96" height="92" border="0" ></td>
														<td width="10" bgcolor="#f1f1f1"><img src="img/spacer.gif" width="1" height="1"  border="0"></td>			
														<td width="459" bgcolor="#f1f1f1" valign="top">
															<table cellpadding="0" cellspacing="0" border="0" width="100%">
																<tr><td height="5"></td></tr>
																<tr>
																	<td height="18">&nbsp;<img src="../asset/img/ico_dot.gif" width="2" height="4" border="0" >

																        <a href="re_intro2.asp?iIdx=37&job=view"><b>신입사원 교육일정 관련 안내[필독]</b></a>
																	</td>
																</tr>
																<tr>
																	<td background="../asset/img/bg_dot_gr02.gif" height="1"><img src="img/spacer.gif" width="1" height="1"  border="0"></td>
																</tr>
																<tr><td height="5"></td></tr>
																<tr>
<!--																	<td>대한민국을 사랑하고 축구를 사랑하는 팬택계열 예비 신입사원 여러분 이번 대한민국의 4강진출과 관련하여 국가가 지정한 7월1일 휴무와 관련해서 많은 분들이 이번 팬택계열의 신입사원 연수일정에 변동이 있느냐는 질문을 많이 해오십니다. <br>(주)팬택과 (주)큐리텔...</td>-->
																		<td>대한민국을 사랑하고 축구를 사랑하는 팬택계열 예비 신입사원 여러분 이번 대한민국의 4강진출과 관련하여 국가가 지정한 7월1일 휴무와 관련해서 많은 분들이 이번 팬택계열의 신입사원 연수일정에 변동이 있느냐는 질문을 많이...</td>
																</tr>			
															</table>
														</td>							
													</tr>	
													...
													<tr>
														<td colspan="2" rowspan="2"><img src="img/spacer.gif" width="1" height="1"  border="0"></td>
														<td height="20">&nbsp;<img src="../asset/img/ico_dot.gif" width="2" height="4" border="0" >
															<a href="re_intro2.asp?iIdx=36&job=view">[06/23]</b> (주)큐리텔 신입사원 입사안내</a>
														</td>
													</tr>			
													<tr>
														<td background="../asset/img/bg_dot_gr02.gif" height="1"><img src="img/spacer.gif" width="1" height="1"  border="0"></td>
													...
													<tr>
														<td colspan="2" rowspan="2"><img src="img/spacer.gif" width="1" height="1"  border="0"></td>
														<td height="20">&nbsp;<img src="../asset/img/ico_dot.gif" width="2" height="4" border="0" >
															<a href="re_intro2.asp?iIdx=35&job=view">[06/12]</b> (주)팬택 (주)큐리텔  신입사원 채용검진 안내</a>
														</td>
													</tr>			
													<tr>
														<td background="../asset/img/bg_dot_gr02.gif" height="1"><img src="img/spacer.gif" width="1" height="1"  border="0"></td>
													...
													<tr>
														<td colspan="2" rowspan="2"><img src="img/spacer.gif" width="1" height="1"  border="0"></td>
														<td height="20">&nbsp;<img src="../asset/img/ico_dot.gif" width="2" height="4" border="0" >
															<a href="re_intro2.asp?iIdx=34&job=view">[06/03]</b> 교육 / 인사 경력사원 모집</a>
														</td>
													</tr>			
													<tr>
														<td background="../asset/img/bg_dot_gr02.gif" height="1"><img src="img/spacer.gif" width="1" height="1"  border="0"></td>
													...
													<tr>
														<td colspan="2" rowspan="2"><img src="img/spacer.gif" width="1" height="1"  border="0"></td>
														<td height="20">&nbsp;<img src="../asset/img/ico_dot.gif" width="2" height="4" border="0" >
															<a href="re_intro2.asp?iIdx=33&job=view">[05/31]</b> SVC센타 A/S관리 및 SVC repair 기사 모집 [서울/부산/광주]</a>
														</td>
													</tr>			
													<tr>
														<td background="../asset/img/bg_dot_gr02.gif" height="1"><img src="img/spacer.gif" width="1" height="1"  border="0"></td>
										...
										<!-- 인사복지제도 -->
											<td width="177" valign="top">
												<table cellpadding="0" cellspacing="0" border="0" width="100%">
													<tr>
														<td bgcolor="#336699" rowspan="4" width="1"><img src="img/spacer.gif" width="1" height="1"  border="0"></td>
														<td height="123" valign="top" align="center"><img src="img/img_info_02.gif" width="175" height="103" border="0" alt=""></td>
														<td bgcolor="#336699" rowspan="4" width="1"><img src="img/spacer.gif" width="1" height="1"  border="0"></td>
													</tr>										
													<tr>
														<td align="center" valign="top">
															<table cellpadding="0" cellspacing="0" border="0" width="150" background="img/spacer.gif">													
																<tr>
																	<td height="120" valign="top" class="tk">임직원들이 보람과 긍지를 가지고 업무에 전념할 수 있도록 사내 커뮤니케이션을 활성화하고 모든 제도를 전향적으로 개선해 나가고 있습니다. </td>
																</tr>																
															</table>
														</td>
													</tr>	
													<tr>
														<td align="right" height="20" valign="top"><a href="javascript:GoMenu('person')"><img src="../asset/img/btn_more.gif" width="36" height="13" border="0"  hspace="15"></a></td>
													</tr>									
													<tr>
														<td height="1" bgcolor="#336699"><img src="img/spacer.gif" width="1" height="1"  border="0"></td>
													</tr>
												</table>
											</td>
											<td width="17"><img src="img/spacer.gif" width="1" height="1"  border="0"></td>
											<!-- 상시채용 -->
											<td width="177" valign="top">
												<table cellpadding="0" cellspacing="0" border="0" width="100%">
													<tr>
														<td bgcolor="#336699" rowspan="4" width="1"><img src="img/spacer.gif" width="1" height="1"  border="0"></td>
														<td height="123" valign="top" align="center"><img src="img/img_info_03.gif" width="175" height="103" border="0" alt=""></td>
														<td bgcolor="#336699" rowspan="4" width="1"><img src="img/spacer.gif" width="1" height="1"  border="0"></td>
													</tr>										
													<tr>
														<td align="center" valign="top">
															<table cellpadding="0" cellspacing="0" border="0" width="150" background="img/spacer.gif">													
																<tr>
																	<td height="120" valign="top" class="tk">
																		국내·외 우수 인재를 확보하기 위해 년중 상시 채용을 하고 있습니다.
																	</td>
																</tr>																
															</table>
														</td>
													...
													<tr>
														<td align="right" height="20" valign="top"><a href="javascript:GoMenu('guide')"><img src="../asset/img/btn_more.gif" width="36" height="13" border="0"  hspace="15"></a></td>
													</tr>										
													<tr>
														<td height="1" bgcolor="#336699"><img src="img/spacer.gif" width="1" height="1"  border="0"></td>
													</tr>
											...
											<td width="177" valign="top">
												<table cellpadding="0" cellspacing="0" border="0" width="100%">
													<tr>
														<td bgcolor="#336699" rowspan="4" width="1"><img src="img/spacer.gif" width="1" height="1"  border="0"></td>
														<td height="123" valign="top" align="center"><img src="img/img_info_04.gif" width="175" height="103" border="0" alt=""></td>
														<td bgcolor="#336699" rowspan="4" width="1"><img src="img/spacer.gif" width="1" height="1"  border="0"></td>
													</tr>										
													<tr>
														<td align="center" valign="top">
															<table cellpadding="0" cellspacing="0" border="0" width="150" background="img/spacer.gif">													
																<tr>
																	<td height="120" valign="top" class="tk">신입/경력 인력 채용방식은 수시 충원입니다. 입사지원시 입력되는 모든 정보는 <br>큐리텔 채용관련 목적에 사용됩니다.</td>
																</tr>																
															</table>
														</td>
													</tr>	
													<tr>
														<td align="right" height="20" valign="top"><a href="javascript:GoMenu('online2')"><img src="../asset/img/btn_more.gif" width="36" height="13" border="0"  hspace="15"></a></td>
													</tr>												
													<tr>
														<td height="1" bgcolor="#336699"><img src="img/spacer.gif" width="1" height="1"  border="0"></td>
													</tr>
										...
										<tr>
											<td height="35" valign="bottom" align="right" colspan="9"><a href="#top"><img src="../asset/img/btn_top.gif" width="36" height="13" border="0" ></a></td>
										</tr>	
