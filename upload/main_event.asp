...
<table width="267" cellpadding="0" cellspacing="0" border="0">
	<tr>
		<td colspan=2 background="/img/main/today_bg.gif"><A HREF="/upload/main_notice.asp" onMouseOver="Over('1','on');" onmouseout="Over('1','off');"><img src="/img/main/today_tab01.gif" name=m1></A><A HREF="/upload/main_event.asp" onMouseOver="Over('2','on');" onmouseout="Over('2','on');"><img src="/img/main/today_tab02_o.gif" name=m2></A><A HREF="/upload/main_service.asp" onMouseOver="Over('3','on');" onmouseout="Over('3','off');"><img src="/img/main/today_tab03.gif" name=m3></A></td>
	</tr>
	...
	<tr>
		...
		<!-- TodayCuritel -->
		<iframe src="/upload/main_event_1.asp" scrolling="no" frameborder="0" width="100%" height="135"></iframe>
		<!-- //TodayCuritel -->
		</td>
	</tr>
</table>
