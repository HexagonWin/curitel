...
<!-- // 레프트 메뉴 END -->
		...
		<td rowspan="2" width="580" valign="top" align="center">
		<!-- 메인 컨텐츠 START -->
        <img src="images/howmuch.gif" border="0" align="absmiddle"><br>
		<iframe id=fbody src="http://www.mymargin.com/curitel/main_list_a.asp" scrolling="no" width="550" height="800" frameborder="0" marginwidth='0' marginheight='0' topmargin="0"></iframe>
		<!-- // 메인 컨텐츠 END -->
		</td>
<!-- 푸터 include -->	</tr>
	<tr>
