...
<input type=hidden name=b_subnum>
  <tr> 
    <td height="372" valign="top"><img src="images/open_movie.gif" width="471" height="419" border="0" usemap="#Map"></td>
  </tr>
  <tr>
	<td align="center" bgcolor="#6098D3"><input type="checkbox" name="Notice" value=""><font class="unnamed2"> 오늘은 이창을 띄우지 않음</font><img src=images/close_new.gif border=0 align="absmiddle" style="cursor:hand" onClick="javascript:closeWin();"><br><br>
	</td>
  </tr>
</form>
</table>
...
<map name="Map">
  <area shape="rect" coords="270,315,329,372" href="javascript:view_form('703','6');">
</map>
</body>
</html>
