	...
	<tr>
		...
		<table width="100%" cellpadding="0" cellspacing="0">
          ...
          <td background="/img/popup/titbg.gif" valign="bottom" style="padding:0 0 8 25"> 
            <img src="/img/popup/tit_serial.gif" alt="" width="68"  height="20" border="0"></td>
	...
	<tr>
		...
		<table height="100%" width="100%" cellpadding="0" cellspacing="0">
          ...
          <td valign="top" style="padding:20 20 25 20" align="center"> 
            <!-- ####contents -->
            <table border="0" cellspacing="0" cellpadding="6" style="border:#CDCDCD 1 solid">
              <tr> 
                <td><img src="/img/popup/img_serial.gif" width="303" height="228"></td>
              </tr>
            </table>
            <!-- ####contents -->
				</td>
