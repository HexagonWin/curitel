	...
	<tr>
		...
		<table width="100%" cellpadding="0" cellspacing="0">
			<tr>
				...
				<img src="/img/popup/tit_print.gif"  height="20" alt="" border="0"></td>
		...
		<table height="100%" width="100%" cellpadding="0" cellspacing="0">
			<tr>
				<td width="5" background="/img/popup/dotbg.gif"></td>
				  <td valign="top" style="padding:20 20 25 20"> 
						<!-- ####contents -->
						<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
						<tr>
							<td style="padding:10 0">
								<img src="/img/prroom/tit_print.gif"><br>
								<img src="/img/prroom/img_sample02.gif" width="380" height="515"><br>
							</td>
						</tr>
						</table> 
						<!-- ####contents -->
