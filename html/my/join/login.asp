...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/my/join/login.asp">
					<tr>
			...
			<table width="148" height="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td valign="top">
						...
						<tr>							
					       <td align="center">
							<script language="JavaScript">flash('/inc/flash/left/left_mycuritel.swf?html_Num=00','100','300');</script>
...
<input type=hidden name=rurl value="">
			...
			<table width="557" cellpadding="0" cellspacing="0" border="0">
			 ...
			 <tr> 
				...
				<tr><td height=50 align=right style="padding-right:50">
				...
				<tr>
					<td style="padding:5 0 0 8"><img src="/img/my/join/namecheck.gif"></td>
				</tr>
				</table>
				<!--//수정-->
</form>
