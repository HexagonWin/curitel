...
<table width="936" cellpadding="0" cellspacing="0">
 ...
 <param name=movie value="/inc/flash/sub_menu.swf?lnum="> <param name=quality value=high> <param name=bgcolor value=#ffffff> <embed src="/inc/flash/sub_menu.swf?lnum=" quality=high bgcolor=#ffffff  width="936" height="137" align=""
...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/my/join/index.asp">
					<tr>
...
<div id="rpath" style="position:absolute;visibility:visible;left:232;top:185;width:596;height:15;z-index:10;">  
      ...
      <td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a> 
        > <a href="/html/my/index.asp">My Curitel</a> > 회원가입</td>
				</tr>
		</table>
</div>
...
-->
		...
		<td width="597" valign="top">
            ...
            <table width="557" cellpadding="0" cellspacing="0" border="0">
              <tr> 
                <td><img src="/img/my/join/subimg00.gif" width="537" height="97" alt="" border="0"></td>
              </tr>
              <tr> 
                <td height="1"></td>
              </tr>
              ...
              <tr> 
                <td style="padding:0 0 0 8"><img src="/img/my/join/txt_join.gif"></td></tr>
              <tr> 
                <td height="20"></td>
              </tr><!--
              <tr> 
                <td style="padding:0 0 0 8"><table width="544" border="0" cellspacing="0" cellpadding="0" bgcolor="#ECF2F5">
                    <tr> 
                      <td width="7" height="7" class="round01"></td>
                      <td></td>
                      <td width="7" class="round02"></td>
                    </tr>
                    <tr> 
                      <td></td>
                      <td style="padding-left:10">* 큐리텔 회원은 3등급으로 나누어져 있습니다.<br>
                        큐리텔 제품을 사용하진 않지만 큐리텔 활동을 원하시는 ‘일반회원’ 등급<br>
                        큐리텔 제품을 가지고 있으며, 큐리텔 사이트를 활발히 이용하는 ‘정회원’ 등급<br>
                        그리고 정회원이 큐리텔의 활동수치인 Battery를  100개 획득했을 경우 획득하게 되는 ‘매니아’<br>
                        등급으로 분류됩니다.</td>
                      <td></td>
                    </tr>
                    <tr> 
                      <td width="7" height="7" class="round03"></td>
                      <td></td>
                      <td width="7" class="round04"></td>
                    </tr>
                  </table></td>
              </tr>
              <tr> 
              ...
              <tr> 
                <td height="30" valign="top"><img src="/img/my/join/title_join01.gif" width="179" height="14"></td>
              </tr>
              <tr> 
                <td style="padding:0 0 0 8"><table width="545" border="0" cellspacing="0" cellpadding="0">
                    <!--<tr> 
                      <td width="100"><img src="/img/my/join/join_mem1.gif" width="76" height="76" vspace="2"></td>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr valign="top"> 
                            <td width="65">회원기준 :</td>
                            <td>큐리텔 제품을 사용하지 않지만 큐리텔사이트 내의 활동을 원하시는 분.</td>
                          </tr>
                          <tr valign="top"> 
                            <td>활동범위 :</td>
                            <td>큐리텔 사이트의 모든 메뉴를 조회할 수는 있으나, [매니아 라이프]나 [폰데코] 등 일부 서비스는 제한을 받음.</td>
                          </tr>
                          <tr valign="top"> 
                            <td>지급Curi :</td>
                            <td>200Curi</td>
                    ...
                    <tr> 
                      <td><img src="/img/my/join/join_mem2.gif" width="76" height="76" vspace="2"></td>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr valign="top"> 
                            <td width="65">회원기준 :</td>
                            <td>큐리텔 제품 정보를 입력하신 분</td>
                          </tr>
                          <tr valign="top"> 
                            <td>활동범위 :</td>
                            <td>큐리텔 사이트에서 [매니아 라이프]를 제외한 모든 메뉴를 제한 없이
                              사용할 수 있음. </td>
                          </tr>
                          <tr valign="top"> 
                            <td>지급Curi :</td>
                    ...
                    <tr> 
                      <td><img src="/img/my/join/join_mem3.gif" width="76" height="76" vspace="2"></td>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr valign="top"> 
                            <td width="65">회원기준 :</td>
                            <td>큐리텔 제품을 소지하신 회원들 중 1000 Battey를 충전할 경우</td>
                          </tr>
                          <tr valign="top"> 
                            <td>활동범위 :</td>
                            <td>[매니아 라이프]를 비롯한 모든 서비스를 자유롭게 사용할 수 있으며
                              매달 3회의 [폰데코] 컨텐츠 무료 다운로드와 특별 혜택을 받음. </td>
                          </tr>
                          <tr valign="top"> 
                            <td>지급Curi :</td>
                            <td>200Curi</td>
              ...
              <tr> 
                <td align="center"><a href="rule.asp?jmode=N"><img src="/img/my/join/btn_join.gif" width="90" height="24" border="0"></a>&nbsp;&nbsp; 
                  <a href="rule.asp?jmode=F"><img src="/img/my/join/btn_join2.gif" width="90" height="24" border="0"></a></td>
              </tr>
            </table> </td>
              </tr>
            </table>
