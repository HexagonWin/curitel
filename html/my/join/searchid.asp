...
<script language=javascript>
  function formsubmit()
  {
    if(document.userLoginFrm.name.value == "")
    {
      alert("이름을 입력하세요!");
      document.userLoginFrm.name.focus();
      return false;
    }
    if(document.userLoginFrm.ssn.value == "")
    {
      alert("주민번호 뒷자리를 입력하세요!");
      document.userLoginFrm.ssn.focus();
      return false;
    }
  }
</script>
...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/my/join/searchid.asp">
					<tr>
...
<div id="rpath" style="position:absolute;visibility:visible;left:232;top:185;width:596;height:15;z-index:10;">  
	 ...
	 <td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a> 
		> <a href="/html/my/index.asp">My Curitel</a> > ID/비밀번호 찾기</td>
				</tr>
		</table>
</div>
...
<form name="userLoginFrm" method="post" action="searchid_exec.asp" onsubmit="return formsubmit(this)">
<input type=hidden name=rurl value="">
			 <tr> 
				<td><img src="/img/my/join/subimg08.gif" width="537" height="97" alt="" border="0"></td>
			 </tr>
			 <tr> 
				<td height="1"></td>
			 </tr>
			 ...
			 <tr> 
				...
				<!--수정//-->
				<div style="position:absolute;margin-left:300;"><img src="/img/my/join/msg_searchidpw.gif"></div>
				<table width="504" border="0" cellspacing="0" cellpadding="0">
				<tr><td height=25 valign=top><img src="/img/my/join/t_searchidpw.gif"></td></tr>
				<tr><td width="504" height="69" background="/img/my/join/login_bg.gif" style="padding:20 0 0 10">
						<img src="/img/my/join/txt_searchidpw.gif">
				</td></tr>
				<tr><td width="504" height="103" background="/img/my/join/login_bg2.gif">
					<table border="0" cellspacing="0" cellpadding="0" align=center>
					<tr>
						<td width=90><img src="/img/my/join/img_searchidpw.gif"></td>
						<td width=230>
							<img src="/img/my/join/login_name.gif" hspace=6 align="absmiddle"><input type="text" name="name" size=16 class="imgbdr">
							<br><img src="/img/b.gif" width=1 height=7z><br>
							<img src="/img/my/join/login_id2.gif" hspace=6 align="absmiddle"><input type="password" name="ssn" size=16 class="imgbdr">
						</td>
						<td width=90><input type=image src="/img/my/join/btn_submit2.gif" width="55" height="55" align="absmiddle" style="height:55"></td>
					</tr>
					</table>
				</td></tr>
				<tr><td height=50 align=right>
							 <!-- <a href="javascript:EmailSend()"><img src="/img/my/join/btn_sendtomail.gif" align="absmiddle"></a>  -->
							 <a href="/html/index.asp"><img src="/img/my/join/btn_cancel2.gif" align="absmiddle"></a> 
							 <a href="/html/my/join/secede.asp"><img src="/img/my/join/btn_secede2.gif" align="absmiddle"></a> 
