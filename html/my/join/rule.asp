...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/my/join/rule.asp">
					<tr>
...
<div id="rpath" style="position:absolute;visibility:visible;left:232;top:197;width:596;height:15;z-index:10;"> 
      ...
      <td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a> 
        > <a href="/html/my/index.asp">My Curitel</a> > 회원가입 > 이용약관</td>
				</tr>
		</table>
</div>
					...
					<td valign="top">
						...
						<tr>							
					       <td align="center"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100" height="400">
					               <param name="movie" value="/inc/flash/left/left_mycuritel.swf?html_Num=60">
					               <param name="quality" value="high">
					               <embed src="/inc/flash/left/left_mycuritel.swf?html_Num=60" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100" height="400"></embed></object></td>
						</tr>
						<tr>
		...
		<td width="597" valign="top">
          ...
          <td valign="top" class="ctsmgn"> 
            ...
            <table width="557" cellpadding="0" cellspacing="0" border="0">
              ...
              <tr> 
                <td style="padding:0 0 30 10">반드시 회원약관을 읽어보신 후 가입신청을 하시기 바랍니다.<br>
                  회원보호정책에 따라 이용자님이 동의하지 않은 정보는 절대 공개하지 않음을 알려드립니다.</td>
              </tr>
              <tr> 
                <td><img src="/img/information/tit01.gif" width="117" height="25"></td>
              </tr>
              <tr> 
                <td style="padding:0 0 0 8"><table width="533" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr> 
                      ...
                      <td style="padding:5"> <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#F5F5F5">
                          <tr> 
                            <td style="padding:10"><iframe src="inc_rule.asp" width="500" height="170" frameborder=0 style="background:#F5F5F5"></iframe></td>
                          </tr>
                        </table></td>
              ...
              <tr> 
                <td style="padding:0 0 0 8"><table width="533" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr> 
                      ...
                      <td style="padding:5"> <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#F5F5F5">
                          <tr> 
                            <td style="padding:10"><iframe src="inc_rule02.asp" width="500" height="170" frameborder=0 style="background:#F5F5F5"></iframe></td>
                          </tr>
                        </table></td>
                      <td style="border-right:1px solid #DCDCDC" valign="top"><img src="/img/b.gif" width="1" height="1"></td>
                    </tr>
              ...
              <tr> 
                <td height="20" align="center"><a href="form.asp?jmode="><img src="/img/my/join/btn_agree.gif" width="50" height="19" border="0"></a>&nbsp;&nbsp; 
                  <a href="index.asp"><img src="/img/my/join/btn_cancel.gif" width="50" height="19" border="0"></a></td>
              </tr>
            </table></td>
              </tr>
            </table>
