  ...
  function setFocus()
  {
     document.userLoginFrm.uid.focus();
		  ...
		  function daumsaign_popup()
		  {
		  	...
		  	//open("http://sign.daum.net/SSOLogin?siteid=curitel&url=http://www.curitel.com/daum/daum_sign_check.asp","daumsign","width=600 height=380 menubars=no scrollbars=no");
		  	open("http://sign.daum.net/SSOLogin?siteid=curitel&regcode=1&url=http://dev.curitel.com/daum/daum_sign_check.asp","daumsign","width=800 height=500 menubars=no scrollbars=no");
		  }
</script>
...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/my/join/login.asp?rurl=/html/event/event/GoldenBell/index.asp">
					<tr>
			...
			<table width="148" height="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td valign="top">
						...
						<tr>							
					       <td align="center">
							<script language="JavaScript">flash('/inc/flash/left/left_mycuritel.swf?html_Num=00','100','380');</script>
							<!-- <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100" height="380">
					               ...
					               <embed src="/inc/flash/left/left_mycuritel.swf?html_Num=00" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100" height="380"></embed></object> --></td>
						</tr>
						<!--tr>
...
<input type=hidden name=rurl value="/html/event/event/GoldenBell/index.asp">
				<tr>
					<td valign="top" class="ctsmgn">
						<!-- #####Contents##### -->			
			<table width="557" cellpadding="0" cellspacing="0" border="0">
			 <tr> 
				<td><img src="/img/my/join/subimg10.gif" width="537" height="97" alt="" border="0"></td>
			 </tr>
			 <tr> 
				<td height="1"></td>
			 </tr>
			 ...
			 <tr> 
				...
				<tr><td width="504" height="69" background="/img/my/join/login_bg.gif" style="padding:5 0 0 10">
						<img src="/img/my/join/txt_login01.gif">
				</td></tr>
				<tr><td width="504" height="103" background="/img/my/join/login_bg2.gif">
					<table border="0" cellspacing="0" cellpadding="0" align=center>
					<tr>
						<td width=320><img src="/img/my/join/img_login01.gif"></td>
						<td width=90><a href="javascript:daumsaign_popup()"><img src="/img/my/join/btn_login.gif" width="55" height="55" align="absmiddle" style="height:55"></a></td>
					</tr>
					</table>
				</td></tr>
