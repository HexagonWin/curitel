...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/my/join/login.asp?rurl=/html/event/event/openevent02/open02_list.asp">
					<tr>
...
<input type=hidden name=rurl value="/html/my/join/login.asp?rurl=/html/event/event/openevent02/open02_list.asp">
					...
					<A href="javascript:changePhoto('.','next','')" onfocus="this.blur()"><img src="/img/common/maintitle03.gif" width="77" height="65" alt="" border="0" name="photolist"></a>

					</td>
					<td width="164" align="right"><a href="/html/my/index.asp" onfocus="this.blur()"><img src="/img/my/channel_title.gif" width="164" height="65" alt="" border="0"></a></td>
				</tr>
				</table>
			</DIV>
		</td>
		<td width="162"></td>
		<td width="590" height="78" !class="rightbg" valign="top"><div style="zindex:0"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="597" height="78">
    <param name="movie" value="/inc/flash/bg/bg_my.swf">
    <param name="quality" value="high"><param name=wmode value=transparent>
    <embed src="/inc/flash/bg/bg_my.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="597" height="78"></embed></object></div></td>
	</tr>
	<tr> 
...
<div id="rpath" style="position:absolute;visibility:visible;left:232;top:197;width:596;height:15;z-index:10;"> 
	 ...
	 <td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a> 
		> <a href="/html/my/index.asp">My Curitel</a> > 로그인</td>
				</tr>
		</table>
</div>
			...
			<table width="148" height="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td valign="top">
						...
						<tr>							
					       <td align="center"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100" height="400">
					               <param name="movie" value="/inc/flash/left/left_mycuritel.swf?html_Num=00">
					               <param name="quality" value="high">
					               <embed src="/inc/flash/left/left_mycuritel.swf?html_Num=00" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100" height="400"></embed></object></td>
						</tr>
						<tr>
...
<form name="userLoginFrm" method="post" action="/common/checkLogin.asp" onsubmit="return formsubmit(this)">
<input type=hidden name=rurl value="/html/event/event/openevent02/open02_list.asp">
			...
			<table width="557" cellpadding="0" cellspacing="0" border="0">
			 <tr> 
				<td><img src="/img/my/join/subimg07.gif" width="537" height="97" alt="" border="0"></td>
			 </tr>
			 <tr> 
				<td height="1"></td>
			 </tr>
			 ...
			 <tr> 
				...
				<!--수정//-->
				<div style="position:absolute;margin-left:300;"><img src="/img/my/join/msg_login.gif"></div>
				<table width="504" border="0" cellspacing="0" cellpadding="0">
				<tr><td height=25 valign=top><img src="/img/my/join/t_login.gif"></td></tr>
				<tr><td width="504" height="69" background="/img/my/join/login_bg.gif" style="padding:20 0 0 10">
						<img src="/img/my/join/txt_login.gif">
				</td></tr>
				<tr><td width="504" height="103" background="/img/my/join/login_bg2.gif">
					<table border="0" cellspacing="0" cellpadding="0" align=center>
					<tr>
						<td width=90><img src="/img/my/join/img_login.gif"></td>
						<td width=230>
							<img src="/img/my/join/login_id.gif" align="absmiddle"><input type="text" name="uid" size=16 class="imgbdr">
							<br><img src="/img/b.gif" width=1 height=7z><br>
							<img src="/img/my/join/login_pw.gif" align="absmiddle"><input type="password" name="passwd" size=16 class="imgbdr">
						</td>
						<td width=90><input type=image src="/img/my/join/btn_login.gif" width="55" height="55" align="absmiddle" style="height:55"></td>
					</tr>
					</table>
				</td></tr>
				<tr><td height=50 align=right>
							 <A HREF="searchid.asp"><img src="/img/my/join/btn_searchidpw.gif" align="absmiddle"></A> 
							<A HREF="index.asp"> <img src="/img/my/join/btn_joinmember.gif" align="absmiddle"></A> 
							 <a href="/html/help/support/faq_category.asp?pidx=9&idx=25"><img src="/img/my/join/btn_gotofaq.gif" align="absmiddle"></a> 
				</td></tr>
				</table>
				<!--//수정-->
</form>
...
<param name="movie" value="/inc/flash/search/search.swf">
<param name="quality" value="high">
<param name="wmode" Value="Transparent">
<embed src="/inc/flash/search/search.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="91" height="340"></embed></object>

<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="91" height="182" vspace="10">
