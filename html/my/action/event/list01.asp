...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/my/action/event/list01.asp">
					<tr>
...
<!-- RecursivePath -->
<div id="rpath" style="position:absolute; left:232; top:197; width:596; height:15; z-index:10; visibility: visible;"> 
		<table cellpadding="0" cellspacing="0" border="0" align="right">
				<tr> 
						<td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a> > <a href="/html/my/index.asp">My Curitel</a> > 나의 활동내역 > 이벤트라이프</td>
				</tr>
		</table>
</div>
			...
			<table width="148" height="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td valign="top">
						...
						<tr>							
					       <td align="center">
							<script language="JavaScript">flash('/inc/flash/left/left_mycuritel.swf?html_Num=54','100','380');</script>
							<!-- <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100" height="380">
					               <param name="movie" value="/inc/flash/left/left_mycuritel.swf?html_Num=54">
					               <param name="quality" value="high">
					               <embed src="/inc/flash/left/left_mycuritel.swf?html_Num=54" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100" height="380"></embed></object> --></td>
						</tr>
						<!--tr>
				...
				<tr>
					<td valign="top" class="ctsmgn">
						...
						<table width="557" cellpadding="0" cellspacing="0" border="0">
							<tr> 
								<td><img src="/img/my/action/subimg04.gif" width="537" height="97" alt="" border="0"></td>
							</tr>
							<tr> 
								<td height="1"></td>
							</tr>
							...
							<tr>
								<td style="padding:23 0 14 12"><img src="/img/my/action/event/txt_guide.gif"></td>
							</tr>
							<tr> 
								<td style="padding:0 0 0 8"><table width="529" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<!--- 텝메뉴 "해당파일_o" --->
											<td colspan="3" height="29" background="/img/common/tabbg.gif"><a href="/html/my/action/event/list01.asp"><img src="/img/my/action/event/tab01_o.gif" width="104" height="30" alt="" border="0"></a><a href="list02.asp"><img src="/img/my/action/event/tab02.gif" width="104" height="30" alt="" border="0" hspace="1"></a></td>
										</tr>
                                        <tr><td height="6"></td></tr>
                                        <tr><td align="right" height=30 valign=top><a href="/html/community/eventlife/expedition/index.asp"><img src="/img/btn/btn_my_event01.gif" width="165" height="19" border="0"></a></td></tr>
									</table></td>
							</tr>
							<tr> 
								<td style="padding:0 0 0 8"> 
									...
									<table width="530" cellpadding="0" cellspacing="0" border="0">
										...
										<tr align="center"> 
											...
											<td width="300" class="field02">제목</td>
											<td width="61" class="field02">아이디</td>
											<td width="62" class="field02">날짜</td>
											<td width="74" class="field03"> <table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0">
													<tr> 
										...
										<tr bgcolor='#f4f6f7'> 
											<td height="20" colspan="5">활동하신 내역이 없습니다.</td>
										</tr>
										<tr> 
										...
										<tr align="center"> 
											<td height="42" colspan="5">&nbsp;<b>|1|</b></td>
										</tr>
									</table>
									<!------- LIST End ------------->
								</td>
							...
							<tr> 
								<td style="padding:10 0"><img src="/img/common/plusline.gif" width="557" height="11" alt="" border="0"></td>
							</tr><!--
							<tr>
								 바로가기 버튼 
								<td align="right" style="padding-right:23"><a href="/html/community/eventlife/expedition/index.asp"><img src="/img/btn/btn_my_event01.gif" width="150" height="18" border="0"></a></td>
							</tr>-->
						</table>
						<!-- #####//Contents##### -->
					</td>
