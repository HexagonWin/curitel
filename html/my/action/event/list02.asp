...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/my/action/event/list02.asp">
					<tr>
						...
						<table width="557" cellpadding="0" cellspacing="0" border="0">
							...
							<tr> 
								<td style="padding:0 0 0 8"><table width="529" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<!--- 텝메뉴 "해당파일_o" --->
											<td colspan="3" height="29" background="/img/common/tabbg.gif"><a href="/html/my/action/event/list01.asp"><img src="/img/my/action/event/tab01.gif" width="104" height="30" alt="" border="0"></a><a href="list02.asp"><img src="/img/my/action/event/tab02_o.gif" width="104" height="30" alt="" border="0" hspace="1"></a></td>
										</tr>
                                        <tr><td height="6"></td></tr>
                                        <tr><td align="right" height=30 valign=top><a href="/html/community/eventlife/sailer/index.asp"><img src="/img/btn/btn_my_event02.gif" width="165" height="19" border="0"></a></td></tr>
									</table></td>
							</tr>
							<tr> 
							...
							<tr>
								 바로가기 버튼 
								<td align="right" style="padding-right:23"><a href="/html/community/eventlife/sailer/index.asp"><img src="/img/btn/btn_my_event02.gif" width="150" height="18" border="0"></a></td>
							</tr>-->
						</table>
						<!-- #####//Contents##### -->
					</td>
