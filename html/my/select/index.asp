...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/my/select/index.asp">
					<tr>
...
<div id="rpath" style="position:absolute;visibility:visible;left:232;top:197;width:596;height:15;z-index:10;"> 
		<table cellpadding="0" cellspacing="0" border="0" align="right">
				<tr> 
						<td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a> > <a href="/html/my/index.asp">My Curitel</a> > 찜리스트 > 폰데코 찜리스트</td>
				</tr>
		</table>
</div>
			...
			<table width="148" height="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td valign="top">
						...
						<tr>							
					       <td align="center">
							<script language="JavaScript">flash('/inc/flash/left/left_mycuritel.swf?html_Num=21','100','380');</script>
							<!-- <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100" height="380">
					               <param name="movie" value="/inc/flash/left/left_mycuritel.swf?html_Num=21">
					               <param name="quality" value="high">
					               <embed src="/inc/flash/left/left_mycuritel.swf?html_Num=21" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100" height="380"></embed></object> --></td>
						</tr>
						<!--tr>
				...
				<tr>
					<td valign="top" class="ctsmgn">
	                    ...
	                    <table width="557" cellpadding="0" cellspacing="0" border="0">
                          <tr> 
                              <td><img src="/img/my/select/subimg01.gif" width="537" height="97" alt="" border="0"></td>
                          </tr>
                          <tr> 
                              <td height="1"></td>
                          </tr>
						  ...
						  <tr>
							...
							<iframe src="http://phonedeco.curitel.com/wish/conWish.do?act=alist&conType=M" width="529" height="750" frameborder="0" scrolling="No"></iframe>	
							</td>
						  </tr>
						</table>
						<!-- #####//Contents##### -->
