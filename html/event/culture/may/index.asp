...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/culture/may/index.asp">
					<tr>
						...
						<tr>
							<td style="padding-top:15">
								<table border=0 cellpadding=0 cellspacing=0>
									<tr>
										<td><img src="img/img.gif" usemap=#1></td>
									</tr>
								</table>
							</td>
						</tr>
...
<map name=1>
	...
	<AREA SHAPE=RECT COORDS="447,675,561,713" onfocus=this.blur() href="list.asp">
</map>
