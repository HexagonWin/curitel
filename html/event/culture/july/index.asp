...
<Script Language='JavaScript'>
	function apply(){
		var nFeatures, nWinnm, nDestPage;
	
		nWinnm = "pop";
		nDestPage = "pop.asp";

		window.open(nDestPage, nWinnm, "width=450,height=339,status=yes");
	}

	function confirmNamecheck(){
		var ans;

		if(ans=confirm('실명인증을 한 회원만 참여 가능합니다.\n\n지금 실명인증 하시겠습니까?')){
			location.href='/html/my/join/modify.asp?txtUrl=/html/event/culture/july';
		}
		else
			return;
...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/culture/july/index.asp">
					<tr>
						...
						<tr>
							<td style="padding-top:15">
								<table border=0 cellpadding=0 cellspacing=0>
									<tr><td><img src="img/img01.gif" usemap=#1></td></tr>
									<tr><td><img src="img/img02.gif"></td></tr>
									<tr><td><img src="img/img03.gif" usemap=#2></td></tr>
								</table>
							</td>
						</tr>
	                  </table>
...
<map name=1>
	<AREA SHAPE=RECT COORDS="443,412,551,438" onfocus=this.blur() href="/html/my/join/modify.asp?txtUrl=/html/event/culture/july">
</map>
<map name=2>
	<AREA SHAPE=RECT COORDS="203,0,387,53" onfocus=this.blur() href="javascript:confirmLogin();">
</map>
