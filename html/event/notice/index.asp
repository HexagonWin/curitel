...
function sendData()
{
	...
	if ( (frm.keyword.value == "") || (frm.keyword.value.length == 0) ){
		alert("검색어를 입력해 주십시오.");
		frm.keyword.focus();
		return;
	}
...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/notice/index.asp">
					<tr>
...
<div id="rpath" style="position:absolute;visibility:visible;left:232;top:197;width:596;height:15;z-index:10;">
		<table cellpadding="0" cellspacing="0" border="0" align="right">
				<tr>
						<td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a> > <a href="/html/event/index.asp">Event</a> > 이벤트 공지사항</td>
				</tr>
		</table>
</div>
			...
			<table width="148" height="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td valign="top">
						...
						<tr>
					       <td align="center">
							<script language="JavaScript">flash('/inc/flash/left/left_event.swf?html_Num=10','100','300');</script>
							<!-- <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100" height="300">
					               <param name="movie" value="/inc/flash/left/left_event.swf?html_Num=10">
					               <param name="quality" value="high">
					               <embed src="/inc/flash/left/left_event.swf?html_Num=10" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100" height="300"></embed></object> --></td>
						</tr>
                  ...
                  <table width="557" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                      <td height="26"> <table width="537" height="100%" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td><img src="/img/event/subimg01.gif" width="537" height="97"></td>
                          </tr>
                          <tr>
                            <td height="1"></td>
                          </tr>
                    ...
                    <tr>
                      <td style="padding:25 0 8 8">
                        ...
                        <table width="530" cellpadding="0" cellspacing="0" border="0">
                          <tr>
                            <td height="35" colspan="6" style="border-bottom:1px solid #c9c9c9;padding:0 8 0 0" align="right">
                              <select name="ktype" style="width:97">
                                <option value='title'>제목
                                <option value='content'>내용</select> <input name="keyword" type="text" style="width:120" value="">
                              <a href="javascript:sendData();"><img src="/img/bbs/btn/btn_search.gif" width="46" height="17" alt="" border="0" align="absmiddle"></a>
                            </td>
                          </tr>
                          <tr>
                          ...
                          <tr align="center">
                            <td width="28" height="25" class="field01">번호</td>
                            <td width="412" class="field02">제목</td>
                            <td width="90" class="field03"> <table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                          ...
                          <tr >
                            <td height="26" >37</td>
                            <td><a href="view.asp?idx=48&num=37">4월, 더욱 막강해진 큐리경매와 풍성한 이벤트를 만나보세요</a></td>
                            <td>2006-03-29</td>
                          </tr>
                          <tr>
                            <td colspan="6" height="1" bgcolor="#e6e8e8"></td>
                          </tr>

                          <tr bgcolor='#f4f6f7'>
                            <td height="26" >36</td>
                            <td><a href="view.asp?idx=46&num=36">4월, 큐리안들을 위한 아주 특별한 파티가 시작됩니다.</a></td>
                            <td>2006-03-16</td>
                          </tr>
                          <tr>
                            <td colspan="6" height="1" bgcolor="#e6e8e8"></td>
                          ...
                          <tr >
                            <td height="26" >35</td>
                            <td><a href="view.asp?idx=44&num=35">'커플이냐? 1억 준다!' 이벤트 대상 고객님들께 알려드립니다.</a></td>
                            <td>2005-12-23</td>
                          </tr>
                          <tr>
                            <td colspan="6" height="1" bgcolor="#e6e8e8"></td>
                          ...
                          <tr bgcolor='#f4f6f7'>
                            <td height="26" >34</td>
                            <td><a href="view.asp?idx=42&num=34">[발표]Fall in Love, Fall in Curitel 이벤트</a></td>
                            <td>2005-11-17</td>
                          </tr>
                          <tr>
                            <td colspan="6" height="1" bgcolor="#e6e8e8"></td>
                          ...
                          <tr >
                            <td height="26" >33</td>
                            <td><a href="view.asp?idx=41&num=33">[이벤트]2006 독일 월드컵 아우토반 원정대</a></td>
                            <td>2005-11-07</td>
                          </tr>
                          <tr>
                            <td colspan="6" height="1" bgcolor="#e6e8e8"></td>
                          ...
                          <tr bgcolor='#f4f6f7'>
                            <td height="26" >32</td>
                            <td><a href="view.asp?idx=40&num=32">[이벤트]도전! 큐리 골든벨</a></td>
                            <td>2005-11-07</td>
                          </tr>
                          <tr>
                            <td colspan="6" height="1" bgcolor="#e6e8e8"></td>
                          ...
                          <tr >
                            <td height="26" >31</td>
                            <td><a href="view.asp?idx=39&num=31">[이벤트]데이콤 웹하드 400MB 무료 2개월 이벤트</a></td>
                            <td>2005-10-17</td>
                          </tr>
                          <tr>
                            <td colspan="6" height="1" bgcolor="#e6e8e8"></td>
                          ...
                          <tr bgcolor='#f4f6f7'>
                            <td height="26" >30</td>
                            <td><a href="view.asp?idx=38&num=30">[이벤트]Fall in Love, Fall in Curitel</a></td>
                            <td>2005-10-17</td>
                          </tr>
                          <tr>
                            <td colspan="6" height="1" bgcolor="#e6e8e8"></td>
                          ...
                          <tr >
                            <td height="26" >29</td>
                            <td><a href="view.asp?idx=37&num=29">[발표]루루공주 OST 싸인 CD 이벤트</a></td>
                            <td>2005-09-01</td>
                          </tr>
                          <tr>
                            <td colspan="6" height="1" bgcolor="#e6e8e8"></td>
                          ...
                          <tr bgcolor='#f4f6f7'>
                            <td height="26" >28</td>
                            <td><a href="view.asp?idx=36&num=28">[발표]강동원 팬미팅</a></td>
                            <td>2005-08-23</td>
                          </tr>
                          <tr>
                            <td colspan="6" height="1" bgcolor="#e6e8e8"></td>
                          ...
                          <tr align="center">
                            <td height="42" colspan="6">&nbsp;<b>|1|</b>&nbsp;<a href=index.asp?page=2&>|2|</a>&nbsp;<a href=index.asp?page=3&>|3|</a>&nbsp;<a href=index.asp?page=4&>|4|</a></td>
                          </tr>
                        </table>
<script language="javascript">
document.searchFrm.ktype.value = 'title';
</script>
                      	</form>
                      </td>
                    </tr>
