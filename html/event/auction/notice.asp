...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/auction/notice.asp">
					<tr>
...
<div id="rpath" style="position:absolute;visibility:visible;left:232;top:197;width:596;height:15;z-index:10;">
		<table cellpadding="0" cellspacing="0" border="0" align="right">
				<tr>
						<td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a> > <a href="/html/event/index.asp">Event</a> > <a href="/event/auction/index.asp">Curi경매</a> > <a href="/html/event/auction/index.asp">진행중 Curi경매</a> > 큐리 경매 공지사항</td>
				</tr>
		</table>
</div>
	...
	<tr><td height="13"></td></tr>
		...
		<td width="597" valign="top">
			<table width="597" cellpadding="0" cellspacing="0" border="0">
                  ...
                  <table width="557" cellpadding="0" cellspacing="0" border="0">
                    <tr> 
                      <td height="26"> <table width="537" height="100%" border="0" cellpadding="0" cellspacing="0">
                          <tr> 
                            <td><img src="/img/event/subimg06.gif" width="537" height="97"></td>
                          </tr>
                          <tr> 
                            <td height="1"></td>
                          </tr>
                    ...
                    <tr> 
                      <td style="padding:25 0 8 8">
                        ...
                        <table width="530" cellpadding="0" cellspacing="0" border="0">
                          <tr> 
                            <td height="35" colspan="3" style="border-bottom:1px solid #c9c9c9;padding:0 8 0 0" align="right"> 
                              <form style="margin:0">
                                    <select name="ktype" style="width:97">
                                        <option value=1>제목 
                                        <option value=2>내용 </select> <input name="kword" type="text" style="width:120" value=""> 
                                    <input type=image src="/img/bbs/btn/btn_search.gif" width="46" height="17" alt="" border="0" align="absmiddle">
								</form> 
                            </td>
                          </tr>
                          <tr> 
                          ...
                          <tr align="center"> 
                            ...
                            <td width="415" class="field02">제목</td>
                            <td width="87" class="field03"> <table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr> 
						  ...
						  <col style="padding:0 0 0 12">
                          </colgroup>


				<tr bgcolor="#ffffff"> 
					<td height="26">23</td>
					<td><a href="view.asp?idx=27&p=1">제 21회 큐리경매 낙찰자 발표</a></td>
					<td>2006.03.16</td>
				</tr>
				...
				<tr bgcolor="#f4f6f7"> 
					<td height="26">22</td>
					<td><a href="view.asp?idx=26&p=1">제 20회 큐리경매 낙찰자 발표</a></td>
					<td>2006.02.20</td>
				</tr>
				...
				<tr bgcolor="#ffffff"> 
					<td height="26">21</td>
					<td><a href="view.asp?idx=25&p=1">제 19회 큐리경매 낙찰자 발표</a></td>
					<td>2006.01.23</td>
				</tr>
				...
				<tr bgcolor="#f4f6f7"> 
					<td height="26">20</td>
					<td><a href="view.asp?idx=24&p=1">제 18회 큐리경매 낙찰자 발표</a></td>
					<td>2005.12.16</td>
				</tr>
				...
				<tr bgcolor="#ffffff"> 
					<td height="26">19</td>
					<td><a href="view.asp?idx=23&p=1">제 17회 큐리경매 낙찰자 발표</a></td>
					<td>2005.11.18</td>
				</tr>
				...
				<tr bgcolor="#f4f6f7"> 
					<td height="26">18</td>
					<td><a href="view.asp?idx=22&p=1">제 16회 큐리경매 낙찰자 발표</a></td>
					<td>2005.10.25</td>
				</tr>
				...
				<tr bgcolor="#ffffff"> 
					<td height="26">17</td>
					<td><a href="view.asp?idx=21&p=1">제 15회 큐리경매 낙찰자 발표</a></td>
					<td>2005.09.26</td>
				</tr>
				...
				<tr bgcolor="#f4f6f7"> 
					<td height="26">16</td>
					<td><a href="view.asp?idx=20&p=1">제 14회 큐리경매 낙찰자 발표</a></td>
					<td>2005.08.23</td>
				</tr>
				...
				<tr bgcolor="#ffffff"> 
					<td height="26">15</td>
					<td><a href="view.asp?idx=19&p=1">제 13회 큐리경매 낙찰자 발표</a></td>
					<td>2005.07.26</td>
				</tr>
				...
				<tr bgcolor="#f4f6f7"> 
					<td height="26">14</td>
					<td><a href="view.asp?idx=18&p=1">제 12회 큐리경매 낙찰자 발표 </a></td>
					<td>2005.06.20</td>
				</tr>
                          ...
                          <tr> 
                            <td colspan="3" height="5" bgcolor="#eaeaea"></td>
                          </tr>
                          <tr align="center"> 
                            <td height="42" colspan="3">&nbsp;<b>|1|</b>&nbsp;<a href=notice.asp?page=2&ktype=1&kword=>|2|</a>&nbsp;<a href=notice.asp?page=3&ktype=1&kword=>|3|</a></td>
                          </tr>
                        </table></td>
                    </tr>
                  </table>
