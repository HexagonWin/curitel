...
<script language="javascript">
	function viewList(form, state){		
		form.action = "list.asp";
		form.vState.value = state;
		form.submit();
	}
</script>
</head>
...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/auction/before/list.asp">
					<tr>
...
<div id="rpath" style="position:absolute;visibility:visible;left:232;top:197;width:596;height:15;z-index:10;">
		...
		<tr>
			<td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a> > <a href="/html/event/index.asp">Event</a> > <a href="/event/auction/index.asp">Curi경매</a> > 지난 Curi경매</td>
		</tr>
		</table>
</div>
...
<!-- #####Contents Start ##### -->
				<div id="event_contents">
					<!-- Notice -->
					<div style="background:url(/img/event/auction_new/before_img01.jpg) no-repeat #fff top left;height:331;" class="l"></div>
					<!-- 탭메뉴 -->
					<div class="box l" style="height:24;background:url(/img/event/auction_new/bg_tab.gif) top repeat-x;margin:25 0 20 0">
						...
						<tr>
							...
							<td><a href="javascript:viewList(tabForm, 'MAX')"><img src="/img/event/auction_new/before_tab01_.gif"></a></td>
							<td><a href="javascript:viewList(tabForm, 'MIN')"><img src="/img/event/auction_new/before_tab02.gif"></a></td>
							<td><a href="javascript:viewList(tabForm, 'GRADE')"><img src="/img/event/auction_new/before_tab03.gif"></a></td>
						</tr>
						</table>
					</div>
					<!--// 탭메뉴 -->
					...
					<script language=javascript>
						function goView(form, idx){
							form.action = "list_max_tab.asp";
							form.auc_idx.value = idx;
							form.submit();
						}
					</script>

					<form name="lastForm" method="post">
						<input type="hidden" name="auc_idx" value="">
					</form>
					
					<div style="width:530;" class="mt20">
						<div>
							<div class="fl rbg_thl"></div>
							<div class="fl rbg_thc" style="width:48;">번호</div>
							<div class="fl rbg_thr"></div>

							<div class="fl rbg_thl" style="margin-left:2"></div>
							<div class="fl rbg_thc" style="width:303;">제목</div>
							<div class="fl rbg_thr"></div>

							<div class="fl rbg_thl" style="margin-left:2"></div>
							<div class="fl rbg_thc" style="width:92;">경매 종료일</div>
							<div class="fl rbg_thr"></div>

							<div class="fl rbg_thl" style="margin-left:2"></div>
							<div class="fl rbg_thc" style="width:65;">입찰자수</div>
							<div class="fl rbg_thr"></div>
						</div>
						<table width="530" cellpadding="2" cellspacing="0" border="0" class="gray_lb">
						<col width="52" class="c">
						<col width="314" class="plr8">
						<col width="96" class="c">
						<col width="68" class="c">
													  
						<tr>
							<td colspan="5" align=center>지난 경매가 없습니다</td>
						</tr>
						

						</table>
						<div class="c mtb14">&nbsp;<b>|1|</b></div>
					</div>
