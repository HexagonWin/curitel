...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/event/expedition/expedition.asp">
					<tr>
	                    ...
	                    <tr> 
								<td> 
									...
									<table border="0" cellpadding="0" cellspacing="0">
										<tr> 
											<td><img src="/html/event/event/expedition/img1.gif" width="537" height="306"></td>
										</tr>
										<tr> 
											<td><img src="/html/event/event/expedition/img2.gif" width="537" height="427" border="0" usemap="#Map"></td>
										</tr>
									</table>
<map name="Map">
	<area shape="circle" coords="201,190,29" href="#">
	<area shape="circle" coords="471,376,29" href="#">
</map>
												</td>
	                    </tr>
	                  </table>
