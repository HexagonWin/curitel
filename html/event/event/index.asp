...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/event/index.asp">
					<tr>
				...
				<tr>
					<td valign="top" class="ctsmgn">
 	                  ...
 	                  <table cellpadding="0" cellspacing="0" border="0">
	                    ...
	                    <tr>
	                      <td style="padding:25 0 8 0"><img src="/img/event/event/tit_hotevent.gif" width="119" height="14"></td>
						</tr>
						<!--<tr>
							<td style="padding:15 0 8 8" align="center">
								현재 진행중인 이벤트가 없습니다.
							</td>
						</tr>-->
						<!--<tr>
							<td style="padding:10 0 10 8"><a href="/html/event/event/goldenbell/index.asp"><img src="/img/event/event/now_goldenbell.gif"></a></td>
						</tr>
						<tr>
							<td style="padding:10 0"><img src="/img/common/plusline.gif" width="557" height="11" alt="" border="1" vspace="2"></td>
						</tr>-->
						<tr>
							<td style="padding:5 0 8 8">
		
							 <table width="525" border="0" cellspacing="0" cellpadding="0">
	                          <tr valign="top">
	                            <td><a href="/html/event/event/imory/index.asp"><img src="http://file.curitel.com/upload/event_history/imory_bann_01.gif" width="245" height="120" hspace="4"></a></td>
	                            <td><img src="http://file.curitel.com/upload/event_history/imory_bann_02.gif" width="256" height="85"><br>
	                              <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#F5F5F5">
	                                <tr>
	                                  <td width="4%"><img src="/img/event/event/box_l.gif" width="11" height="30"></td>
	                                  <td width="92%"><a href="/html/event/event/imory/index.asp"><img src="/img/event/event/btn_detail.gif"   vspace="5" border="0"></a></td>
							 ...
							 <table width="525" border="0" cellspacing="0" cellpadding="0">
	                          <tr valign="top">
	                            <td><a href="/html/event/event/webhard/index.asp"><img src="http://file.curitel.com/upload/event_history/webhard_1014.gif" width="245" height="120" hspace="4"></a></td>
	                            <td><img src="http://file.curitel.com/upload/event_history/webhard_txt_1014.gif" width="256" height="85"><br>
	                              <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#F5F5F5">
	                                <tr>
	                                  <td width="4%"><img src="/img/event/event/box_l.gif" width="11" height="30"></td>
	                                  <td width="92%"><a href="/html/event/event/webhard/index.asp"><img src="/img/event/event/btn_detail.gif"   vspace="5" border="0"></a></td>
	                                  <td width="4%" align="right"><img src="/img/event/event/box_r.gif" width="11" height="30"></td>
	                                </tr>
	                              </table></td>
	                          </tr>
