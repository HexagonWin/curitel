...
function pop()
{
	...
	eventWindow1  =  window.open("http://www.event1000.co.kr/APTNQ0406N01/who/game.html?userid=" , "eventpopup", "menubar=0,resiable=0,scrollbars=0 , width=500,height=350,left=3,top=182");
...
<script language='JavaScript'><!--// 
adURL="http://ad.realmedia.co.kr/RealMedia/ads/adstream_jx.ads/www.curitel.com/adpage_two@x01"; 
...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/event/tgi/tgi01.asp">
					<tr>
...
<tr><td><img src="tgi01_img1.gif" width="537" height="210" usemap="#m1"></td></tr>
<tr><td><img src="tgi01_img2.gif" width="537" height="235"></td></tr>
<tr><td><img src="tgi01_img3.gif" width="537" height="173"></td></tr>
<tr><td><img src="tgi01_img4.gif" width="537" height="247"></td></tr>
<tr><td><img src="tgi01_img5.gif" width="537" height="206"></td></tr>
<tr><td height=40 align=right valign=bottom><a href="tgi.asp"><img src="btn_main.gif" width="80" height="26"></a></td></tr>
...
<area shape="rect" coords="303,74,396,103" href="javascript:alert('이벤트가 종료 되었습니다.')">
