...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/event/slimslide/index.asp">
					<tr>
			...
			<table width="597" cellpadding="0" cellspacing="0" border="0">
				<tr>
					...
					<TABLE WIDTH=539 BORDER=0 CELLPADDING=0 CELLSPACING=0 style="border:0 solid D8DAD7;margin:25 0 0 33;">
						...
						<tr><td><img src="/img/event/event/slimslide_01.gif"></td></tr>
						<tr><td><img src="/img/event/event/slimslide_02.gif"></td></tr>
						<tr><td><img src="/img/event/event/slimslide_03.gif" usemap="#1"></td></tr>

					</TABLE>

					<map name=1>
					<AREA SHAPE=rect COORDS="364,164,502,203" href="http://ktf.redpi.co.kr/Slim/Web/Index.asp" onfocus="this.blur()" target="_new">
					</map>
