...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/event/sailer/sailer.asp">
					<tr>
	                    ...
	                    <tr> 
								<td> 
									...
									<table border="0" cellpadding="0" cellspacing="0">
										<tr> 
											<td><img src="/html/event/event/sailer/img1.gif" width="537" height="474" border="0" usemap="#Map"></td>
										</tr>
									</table>
<map name="Map">
	<area shape="circle" coords="394,230,15" href="#">
	<area shape="circle" coords="416,271,15" href="#">
	<area shape="circle" coords="432,345,15" href="#">
</map>
												</td>
	                    </tr>
	                  </table>
