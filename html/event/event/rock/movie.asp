...
function movieplay(){
	...
	window.open("movieplay.asp","filedownload","width=422,height=500,scrollbars=no,resizable=no");
}
//-->
</script>
...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/event/rock/movie.asp">
					<tr>
...
<TABLE WIDTH=534 BORDER=0 CELLPADDING=0 CELLSPACING=0>
	<TR>
		<TD>
			<IMG SRC="images/final_01.jpg" WIDTH=534 HEIGHT=246 ALT=""></TD>
	</TR>
	<TR>
		<TD>
			<IMG SRC="images/final_02.jpg" WIDTH=534 HEIGHT=130 ALT=""></TD>
	</TR>
	<TR>
		<TD>
			<IMG SRC="images/final_03.jpg" WIDTH=534 HEIGHT=166 ALT=""></TD>
	</TR>
	<TR>
		<TD>
			<IMG SRC="images/final_04.jpg" WIDTH=534 HEIGHT=318 ALT=""></TD>
	</TR>
</TABLE>
</td>
</tr>
...
<map name="Map">
  <area shape="rect" coords="75,309,164,337" href="javascript:movieplay()">
</map>
