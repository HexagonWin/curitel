...
<!--
	function lulu_go(objform){
		
		confirmLogin();
		return ;
		
			
		if(objform.answer1.value == "" )
		{
			alert("정답을 입력해주세요.");
			objform.answer1.focus();
			return ; 
		}
		if(objform.answer2.value == "" )
		{
			alert("정답을 입력해주세요.");
			objform.answer2.focus();
			return ; 
		}
		if(objform.answer3.value == "" )
		{
			alert("정답을 입력해주세요.");
			objform.answer3.focus();
			return ; 
		}
		if(objform.answer4.value == "" )
		{
			alert("정답을 입력해주세요.");
			objform.answer4.focus();
			return ; 
		}
		if(objform.answer5.value == "" )
		{
			alert("정답을 입력해주세요.");
			objform.answer5.focus();
			return ; 
		}

		validstr  ="0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_";

   		for (i=1; i<6; i++) 
		{
			  if(validstr.indexOf(eval("objform.answer"+i+".value.substring(0,1)"))>0) 
			  {
					alert('한글입력만 가능합니다!'); 
					eval("objform.answer"+i+".focus()");
					return ;
			  }
		}
			objform.target = "irun2005"
			objform.action= "run_process.asp"
			objform.submit();
	}
...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/event/lulu/index.asp">
					<tr>
		...
		<td width="597" valign="top" style="padding:0 0 15 0">
			<table width="597" cellpadding="0" cellspacing="0" border="0">
				<tr>
					...
					<!-- #####Contents Start ##### -->
<form name="run" method="post" onKeyDown = "keyEnter() ">
<TABLE WIDTH=572 BORDER=0 CELLPADDING=0 CELLSPACING=0 style="margin:25 0 0 23">
	<TR><TD><IMG SRC="img/lulu_img01.jpg"  width="539" height="385" ALT="" style="margin:0 0 0 10"></TD></TR>
	<TR><TD height="108" style="background:url(img/lulu_img02.jpg) no-repeat 10 top;padding:10 0 0 75">
		<input type="text" name="answer1" maxlength="1" style="width:24;height:20;ime-mode:active;background:;border:0;font-size:14pt;letter-spacing:8;font-weight:bold">
		<input type="text" name="answer2" maxlength="1" style="width:24;height:20;ime-mode:active;background:;border:0;font-size:14pt;letter-spacing:8;font-weight:bold">
		<input type="text" name="answer3" maxlength="1" style="width:24;height:20;ime-mode:active;background:;border:0;font-size:14pt;letter-spacing:8;font-weight:bold">
		<input type="text" name="answer4" maxlength="1" style="width:24;height:20;ime-mode:active;background:;border:0;font-size:14pt;letter-spacing:8;font-weight:bold">
		<input type="text" name="answer5" maxlength="1" style="width:24;height:20;ime-mode:active;background:;border:0;font-size:14pt;letter-spacing:8;font-weight:bold" >
		
	<!-- 응모하기  -->
	
		<a href="javascript:alert('이벤트가 기간이 아닙니다.');">
	
	<img src="img/btn_apply.gif" align="absmiddle" style="margin:0 0 0 26">
	</a>
	
	<!-- 응모하기 -->


		<a href="http://www.curitel.com/html/prroom/ad/tvcf_view.asp?idx=28" target="_blank"><img src="img/hint_tvcf.gif" align="absmiddle" style="margin:10 0 0 12"></a>
	</TD></TR>
	<TR><TD><IMG SRC="img/lulu_img03.jpg" width="539" height="480" ALT="" style="margin:0 0 0 10" usemap="#Map"></TD></TR>
</TABLE>
</form>
...
<map name="Map">
<area shape="poly" coords="70,190,74,205,124,193,122,179" href="javascript:pop('pop_picture.asp','img01','400','320')" onFocus="blur()">
<area shape="poly" coords="306,175,303,189,361,200,363,186" href="javascript:pop('pop_picture02.asp','img02','400','320')" onFocus="blur()">
<area shape="rect" coords="66,436,119,453" href="javascript:pop('pop_picture03.asp','img03','400','320')" onFocus="blur()">
<area shape="rect" coords="225,176,253,190" href="http://www.curitel.com/html/product/product_mains/pt-k1100.asp?serial_no=91" target="_blank" onFocus="blur()">
<area shape="rect" coords="443,208,471,222" href="http://www.curitel.com/html/product/product_mains/pt-s110.asp?serial_no=90" target="_blank" onFocus="blur()">
<area shape="rect" coords="353,377,381,391" href="http://www.curitel.com/html/product/lineup/feature.asp?serial_no=94" target="_blank" onFocus="blur()">     
</map>
