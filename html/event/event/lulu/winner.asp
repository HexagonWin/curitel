...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/event/lulu/winner.asp">
					<tr>
				...
				<tr>
					<td valign="top" class="ctsmgn">
 	                  ...
 	                  <table cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							<td style="padding:25 0 0 0" align="center"><img src="/img/event/event/lulu_0902_img01.gif"></td>
						</tr>
						<tr>
							<td align="center"><img src="/img/event/event/lulu_0902_img02.gif"></td>
						</tr>
						<tr>
							<td align="center" background="/img/event/event/lulu_0902_img03.gif" height=185>
								<table border=0 cellpadding=0 cellspacing=0 width=100%>
								<col width=75 style="padding-left:70">
								<col width=75>
								<col width=75>
								<col width=70>
								<col width=75>
						...
						<tr>
							<td align="center"><img src="/img/event/event/lulu_0902_img04.gif"></td>
						</tr>
