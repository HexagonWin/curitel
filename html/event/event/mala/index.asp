...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/event/mala/index.asp">
					<tr>
...
<TABLE WIDTH=572 BORDER=0 CELLPADDING=0 CELLSPACING=0 style="margin:25 0 0 23">
	<TR>
		<TD >
			<IMG SRC="img/mala_img1.gif"  width="539" height="392" ALT="" style="margin:0 0 0 10"></TD>
	</TR>
	<TR>
		<TD>
			<IMG SRC="img/mala_img2.gif" width="539" height="392" ALT="" style="margin:0 0 0 10" usemap="#Map"></TD>
	</TR>
</TABLE>
...
<map name="Map">
	...
	<area shape="rect" coords="16,299,154,339" href="javascript:alert('이벤트가 종료되었습니다.');">
