...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/event/fanmeeting/index.asp">
					<tr>
...
<TABLE WIDTH=572 BORDER=0 CELLPADDING=0 CELLSPACING=0 style="margin:25 0 0 23">
	<TR>
		<TD >
			<IMG SRC="img/fanmeeting_img01.jpg"  width="538" height="330" ALT="" style="margin:0 0 0 10"></TD>
	</TR>
	<TR>
		<TD>
	<!-- 응모하기  -->
	
	<IMG SRC="img/fanmeeting_img02.jpg" width="538" height="330" ALT="" style="margin:0 0 0 10"  useMap="#Map">
	</a>
...
<map name="Map">
	...
	<area shape="rect" coords="266,25,344,61" href="javascript:alert('이벤트가 기간이 아닙니다.');">
</map>
