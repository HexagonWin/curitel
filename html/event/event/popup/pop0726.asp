...
<table width="337" cellpadding="0" cellspacing="0" border="0">
	<tr>
		<td align="center" style="padding-top:5"><a href="javascript:;" onclick="opener.parent.location.href='/html/event/event/tslide2/index.asp';window.close();"><img src="/html/event/event/popup/img/p0726/img001.jpg" border="0" width=325 height=204></a></td>
	</tr>
</table>
