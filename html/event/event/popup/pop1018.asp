...
<table width="337" cellpadding="0" cellspacing="0" border="0">
	<tr>
		<td bgcolor="#ffffff" align="center" valign="top"><img src="/html/event/event/popup/img/p1018/p1018_1.jpg" alt="" width="337" height="267" border="0" usemap="#p01"><br>
		<img src="/html/event/event/popup/img/p1018/p1018_2.jpg" alt="" height=380 width=337 border="0" usemap="#p02"></td>
	</tr>
</table>
...
<map name="p01">
   <area shape="circle" coords="142,226,30" href="javascript:;" onclick="opener.parent.location.href='/html/event/event/single/index.asp';window.close();" onFocus="this.blur()">
</map>
<map name="p02">
	<area shape="circle" coords="143,110,22" href="javascript:;" onclick="opener.parent.location.href='/html/event/event/designcontest/index.asp';window.close();" onFocus="this.blur()">
    <area shape="rect" coords="221,246,316,276" href="javascript:;" onclick="opener.parent.location.href='http://www.curitel.com/html/help/notice/view.asp?idx=62';window.close();" onFocus="this.blur()">
</map>
</map>
</body>
</html>