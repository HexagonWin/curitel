...
<table width="337" cellpadding="0" cellspacing="0" border="0">
	<tr>
		<td style="padding-top:5"><a href="javascript:;" onclick="opener.parent.location.href='http://www.curitel.com/html/help/notice/view.asp?idx=92';window.close();" onFocus="this.blur()"><img src="/html/event/event/popup/img/p1101/1108.gif" border="0"></a></td>
	</tr>
	<tr>
		<td valign="top"><a href="javascript:;" onclick="opener.parent.location.href='http://www.curitel.com/html/event/event/designcontest/designcontest_result.asp';window.close();" onFocus="this.blur()"><img src="/html/event/event/popup/dcon01.gif" border="0"></a></td>
	</tr>
</table>
