...
<table width="337" cellpadding="0" cellspacing="0" border="0">
	<tr>
		<td align="center" style="padding-top:5"><img src="/html/event/event/popup/img/p0114/img001.gif" border="0" width=325 height=355 usemap=#Map></td>
	</tr>
</table>
...
<map name="Map">
  <area shape="rect" coords="13,185,139,216"  href="javascript:;" onclick="opener.parent.location.href='/html/event/event/mala/index.asp';window.close();" onFocus="this.blur()">
</map>
