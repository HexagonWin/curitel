...
<table width="325" cellpadding="0" cellspacing="1" border="0" bgcolor="#43859D">
	<tr>
		...
		<img src="/html/event/event/popup/img/p0902_01.jpg" alt="" width="311" height="327" border="0" class="mgn" usemap="#p01"></td>
	</tr>
</table>
...
<map name="p01">
   <area shape="circle" coords="247,268,36" href="javascript:;" onclick="opener.parent.location.href='/html/event/event/designcontest/index.asp';window.close();" onFocus="this.blur()">
</map>
<map name="p02" id="ktf2">
   <area shape="rect" coords="144,107,228,129" href="javascript:;" onclick="opener.parent.location.href='/html/event/event/rock/movie.asp';window.close();" onFocus="this.blur()">
</map>
</body>
</html>