...
<body  background="/html/event/event/popup/popbg.gif" ONMOVE="self.moveTo(40,250);" ONLOAD="self.moveTo(40,250);">
<table width="337" cellpadding="0" cellspacing="0" border="0">
	<tr>
		<td align="center" valign="top" style='padding-top:5'><a href="javascript:GoGo();"><img src="/html/event/event/popup/img/reuse.gif" alt="" width="325" height="279" border="0" usemap="#p01"></a></td>
	</tr>
</table>
...
<!--
	function GoGo()
	{
		opener.location.href='http://www.curitel.com/html/help/reuse.asp'
		this.close();
	}
//-->
</script>
