...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/event/single/index.asp">
					<tr>
			...
			<table width="597" cellpadding="0" cellspacing="0" border="0">
				<tr>
					...
					<table width="547" height="100%" border="0" cellpadding="0" cellspacing="0" style="margin:0 0 0 33">
                        <tr>
                          <td><img src="/img/event/subimg02_1.gif" width="547" height="97"></td>
                        </tr>
                        <tr>
                          <td height="1"></td>
                        </tr>
						...
						<TABLE WIDTH=582 BORDER=0 CELLPADDING=0 CELLSPACING=0>
							<TR>
								<TD style="padding-left:20">
									<IMG SRC="img/s_img01.gif" WIDTH=582 HEIGHT=321></TD>
							</TR>
							<TR>
								<TD style="padding-left:20">
									<IMG SRC="img/s_img02.jpg" WIDTH=582 HEIGHT=362></TD>
							</TR>
							<TR>
								<TD style="padding-left:20">
									<IMG SRC="img/s_img03.jpg" ALT="" WIDTH=582 HEIGHT=335 usemap="#map2"></TD>
							</TR>
							<TR>
								<TD style="padding-left:20">
									<IMG SRC="img/s_img04.jpg" ALT="" WIDTH=582 HEIGHT=217 usemap="#map3"></TD>
							</TR>
						</TABLE>
...
<!-- <map name="Map">
  <area shape="poly" coords="228,203,348,184,363,212,235,234" href="photo_up.asp">
</map>
<map name="Map2">
    <area shape="circle" coords="408,64,42" href="single_one.asp">
</map>
<map name="Map3">
    <area shape="circle" coords="254,94,41" href="single_two.asp">
</map> -->
<map name="Map2">
    <area shape="circle" coords="408,64,42" href="javascript:alert('이벤트가 종료되었습니다.');">
</map>
<map name="Map3">
    <area shape="circle" coords="254,94,41" href="javascript:alert('이벤트가 종료되었습니다.');">
</map>
</body>
</html>
