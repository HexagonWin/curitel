...
function photo_search(){
	window.open("photo_search.asp","photo","width=420,height=412");
}
//-->
</script>
...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/event/ktf/photo_up.asp">
					<tr>
		...
		<td width="597" valign="top" style="padding:0 0 15 0">
			<table width="597" cellpadding="0" cellspacing="0" border="0">
				<tr>
					...
					<!-- #####Contents Start ##### -->
<TABLE WIDTH=537 BORDER=0 CELLPADDING=0 CELLSPACING=0 style="margin:25 0 0 33">

	<TR>
		<TD style="background:url(img/ktf_img04.gif) no-repeat; align:top; padding:404 0 0 10;" WIDTH=537 HEIGHT=441 colspan="3"><a href="javascript:alert('이벤트가 종료 되었습니다.');"><IMG src="img/btn_upload.gif" border="0" ></a></TD></TR> 
<tr>	
		<TD style="padding:14 0 0 10" valign="top">
			<table cellspacing=0 cellpadding=0 border=0>
				<tr>
					  <td WIDTH=161 height="147" style="background:url(img/ktf_bg01.gif) no-repeat; padding:0 0 0 10" valign="top">
						<table cellpadding=o cellspacing=0 border=0>
							<tr>	
								<td align="right" height="25" style="padding:0 2 0 0">NO.665</td>
							</tr>
							<tr>
								<td align="center" valign="middle" style="padding:8 0 0 2"><a href="photo_view.asp?idx=701&page=1"><img src="http://file.curitel.com/upload/event_ktf/022_noname.jpg" style="border:1px; border-style:solid; border-color:#DADADA" width="130" height="96"></td>
							</tr>
						</table>
					  </td>
				<tr>
					<td style="padding:9 0 0 9">
						 <img src="img/orgdot.gif" valign="absmiddle"> 날아라 슈퍼맨!(0)<br> 

						 <img src="img/orgdot.gif" valign="absmiddle"> Curian : <A HREF=javascript:; onmouseover=snMenu('hduhwan','')  onmouseout=Osn=0;setTimeout('hsnMenu()',200)>hduhwan</A><br> 

						 <img src="img/orgdot.gif" valign="absmiddle"> 2004-08-31 
					</td>
				</tr>
				</tr>
			</table>
			...
			<table cellspacing=0 cellpadding=0 border=0>
				<tr>
					  <td WIDTH=161 height="147" style="background:url(img/ktf_bg01.gif) no-repeat; padding:0 0 0 10" valign="top">
						<table cellpadding=o cellspacing=0 border=0>
							<tr>	
								<td align="right" height="25" style="padding:0 2 0 0">NO.664</td>
							</tr>
							<tr>
								<td align="center" valign="middle" style="padding:8 0 0 2"><a href="photo_view.asp?idx=700&page=1"><img src="http://file.curitel.com/upload/event_ktf/004_noname(3).jpg" style="border:1px; border-style:solid; border-color:#DADADA" width="130" height="96"></td>
							</tr>
						</table>
					  </td>
				<tr>
					<td style="padding:9 0 0 9">
						 <img src="img/orgdot.gif" valign="absmiddle"> 인형을 안고 있는 ...(0)<br> 
			...
			<table cellspacing=0 cellpadding=0 border=0>
				<tr>
					  <td WIDTH=161 height="147" style="background:url(img/ktf_bg01.gif) no-repeat; padding:0 0 0 10" valign="top">
						<table cellpadding=o cellspacing=0 border=0>
							<tr>	
								<td align="right" height="25" style="padding:0 2 0 0">NO.663</td>
							</tr>
							<tr>
								<td align="center" valign="middle" style="padding:8 0 0 2"><a href="photo_view.asp?idx=699&page=1"><img src="http://file.curitel.com/upload/event_ktf/108970026966011.jpg" style="border:1px; border-style:solid; border-color:#DADADA" width="130" height="96"></td>
							</tr>
						</table>
					  </td>
				<tr>
					<td style="padding:9 0 0 9">
						 <img src="img/orgdot.gif" valign="absmiddle"> 개아직남은거올림니다(0)<br> 

						 <img src="img/orgdot.gif" valign="absmiddle"> Curian : <A HREF=javascript:; onmouseover=snMenu('qa23zx','')  onmouseout=Osn=0;setTimeout('hsnMenu()',200)>qa23zx</A><br> 
			...
			<table cellspacing=0 cellpadding=0 border=0>
				<tr>
					  <td WIDTH=161 height="147" style="background:url(img/ktf_bg01.gif) no-repeat; padding:0 0 0 10" valign="top">
						<table cellpadding=o cellspacing=0 border=0>
							<tr>	
								<td align="right" height="25" style="padding:0 2 0 0">NO.662</td>
							</tr>
							<tr>
								<td align="center" valign="middle" style="padding:8 0 0 2"><a href="photo_view.asp?idx=698&page=1"><img src="http://file.curitel.com/upload/event_ktf/109340621762687.jpg" style="border:1px; border-style:solid; border-color:#DADADA" width="130" height="96"></td>
							</tr>
						</table>
					  </td>
				<tr>
					<td style="padding:9 0 0 9">
						 <img src="img/orgdot.gif" valign="absmiddle"> 울집개임니다(0)<br> 
			...
			<table cellspacing=0 cellpadding=0 border=0>
				<tr>
					  <td WIDTH=161 height="147" style="background:url(img/ktf_bg01.gif) no-repeat; padding:0 0 0 10" valign="top">
						<table cellpadding=o cellspacing=0 border=0>
							<tr>	
								<td align="right" height="25" style="padding:0 2 0 0">NO.661</td>
							</tr>
							<tr>
								<td align="center" valign="middle" style="padding:8 0 0 2"><a href="photo_view.asp?idx=697&page=1"><img src="http://file.curitel.com/upload/event_ktf/aulbin_1.jpg" style="border:1px; border-style:solid; border-color:#DADADA" width="130" height="96"></td>
							</tr>
						</table>
					  </td>
				<tr>
					<td style="padding:9 0 0 9">
						 <img src="img/orgdot.gif" valign="absmiddle"> 나의 이쁜강아지~(0)<br> 
			...
			<table cellspacing=0 cellpadding=0 border=0>
				<tr>
					  <td WIDTH=161 height="147" style="background:url(img/ktf_bg01.gif) no-repeat; padding:0 0 0 10" valign="top">
						<table cellpadding=o cellspacing=0 border=0>
							<tr>	
								<td align="right" height="25" style="padding:0 2 0 0">NO.660</td>
							</tr>
							<tr>
								<td align="center" valign="middle" style="padding:8 0 0 2"><a href="photo_view.asp?idx=696&page=1"><img src="http://file.curitel.com/upload/event_ktf/루와 유도.jpg" style="border:1px; border-style:solid; border-color:#DADADA" width="130" height="96"></td>
							</tr>
						</table>
					  </td>
				<tr>
					<td style="padding:9 0 0 9">
						 <img src="img/orgdot.gif" valign="absmiddle"> 루! 너를 내 의자...(0)<br> 

						 <img src="img/orgdot.gif" valign="absmiddle"> Curian : <A HREF=javascript:; onmouseover=snMenu('lsjy7707','')  onmouseout=Osn=0;setTimeout('hsnMenu()',200)>lsjy7707</A><br> 
			...
			<table cellspacing=0 cellpadding=0 border=0>
				<tr>
					  <td WIDTH=161 height="147" style="background:url(img/ktf_bg01.gif) no-repeat; padding:0 0 0 10" valign="top">
						<table cellpadding=o cellspacing=0 border=0>
							<tr>	
								<td align="right" height="25" style="padding:0 2 0 0">NO.659</td>
							</tr>
							<tr>
								<td align="center" valign="middle" style="padding:8 0 0 2"><a href="photo_view.asp?idx=695&page=1"><img src="http://file.curitel.com/upload/event_ktf/루2.jpg" style="border:1px; border-style:solid; border-color:#DADADA" width="130" height="96"></td>
							</tr>
						</table>
					  </td>
				<tr>
					<td style="padding:9 0 0 9">
						 <img src="img/orgdot.gif" valign="absmiddle"> 잘생긴 루~(0)<br> 
			...
			<table cellspacing=0 cellpadding=0 border=0>
				<tr>
					  <td WIDTH=161 height="147" style="background:url(img/ktf_bg01.gif) no-repeat; padding:0 0 0 10" valign="top">
						<table cellpadding=o cellspacing=0 border=0>
							<tr>	
								<td align="right" height="25" style="padding:0 2 0 0">NO.658</td>
							</tr>
							<tr>
								<td align="center" valign="middle" style="padding:8 0 0 2"><a href="photo_view.asp?idx=694&page=1"><img src="http://file.curitel.com/upload/event_ktf/행복한 해피.jpg" style="border:1px; border-style:solid; border-color:#DADADA" width="130" height="96"></td>
							</tr>
						</table>
					  </td>
				<tr>
					<td style="padding:9 0 0 9">
						 <img src="img/orgdot.gif" valign="absmiddle"> ☆행복한 해피☆(0)<br> 
			...
			<table cellspacing=0 cellpadding=0 border=0>
				<tr>
					  <td WIDTH=161 height="147" style="background:url(img/ktf_bg01.gif) no-repeat; padding:0 0 0 10" valign="top">
						<table cellpadding=o cellspacing=0 border=0>
							<tr>	
								<td align="right" height="25" style="padding:0 2 0 0">NO.657</td>
							</tr>
							<tr>
								<td align="center" valign="middle" style="padding:8 0 0 2"><a href="photo_view.asp?idx=693&page=1"><img src="http://file.curitel.com/upload/event_ktf/해피 소세지 먹다.jpg" style="border:1px; border-style:solid; border-color:#DADADA" width="130" height="96"></td>
							</tr>
						</table>
					  </td>
				<tr>
					<td style="padding:9 0 0 9">
						 <img src="img/orgdot.gif" valign="absmiddle"> 해피는 소세지를 조...(0)<br> 
	...
	<tr>
		<td align="center" colspan="3" height="50" valign="bottom"><img src=/img/bbs/btn/btn_pre.gif width='54' height='17' alt='' border='0' align='absmiddle' hspace='26'>&nbsp;<b>|1|</b>&nbsp;<a href=photo_up.asp?page=2&ktype=uid&kword=>|2|</a>&nbsp;<a href=photo_up.asp?page=3&ktype=uid&kword=>|3|</a>&nbsp;<a href=photo_up.asp?page=4&ktype=uid&kword=>|4|</a>&nbsp;<a href=photo_up.asp?page=5&ktype=uid&kword=>|5|</a>&nbsp;<a href=photo_up.asp?page=6&ktype=uid&kword=>|6|</a>&nbsp;<a href=photo_up.asp?page=7&ktype=uid&kword=>|7|</a>&nbsp;<a href=photo_up.asp?page=8&ktype=uid&kword=>|8|</a>&nbsp;<a href=photo_up.asp?page=9&ktype=uid&kword=>|9|</a>&nbsp;<a href=photo_up.asp?page=10&ktype=uid&kword=>|10|</a>&nbsp;<a href=photo_up.asp?page=11&ktype=uid&kword=><img src=/img/bbs/btn/btn_next.gif width='54' height='17' alt='' border='0' align='absmiddle' hspace='26'></a></td>
	</tr>
	  <form name=searchForm>
	<tr>
		<td align="center" style="padding:15 5 0 0" colspan="3"><select name="ktype" style="width:100" >
        <option value="uid">아이디/MMS No 
        <option value="subject">제목 
		</select> <input name="kword" type="text" style="width:120" value=""> 
		<input type="image" src="/img/bbs/btn/btn_search.gif" width="46" height="17" alt="" border="0" align="absmiddle"></td>	
	</tr>
	</form>
	<TR>
		<TD align="right" style="padding:20 0 0 0" colspan="3">
			<IMG SRC="img/copy.gif" ALT="" WIDTH=442 HEIGHT=52 border="0"></TD>
	</TR>
</TABLE>
<SCRIPT LANGUAGE="JavaScript">
<!--
//검색 셀렉트 선택
    document.all.ktype.value = "uid";
//-->
</SCRIPT>
