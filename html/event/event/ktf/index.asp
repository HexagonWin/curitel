...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/event/ktf/index.asp">
					<tr>
...
<TABLE WIDTH=572 BORDER=0 CELLPADDING=0 CELLSPACING=0 style="margin:25 0 0 23">
	<TR>
		<TD >
			<IMG SRC="img/ktf_img01.gif" WIDTH=538 HEIGHT=390 ALT="" style="margin:0 0 0 10"></TD>
	</TR>
	<TR>
		<TD>
			<IMG SRC="img/ktf_img02.gif" WIDTH=561 HEIGHT=261 ALT="" style="margin:0 0 0 10" usemap="#Map"></TD>
	</TR>
	<TR>
		<TD>
			<IMG SRC="img/ktf_img03.gif" ALT="" WIDTH=572 HEIGHT=278 border="0"></TD>
	</TR>
	<TR>
		<TD align="right" style="padding:15 23 0 0">
