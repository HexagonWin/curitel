...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/event/ktf/winner.asp">
					<tr>
				...
				<tr>
					<td valign="top" class="ctsmgn">
	                  ...
	                  <table width="572" cellpadding="0" cellspacing="0" border="0">
	                    <tr> 
	                      <td height="97" style="padding-left:8;"><img src="img/top_img01.jpg" width="537" height="97" border="0"></td>
	                    </tr>
						<tr>
							<td height="28" style="padding-left:8;" valign="top">
								<table border="0" cellpadding="0" cellspacing="0" width="537" height="28">
									<tr>
										<td width="537" height="2"></td>
									</tr>
									<tr>
										<td width="537" height="26" bgcolor="#F6F8F9"></td>
									</tr>
									<tr>
										<td width="537" height="2"></td>
									</tr>
						...
						<tr>
							<td height="235"><img src="img/img01.jpg" border="0"></td>
						</tr>
						<tr>
							<td height="244"><img src="img/img02.jpg" border="0"></td>
						</tr>
						<tr>
							<td height="234"><img src="img/img03.jpg" border="0"></td>
						</tr>
						<tr>
							<td valign="top" style="padding-left:8;">
								<table border="0" cellpadding="0" cellspacing="0" width="537">
									<tr>
										<td colspan="4" style="padding-left:8;padding-top:12;padding-bottom:8;"><img src="img/s_title01.jpg" border="0"></td>
									</tr>
									<tr>
										<td height="12" bgcolor="#EFEFEF" colspan="4"></td>
									</tr>
									<tr>
										<td width="134" bgcolor="#EFEFEF" height="20" align="center" align="center">010-xxxx-7713님/</td>
										<td width="134" bgcolor="#EFEFEF" align="center" align="center">010-xxxx-0140님/</td>
										<td width="134" bgcolor="#EFEFEF" align="center" align="center">011-xxxx-4885님/</td>
										<td width="135" bgcolor="#EFEFEF" align="center" align="center">016-xxxx-0415님/</td>
									</tr>
									<tr>
										<td width="134" bgcolor="#EFEFEF" height="20" align="center" align="center">011-xxxx-6552님/</td>
										<td width="134" bgcolor="#EFEFEF" align="center" align="center">010-xxxx-4041님/</td>
										<td width="134" bgcolor="#EFEFEF" align="center" align="center">016-xxxx-0528님/</td>
										<td width="135" bgcolor="#EFEFEF" align="center" align="center">010-xxxx-0728님/</td>
									</tr>
									<tr>
										<td width="134" bgcolor="#EFEFEF" height="20" align="center">011-xxxx-2805님/</td>
										<td width="134" bgcolor="#EFEFEF" align="center" align="center">016-xxxx-7771님/</td>
										<td width="134" bgcolor="#EFEFEF"></td>
										<td width="135" bgcolor="#EFEFEF"></td>
									</tr>
									<tr>
										<td height="12" bgcolor="#EFEFEF" colspan="4"></td>
									</tr>
						...
						<tr>
							<td valign="top" style="padding-left:8;">
								<table border="0" cellpadding="0" cellspacing="0" width="537">
									<tr>
										<td colspan="8" style="padding-left:8;padding-top:12;padding-bottom:8;"><img src="img/s_title02.jpg" border="0"></td>
									</tr>
									<tr>
										<td height="12" bgcolor="#EFEFEF" colspan="8"></td>
									</tr>
									<tr bgcolor="#EFEFEF" height="20">
										<td style="padding:0 0 0 20">jungblue78</td>
										<td>정주영/&nbsp;&nbsp;</td>
										<td>hyuiin</td>
										<td>송혜인/&nbsp;&nbsp;</td>
										<td>mimizzzang</td>
									...
									<tr bgcolor="#EFEFEF" height="20">
										<td style="padding:0 0 0 20">neat0000</td>
										<td>이정희/&nbsp;&nbsp;</td>
										<td>ckwolf</td>
										<td>이대근/&nbsp;&nbsp;</td>
										<td>harusary</td>
									...
									<tr bgcolor="#EFEFEF" height="20">
										<td style="padding:0 0 0 20">SUSIA6020</td>
										<td>김민지/&nbsp;&nbsp;</td>
										<td>berepper</td>
										<td>박인식/&nbsp;&nbsp;</td>
										<td>&nbsp;</td>
