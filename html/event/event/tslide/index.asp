...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/event/tslide/index.asp">
					<tr>
...
<TABLE WIDTH=572 BORDER=0 CELLPADDING=0 CELLSPACING=0 style="margin:25 0 0 23">
	<TR>
		<TD >
			<IMG SRC="img/tslide_img01.jpg"  width="539" height="362" ALT="" style="margin:0 0 0 10"></TD>
	</TR>
	<TR>
		<TD>
			<IMG SRC="img/tslide_img02.jpg" width="539" height="362" ALT="" style="margin:0 0 0 10" usemap="#Map"></TD>
	</TR>
</TABLE>
...
<map name="Map">
    <area shape="rect" coords="306,298,490,341" href="http://cyworld.nate.com/tslide" onfocus=blur() target=_blank>
</map>
