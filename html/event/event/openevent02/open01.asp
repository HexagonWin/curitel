...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/event/openevent02/open01.asp">
					<tr>
...
<option value='13'>광고</option>
	...
	<tr><td height="13"></td></tr>
		...
		<td width="597" valign="top">
			<table width="597" cellpadding="0" cellspacing="0" border="0">
				<tr>
                  ...
                  <table border=0 cellpadding=0 cellspacing=0>
                    <tr> 
                      <td><img src="img01.gif" width="534" height="300"></td>
                    </tr>
                    <tr> 
                      <td><img src="img02.gif" width="534" height="369" border="0" usemap="#Map"></td>
                    </tr>
                  </table>
            ...
            <p align="right"><img src="img03.gif" width="572" height="350"><br>
              <img src="img04.gif" width="572" height="337" border="0" usemap="#Map2"></p>
            <!-- #####//Contents End ##### -->
          </td>
				</tr>
			</table>
...
<map name="Map">
  <area shape="rect" coords="390,316,491,342" href="/html/my/join/index.asp" onFocus="this.blur()">
  <area shape="rect" coords="253,316,375,344" href="../openevent01/open01.asp" onFocus="this.blur()">
</map>
<map name="Map2">
  <area shape="rect" coords="28,274,157,302" href="open01_list.asp" onFocus="this.blur()">
  <area shape="rect" coords="172,273,300,302" href="open02_list.asp" onFocus="this.blur()">
  <area shape="rect" coords="312,274,417,301" href="/html/my/join/index.asp" onFocus="this.blur()">
</map>
</body>
</html>