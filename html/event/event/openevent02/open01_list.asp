...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/event/openevent02/open01_list.asp">
					<tr>
...
<option value='13'>광고</option>
	...
	<tr><td height="13"></td></tr>
		...
		<td width="597" valign="top">
            ...
            <table width="557" border="0" align="right" cellpadding="0" cellspacing="0">
              <tr> 
              ...
              <tr>
                <td><img src="titimg01.gif" width="568" height="337" border="0" usemap="#Map" alt="작성하기"></td>
              </tr>
              <tr>
                <td><table width="520" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><img src="table01.gif" width="520" height="31"></td>
                    </tr>
                    <tr>
                      <td align="center" background="table03.gif" style="padding:20 0"> 
                        <!--- 이벤트2 게시판 --->
                        <table width="479" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td width="479" height="37" colspan="6" valign="top"><img src="table_list01.gif" width="479" height="31"></td>
                          </tr>
                        </table>
                        <table width="460" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr> 
                            <td width="39" height="25">503<!--25--></td>
                            <td width="192"><a href="open01_view.asp?idx=543&num=503&page=1&search_key=&search_value=">쿨 하다...헤어진 그애 앞에서 울지않은나....</a></td>
                            <td width="75">darkill2<!--NICEGUYC--></td>
                            <td width="64">2004.06.30<!--2003.09.09--></td>
                            <td width="47">43<!--100--></td>
                            <td width="53">2<!--100--></td>
                          </tr>
                          <tr> 
                            <td height="1" colspan="6"><img src="table_line.gif" width="470" height="1"></td>
                          </tr>
						  <!--
                          <tr> 
                            <td height="25">25</td>
                            <td><a href="#">☆★초강추LUXURT M.T(강촌..)</a></td>
                            <td>NICEGUYC</td>
                            <td>2003.09.09</td>
                            <td>100</td>
                            <td>100</td>
                          ...
                          <tr> 
                            <td width="39" height="25">502<!--25--></td>
                            <td width="192"><a href="open01_view.asp?idx=542&num=502&page=1&search_key=&search_value=">큐리텔과 함께</a></td>
                            <td width="75">esuji1119<!--NICEGUYC--></td>
                            <td width="64">2004.06.30<!--2003.09.09--></td>
                            <td width="47">27<!--100--></td>
                            <td width="53">1<!--100--></td>
                          </tr>
                          <tr> 
                            <td height="1" colspan="6"><img src="table_line.gif" width="470" height="1"></td>
                          </tr>
                          ...
                          <tr> 
                            <td width="39" height="25">501<!--25--></td>
                            <td width="192"><a href="open01_view.asp?idx=541&num=501&page=1&search_key=&search_value=">얼음맛을 아세요?</a></td>
                            <td width="75">bhs55<!--NICEGUYC--></td>
                            <td width="64">2004.06.30<!--2003.09.09--></td>
                            <td width="47">36<!--100--></td>
                            <td width="53">2<!--100--></td>
                          </tr>
                          <tr> 
                            <td height="1" colspan="6"><img src="table_line.gif" width="470" height="1"></td>
                          ...
                          <tr> 
                            <td width="39" height="25">500<!--25--></td>
                            <td width="192"><a href="open01_view.asp?idx=540&num=500&page=1&search_key=&search_value=">내 인생의 로또~</a></td>
                            <td width="75">buza<!--NICEGUYC--></td>
                            <td width="64">2004.06.30<!--2003.09.09--></td>
                            <td width="47">42<!--100--></td>
                            <td width="53">4<!--100--></td>
                          </tr>
                          <tr> 
                            <td height="1" colspan="6"><img src="table_line.gif" width="470" height="1"></td>
                          </tr>
                          ...
                          <tr> 
                            <td width="39" height="25">499<!--25--></td>
                            <td width="192"><a href="open01_view.asp?idx=539&num=499&page=1&search_key=&search_value=">인생 에서 정말 당황한적 17살인생에서 ㅋ</a></td>
                            <td width="75">yjy88Star<!--NICEGUYC--></td>
                            <td width="64">2004.06.30<!--2003.09.09--></td>
                            <td width="47">30<!--100--></td>
                            <td width="53">2<!--100--></td>
                          </tr>
                          <tr> 
                            <td height="1" colspan="6"><img src="table_line.gif" width="470" height="1"></td>
                          ...
                          <tr> 
                            <td width="39" height="25">498<!--25--></td>
                            <td width="192"><a href="open01_view.asp?idx=538&num=498&page=1&search_key=&search_value=">태극기를 휘날리며보며.엄마도 여린여자임을알았습니다.</a></td>
                            <td width="75">36tkddnjs<!--NICEGUYC--></td>
                            <td width="64">2004.06.30<!--2003.09.09--></td>
                            <td width="47">33<!--100--></td>
                            <td width="53">1<!--100--></td>
                          </tr>
                          <tr> 
                            <td height="1" colspan="6"><img src="table_line.gif" width="470" height="1"></td>
                          ...
                          <tr> 
                            <td width="39" height="25">497<!--25--></td>
                            <td width="192"><a href="open01_view.asp?idx=537&num=497&page=1&search_key=&search_value=">제 사진이 엽기사이트에 ! </a></td>
                            <td width="75">jje446<!--NICEGUYC--></td>
                            <td width="64">2004.06.30<!--2003.09.09--></td>
                            <td width="47">33<!--100--></td>
                            <td width="53">1<!--100--></td>
                          </tr>
                          ...
                          <tr> 
                            <td width="39" height="25">496<!--25--></td>
                            <td width="192"><a href="open01_view.asp?idx=536&num=496&page=1&search_key=&search_value=">내 조카의 탄생일~</a></td>
                            <td width="75">songuen<!--NICEGUYC--></td>
                            <td width="64">2004.06.30<!--2003.09.09--></td>
                            <td width="47">36<!--100--></td>
                            <td width="53">3<!--100--></td>
                          </tr>
                          <tr> 
                            <td height="1" colspan="6"><img src="table_line.gif" width="470" height="1"></td>
                          </tr>
                          ...
                          <tr> 
                            <td width="39" height="25">495<!--25--></td>
                            <td width="192"><a href="open01_view.asp?idx=535&num=495&page=1&search_key=&search_value=">생전 처음 갔던 콘서트</a></td>
                            <td width="75">joh97<!--NICEGUYC--></td>
                            <td width="64">2004.06.30<!--2003.09.09--></td>
                            <td width="47">38<!--100--></td>
                            <td width="53">4<!--100--></td>
                          </tr>
                          <tr> 
                            <td height="1" colspan="6"><img src="table_line.gif" width="470" height="1"></td>
                          ...
                          <tr> 
                            <td width="39" height="25">494<!--25--></td>
                            <td width="192"><a href="open01_view.asp?idx=534&num=494&page=1&search_key=&search_value=">바로바로~!</a></td>
                            <td width="75">haha2426<!--NICEGUYC--></td>
                            <td width="64">2004.06.30<!--2003.09.09--></td>
                            <td width="47">29<!--100--></td>
                            <td width="53">2<!--100--></td>
                          </tr>
                          <tr> 
                            <td height="1" colspan="6"><img src="table_line.gif" width="470" height="1"></td>
                          ...
                          <tr align="center"> 
                            <td height="42" colspan="6"><a href="#">
<img src="/img/bbs/btn/btn_pre.gif" width="54" height="17" alt="" border="0" align="absmiddle" hspace="26">&nbsp;<b>|1|</b>&nbsp;<a href=open01_list.asp?page=2&search_key=&search_value=>|2|</a>&nbsp;<a href=open01_list.asp?page=3&search_key=&search_value=>|3|</a>&nbsp;<a href=open01_list.asp?page=4&search_key=&search_value=>|4|</a>&nbsp;<a href=open01_list.asp?page=5&search_key=&search_value=>|5|</a>&nbsp;<a href=open01_list.asp?page=6&search_key=&search_value=>|6|</a>&nbsp;<a href=open01_list.asp?page=7&search_key=&search_value=>|7|</a>&nbsp;<a href=open01_list.asp?page=8&search_key=&search_value=>|8|</a>&nbsp;<a href=open01_list.asp?page=9&search_key=&search_value=>|9|</a>&nbsp;<a href=open01_list.asp?page=10&search_key=&search_value=>|10|</a>&nbsp;<a href=open01_list.asp?page=11&search_key=&search_value=><img src="/img/bbs/btn/btn_next.gif" width="55" height="17" alt="" border="0" align="absmiddle" hspace="26"></a>
							<!--
							<img src="/img/bbs/btn/btn_pre.gif" width="54" height="17" alt="" border="0" align="absmiddle" hspace="26"></a><a href="#"><b>|1|</b></a> 
                              |2| |3| |4| |5| |6| |7| |8| |9| |10|<a href="#"><img src="/img/bbs/btn/btn_next.gif" width="55" height="17" alt="" border="0" align="absmiddle" hspace="26"></a>
							-->
							</td>
                          </tr>
                        </table></td>
                    ...
                    <tr>
                      <td><img src="table02.gif" width="520" height="16"></td>
                    </tr>
                  </table>
...
<map name="Map">
  <area shape="rect" coords="309,288,477,314" href="javascript:alert('이벤트가 종료되었습니다.')">
</map>
</body>
</html>
