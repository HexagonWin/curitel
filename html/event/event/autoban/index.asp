...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/event/autoban/index.asp">
					<tr>
			...
			<table width="597" cellpadding="0" cellspacing="0" border="0">
				<tr>
					...
					<TABLE WIDTH=539 BORDER=0 CELLPADDING=0 CELLSPACING=0 style="border:0 solid D8DAD7;margin:25 0 0 33;">
						...
						<tr><td><img src="/img/event/event/autoban_img01.gif"></td></tr>
						<tr><td><img src="/img/event/event/autoban_img02.gif"></td></tr>
						<tr><td><img src="/img/event/event/autoban_img03.gif" usemap="#1"></td></tr>

					</TABLE>

					<map name=1>
					<AREA SHAPE=rect COORDS="313,8,485,48" href="http://drive.nate.com/jsp/join/sub03_01.jsp" onfocus="this.blur()" target="blank">
					</map>
