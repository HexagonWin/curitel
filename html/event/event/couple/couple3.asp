...
<script language='javascript' src='http://nac.nasmedia.co.kr/post.nas/adtype=1&site=Curitel(0504)&pp=4&sz=0x0'></script>
...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/event/couple/couple3.asp">
					<tr>
...
<table width=580 cellpadding=0 cellspacing=0 border=0 style="margin:25 0 0 7">
	...
	<tr><td><img src='img/menu3.jpg'width="580" height="57" style="margin:0 0 0 10" usemap=#couplemenu_Map border=0></td></tr>
	<tr>
		<td height=270 style='background:url(img/couple3_img1.jpg) no-repeat 10px top;padding:65 44 0 0' align=right>
...
for(a=1;a<=3;a++){
	...
	eval('m'+a+'_on.src = \"img/story'+a+'_.gif\"');
	eval('m'+a+'_off.src = \"img/story'+a+'.gif\"');
	}//-->
</script>

<a href="couple3.asp?cid=1" onMouseOver="Img('1','on');" onmouseout="Img('1','off');"><img src="img/story1.gif" width="313" height="24" name=m1></a><br>

<a href="couple3.asp?cid=2" onMouseOver="Img('2','on');" onmouseout="Img('2','off');"><img src="img/story2.gif" width="313" height="24" name=m2></a>


<script language="JavaScript">
	document.all.m2.src='img/story2_.gif';
	m2_off.src='img/story2_.gif';
	m2_on.src='img/story2_.gif';
</script>
	...
	<tr>
		<td height=485 style='background:url(img/couple3_bg.gif) repeat-y 10px top;padding:0 0 0 10' valign=top align=center>
		<img src='img/story2.jpg' width=425 height=21923><br>

		</td>
	</tr>
	<tr><td height=71 style='background:url(img/couple3_bg2.gif) no-repeat 10px top'></td></tr>
...
<map name="couplemenu_Map">
	...
	<area shape="rect" coords="141,8,272,55" href="couple1.asp">
	<area shape="rect" coords="273,9,418,55" href="couple2.asp">
	<area shape="rect" coords="422,0,545,55" href="couple3.asp">
</map>
