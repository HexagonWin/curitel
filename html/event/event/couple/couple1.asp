...
<script language='javascript' src='http://nac.nasmedia.co.kr/post.nas/adtype=1&site=Curitel(0504)&pp=2&sz=0x0'></script>
<script language="javascript" src="http://www.curitel.com/inc/js/common.js"></script>
<script language="JavaScript">
<!--
	function run2005(objform){
...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/event/couple/couple1.asp">
					<tr>
		...
		<td width="597" valign="top" style="padding:0 0 15 0">
			<table width="597" cellpadding="0" cellspacing="0" border="0">
				<tr>
					...
					<!-- #####Contents Start ##### -->
<table width=580 cellpadding=0 cellspacing=0 border=0 style="margin:25 0 0 7">
	<tr><td><img src="img/top_img.jpg" width="580" height="418" style="margin:0 0 0 10" usemap=#couple_Map></td></tr>
	<tr><td><img src='img/menu1.jpg'width="580" height="57" style="margin:0 0 0 10" usemap=#couplemenu_Map border=0></td></tr>
	<tr><td><img src='img/join_top.gif'width="580" height="252" style="margin:0 0 0 10"></td></tr>
	<tr>
		<td style='background:url(img/join_bg.gif) repeat-y 10px top;padding:5 35 0 60'>
		<img src='img/icon.gif' align=absmiddle> 응모기간 : 2005. 3. 28 ~ 2005. 5. 31<br>
		<img src='img/icon.gif' align=absmiddle> 응모대상 : 커플폰 (PH-K2500V 또는 PH-K3000V)으로 KTF에 가입한 고객<br>
		<img src='img/icon.gif' align=absmiddle> 접수방법 : 응모하기를 누르신 후 커플 보험신청서를 작성하시면 이벤트에 응모되며, 보<br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;험 증권을 발송해 드립니다. <br>
		<img src='img/icon.gif' align=absmiddle> 지급대상 : 가입일로부터 12월 25일까지 커플을 유지한 모든 커플<br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(단, 가입일부터 12월 25일까지 큐리텔 단말기 및 KTF 가입 상태가 아닌 고객<br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(해지고객)은 대상자에서 제외됩니다.)<br>
		<img src='img/icon.gif' align=absmiddle> 당첨자 발표 : 2005. 12. 25<br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;커플보험증서를 지참하시고 커플과 함께 지정된 장소로 오세요 (장소추후<br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;공지)<br><br>

		※ 제세공과금은 본인 부담입니다.<br><br>
		<img src='img/couple1_txt.gif' width=481 height=65><br><br>
		<img src='img/couple1_txt2.gif' width=481 height=69><br><br>
		</td>
	</tr>
	<tr>
		<td height=80 style='background:url(img/couple1_bottom.gif) no-repeat 10px top;padding:20 47 0 0' valign=top align=right>
			<a href='javascript:go_next();'><img src='img/btn_app.gif' width=109 height=35></a><br>
		</td>
	</tr>
	<tr><td height=5 style='background:url(img/btm.gif) no-repeat left top'></td></tr>
</table>

<map name="couple_Map">
	<area shape="rect" coords="33,282,98,413" href="/html/product/lineup/feature.asp?serial_no=83" onfocus=blur() target=_blank>
	<area shape="rect" coords="100,282,176,413" href="/html/product/product_mains/ph-k2500.asp?serial_no=77" onfocus=blur() target=_blank>
</map>


<map name="couplemenu_Map">
	<area shape="rect" coords="33,9,136,55" href="index.asp">
	<area shape="rect" coords="138,1,271,55" href="couple1.asp">
	<area shape="rect" coords="273,8,419,55" href="couple2.asp">
	<area shape="rect" coords="421,8,545,55" href="couple3.asp">
</map>
...
<map name="Map">
    <area shape="rect" coords="16,299,154,339" href="javascript:run2005(run);">
</map>
