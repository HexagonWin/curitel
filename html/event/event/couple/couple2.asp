...
<script language='javascript' src='http://nac.nasmedia.co.kr/post.nas/adtype=1&site=Curitel(0504)&pp=3&sz=0x0'></script>
...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/event/couple/couple2.asp">
					<tr>
		...
		<td width="597" valign="top" style="padding:0 0 15 0">
			<table width="597" cellpadding="0" cellspacing="0" border="0">
				<tr>
					...
					<!-- #####Contents Start ##### -->
<form name="couple2" method="post">
	<input type="hidden" name="event_num" value="2">
<table width=580 cellpadding=0 cellspacing=0 border=0 style="margin:25 0 0 7">
	...
	<tr><td><img src='img/menu2.jpg'width="580" height="57" style="margin:0 0 0 10" usemap=#couplemenu_Map border=0></td></tr>
	<tr><td><img src='img/couple2_img1.gif' width=580 height=259 style="margin:0 0 0 10"></td>
	</tr>
	<tr>
		<td height=321 style='background:url(img/couple2_img2.gif) no-repeat 10px top;padding:116 0 0 65' valign=top>
			<table cellpadding=0 cellspacing=0 border=0>
			<tr>
				<td width=370 height=105 valign=top><input type='radio' name="section" value="A" checked></td>
				<td rowspan=2 valign=bottom><a href='javascript:go_next(1);'><img src='img/btn_app2.gif' width=109 height=35></a></td>
			</tr>
			<tr><td height=95 valign=top><input type='radio' name="section" value="B"></td></tr>
			</table>
		</td>
	</tr>
	<tr>
		<td height=282 style='background:url(img/couple2_img3.gif) no-repeat 10px top;padding:0 50 40 0' valign=bottom align=right>
			<a href='javascript:go_next(2);'><img src='img/btn_app3.gif' width=204 height=35></a><br>
		</td>
	</tr>
...
<map name="couplemenu_Map">
	...
	<area shape="rect" coords="140,8,271,55" href="couple1.asp">
	<area shape="rect" coords="273,0,418,55" href="couple2.asp">
