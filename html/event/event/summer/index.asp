...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/event/summer/index.asp">
					<tr>
		...
		<td width="597" valign="top" style="padding:0 0 15 0">
			<table width="597" cellpadding="0" cellspacing="0" border="0">
				<tr>
					...
					<tr><td height="26"><img src="http://www.curitel.com/img/event/subimg02_1.gif" width="537" height="97"></td></tr>
					<tr><td><img src="/html/event/event/summer/img/summer_01.jpg" width=537 height=204 alt=""></td></tr>
					<tr><td><img src="/html/event/event/summer/img/summer_02.jpg" width=537 height=294 alt=""></td></tr>
					<tr><td><img src="/html/event/event/summer/img/summer_03.jpg" alt="" width=537 height=240 border="0" usemap="#event01"></td></tr>
					<tr><td><img src="/html/event/event/summer/img/summer_04.jpg" width=537 height=264 alt=""></td></tr>
					<tr><td><img src="/html/event/event/summer/img/summer_05.jpg" alt="" width=561 height=328 border="0" usemap="#event01_01"></td></tr>
					<tr><td><img src="/html/event/event/summer/img/summer_06.jpg" alt="" width=537 height=209 border="0" usemap="#event02_02"></td></tr>
					</table>
		            <!-- #####//Contents End ##### -->
		          </td>
				</tr>
...
<map name="event01">
  <area shape="rect" coords="235,181,325,215" href="participate.asp"><!--01>응모-->
  <area shape="rect" coords="341,181,441,215" href="summer01.asp"><!--01>자세히-->
</map>
<map name="event01_01">
  <area shape="rect" coords="97,120,199,154" href="summer02.asp"><!--02>자세히-->
  <area shape="rect" coords="64,286,152,316" href="phone_event_prc.asp?ticket_type=1"><!--02>응모1-->
</map>
<map name="event02_02">
  <area shape="rect" coords="57,77,143,107" href="phone_event_prc.asp?ticket_type=2"><!--02>응모2-->
</map>
