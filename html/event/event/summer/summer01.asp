...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/event/summer/summer01.asp">
					<tr>
		...
		<td width="597" valign="top">
			<table width="597" cellpadding="0" cellspacing="0" border="0">
				<tr>
					...
					<tr>
					<td height="26">
					<img src="http://www.curitel.com/img/event/subimg02.gif" width="537" height="97"></td></tr>
					<tr><td><img src="/html/event/event/summer/img/summer01_01.jpg" width=537 height=207 alt=""></td></tr>
					<tr><td><img src="/html/event/event/summer/img/summer01_02.jpg" width=537 height=294 alt=""></td></tr>
					</table>
					<table width="557" cellpadding="0" cellspacing="0" border="0" style="margin-left:6">
					<tr><td><img src="/html/event/event/summer/img/summer01_03.jpg" alt="" width=557 height=221 border="0" usemap="#join"></td></tr>
					</table>
					<table width="557" cellpadding="0" cellspacing="0" border="0" style="margin-left:26">
					<tr><td><img src="/html/event/event/summer/img/summer01_04.jpg" width=537 height=250 alt=""></td></tr>
					<tr><td><img src="/html/event/event/summer/img/summer01_05.jpg" width=537 height=341 alt=""></td></tr>
...
<map name="join" id="join">
  ...
  <area shape="rect" coords="314,170,404,204" href="javascript:alert('이벤트가 종료 되었습니다.')">
