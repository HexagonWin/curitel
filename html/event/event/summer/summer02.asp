...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/event/summer/summer02.asp">
					<tr>
		...
		<td width="597" valign="top">
			<table width="597" cellpadding="0" cellspacing="0" border="0">
				<tr>
					...
					<tr>
					<td height="26">
					<img src="http://www.curitel.com/img/event/subimg02.gif" width="537" height="97"></td>
					</tr>
					<tr><td><img src="/html/event/event/summer/img/summer02_01.jpg" width=537 height=200 alt=""></td></tr>
					<tr><td><img src="/html/event/event/summer/img/summer02_02.jpg" width=537 height=204 alt=""></td></tr>
					<tr><td><img src="/html/event/event/summer/img/summer02_03.jpg" width=537 height=208 alt=""></td></tr>
					<tr><td><img src="/html/event/event/summer/img/summer02_04.jpg" alt="" width=559 height=132 border="0" usemap="#join01"></td></tr>
					<tr><td><img src="/html/event/event/summer/img/summer02_05.jpg" alt="" width=537 height=216 border="0" usemap="#join02"></td></tr>
					<tr><td height=40 align=right valign=bottom style="padding:0 25 0 0"><a href="javascript:history.back(-1)"><img src="http://www.curitel.com/html/event/event/tgi/btn_main.gif" width="80" height="26"></a></td></tr>
					</table>
		            <!-- #####//Contents End ##### -->
		          </td>
				</tr>
...
<map name="join01" id="join01">
  <area shape="rect" coords="66,93,150,127" href="javascript:alert('이벤트가 종료 되었습니다')">
</map>
<map name="join02">
  <area shape="rect" coords="57,84,143,112" href="javascript:alert('이벤트가 종료 되었습니다')">
</map>
