...
function goGoldenbell(f){
	nUrl = "/html/event/event/goldenbell/goldenbell_frame.asp"
	window.open('','goldenbell','width=400,height=411');
	f.action = nUrl;
	f.target = 'goldenbell';
	f.submit();
}
...
function pop_h() {
window.open("/html/event/event/goldenbell/pop_h.asp","popup","width=400,height=411,scrollbars=no,resizable=no"); 
}
-->
</script>
...
<div id="rpath" style="position:absolute;visibility:visible;left:232;top:197;width:596;height:15;z-index:10;">
		<table cellpadding="0" cellspacing="0" border="0" align="right">
				<tr>
						<td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a> > <a href="/html/event/index.asp">Event</a> > 환상이벤트 > 진행중 이벤트<a href="test.asp">&nbsp;&nbsp;</a></td>
				</tr>
		</table>
</div>
		...
		<td width="597" valign="top" style="padding:0 0 15 0">
			<table width="597" cellpadding="0" cellspacing="0" border="0">
				<tr>
					...
					<TABLE WIDTH=539 BORDER=0 CELLPADDING=0 CELLSPACING=0 style="border:0 solid D8DAD7;margin:7 0 0 33;">

						<tr><td><img src="/img/event/event/goldenbell/img01.gif" usemap="#1"></td></tr>
						<tr><td><img src="/img/event/event/goldenbell/img02.gif"></td></tr>
						<tr><td><img src="/img/event/event/goldenbell/img03.gif" usemap="#2"></td></tr>
					...
					function checklogin(){
						alert('로그인이 필요합니다.');
						location.href="/html/my/join/login.asp?rurl=/html/event/event/GoldenBell/index.asp";
					}
					</Script>

					<map name=1>
					<AREA SHAPE=RECT COORDS="228,209,405,238" href="list.asp" onfocus="this.blur()">
					</map>
					<map name=2>
					<AREA SHAPE=RECT COORDS="361,33,485,62" href="Javascript:alert('도전 골든벨 이벤트가 종료되었습니다.');" onfocus="this.blur()">
					</map>
