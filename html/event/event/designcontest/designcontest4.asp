...
function download(num){
	...
	window.open(file_url+"/common/event_download.asp?event_seq="+num,"filedownload","width=1,height=1,top=100000,left=100000");
}
//-->
</script>
...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/event/designcontest/designcontest4.asp">
					<tr>
...
<tr><td align=right>
		...
		<tr align=center height=28>
			...
			<td style="color:#C4C4C4">|</td>
			<td width=130 style="font-weight:bold"><a href="designcontest3.asp">심사 및 시상</a></td>
			<td style="color:#C4C4C4">|</td>
			<td width=95 style="font-weight:bold"><a href="designcontest4.asp"><font color=#0187A9>자료실</font></a></td>
			<td style="color:#C4C4C4">|</td>
...
<tr><td style="padding:0 0 45 0"><img src="img/data_t1.gif" width="60" height="22"><br>
<font color="#EA7610">2004 큐리텔 디자인 공모전 참가신청서를 다운 받으세요.</font> <a href="javascript:download(3)"><img src="img/btn_form.gif" align=absmiddle></a>
</td></tr>
<tr><td style="padding:0 0 45 0"><img src="img/data_t2.gif" width="60" height="22"><br>
	<img src="img/data_mark.gif" width="365" height="70">
</td></tr>
<tr><td style="padding:0 0 45 0"><img src="img/data_t3.gif" width="60" height="22"><br>
당사의 CI/BI 규정을 준수해 주시기 바랍니다.<br>
<font color=#EA7610>규정에 맞지 않게 적용된 출품작은 신청 및 참가자격이 취소됩니다.</font><br>
<a href="javascript:download(4)"><img src="img/btn_rule.gif" align=absmiddle style="margin:10 0 0 280"></a>
</td></tr>
<tr><td style="padding:0 0 45 0"><img src="img/data_mark1.gif" width="471" height="471" border=0></td></tr>
<tr><td style="padding:0 0 45 0"><img src="img/data_mark2.gif" width="471" height="417" border=0></td></tr>
<tr><td style="padding:0 0 45 0"><img src="img/data_mark3.gif" width="471" height="207" border=0></td></tr>
</table>
