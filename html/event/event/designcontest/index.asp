...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/event/designcontest/index.asp">
					<tr>
...
<tr><td align=right>
		...
		<tr align=center height=28>
			<td width=90 style="font-weight:bold"><a href="index.asp"><font color=#0187A9>인사말</font></a></td>
...
<!--<a href="index.html">인사말</a>-->
<table width cellpadding=0 cellspacing=0 border=0 style="text-align:justify">
<tr><td>
<img src="img/greeting.gif" width="340" height="22" border=0><br><br>
디지털시대의 Leading기업으로서 자리매김하고 있는 <b><font color="#048FAF">㈜팬택과 ㈜팬택&큐리텔</font></b>에서는 
디자인에 애정을 가지고 계시는 여러분을 대상으로 2004 큐리텔디자인공모전을 시행하게 되었습니다. <br><br>
이는 젊고 역동적이며 지적 매력이 넘치는 팬택계열의 아이덴터티가 감각적으로 
묻어나고 사람과 제품 그리고 공간을 이어주는 <font color="#048FAF">Harmony, Convergence & Advance</font>한 
디자인을 중심으로 미래 <font color="#048FAF">Personal Mobile Phone</font>에 대한 디자인 공모전을 개최하고자 합니다.<br><br>
저희 팬택계열은 세계최고의 디자이너를 꿈꾸는 디자인학도 및 디자인에 관심있는 일반인 
여러분의 뜨거운 관심과 성원을 바탕으로 내실있고 수준높은 소중한 공모전으로 자리매김
할 수 있도록 지속적인 노력을 다할 것을 약속 드립니다.<br><br>
큐리텔디자인공모전 사무국 
</td></tr>
</table>
