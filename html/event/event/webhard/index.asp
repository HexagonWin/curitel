...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/event/webhard/index.asp">
					<tr>
			...
			<table width="597" cellpadding="0" cellspacing="0" border="0">
				<tr>
					...
					<TABLE WIDTH=539 BORDER=0 CELLPADDING=0 CELLSPACING=0 style="border:0 solid D8DAD7;margin:25 0 0 33;">
						...
						<tr><td><img src="/img/event/event/webhard_01.gif" usemap="#1"></td></tr>
						<tr><td><img src="/img/event/event/webhard_02.gif"></td></tr>
						<tr><td><img src="/img/event/event/webhard_03.gif" usemap="#2"></td></tr>

					</TABLE>

					<map name=1>
					<AREA SHAPE=CIRCLE COORDS="489,198,40" href="http://www.webhard.co.kr" onfocus="this.blur()" target="_new">
					</map>
					<map name=2>
					<AREA SHAPE=RECT COORDS="215,4,347,42" href="http://www.curitel.com/html/my/join/index.asp" onfocus="this.blur()">
					
					<AREA SHAPE=RECT COORDS="364,4,496,42" href="javascript:confirmLogin();" onfocus="this.blur()">
