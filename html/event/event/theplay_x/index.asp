...
<!--
function event_apply(num)
{

	if(!window.ifahidden)
		document.body.innerHTML+="<iframe id=ifahidden style='display:none'></iframe>";
	
	ifahidden.location.href="event_play_process.asp?num="+num;
}
...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/event/theplay_x/index.asp">
					<tr>
			...
			<table width="148" height="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td valign="top">
						...
						<tr>
					       <td align="center">
							<script language="JavaScript">flash('/inc/flash/left/left_event.swf?html_Num=22','100','300');</script>
			...
			<table width="597" cellpadding="0" cellspacing="0" border="0">
				<tr>
					...
					<table width="557" cellpadding="0" cellspacing="0" border="0" style="margin:25 0 0 33">
						<tr>
					           <td>
						       <IMG SRC="img/play01.jpg" WIDTH=537 HEIGHT=379 ></td>
						</tr>
						<tr>
							
					           <td> <IMG SRC="img/play02.jpg" ALT="" WIDTH=537 HEIGHT=455 border="0" usemap="#coex"></td>
						</tr>
						<tr>
					           <td>
							<IMG SRC="img/play03.jpg" ALT="" WIDTH=537 HEIGHT=266 border="0" usemap="#Map2"></td>
						</tr>
						<tr>
						   <td><IMG SRC="img/play04.jpg" WIDTH=537 HEIGHT=280 border="0" usemap="#Map3">
							</td>
						</tr>
					</table>
		            <!-- #####//Contents End ##### -->
...
<map name="coex" id="coex">
  <area shape="poly" coords="378,13,384,65,506,49,495,1" href="http://cyworld.nate.com/MusicalPlay" target="_blank">
  <area shape="rect" coords="314,242,367,259" href="http://www.coex.co.kr/Common/I_Guide/Way_To/traffic_Guide.asp?L=6&M=1&S=1" target="_blank">
</map>
<map name="Map2">
  <area shape="rect" coords="384,11,468,39" href="javascript:alert('이벤트가 종료 되었습니다.')">
  <area shape="poly" coords="148,10,154,38,233,21,224,4" href="javascript:alert('이벤트가 종료 되었습니다.')">
</map>
<map name="Map3">
  <area shape="rect" coords="390,203,491,234" href="album_list.asp">
</map>
</body>
</html>
