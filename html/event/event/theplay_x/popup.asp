...
<table width="335" border="0" cellspacing="0" cellpadding="0">
  <tr><td height="218"><img src="/html/event/event/theplay_x/img/popup03.jpg" alt="" width="335" height="218" border="0" usemap="#summer"></td></tr>
  <tr><td height="114"><img src="/html/event/event/theplay_x/img/popup02.jpg" alt="" width="335" height="114" border="0" usemap="#rock"></td></tr>
  <tr><td height="123"><img src="/html/event/event/theplay_x/img/popup01.jpg" alt="" width="335" height="123" border="0" usemap="#theplay"></td></tr>
  <tr>
...
<map name="theplay" id="theplay">
  <area shape="rect" coords="225,82,316,110"  href="javascript:;" onclick="opener.parent.location.href='/html/event/event/theplay_x/index.asp';window.close();" onFocus="this.blur()">
</map>
<map name="rock" id="rock">
  <area shape="rect" coords="226,12,318,37"  href="javascript:;" onclick="opener.parent.location.href='/html/event/event/rock/index.asp';window.close();" onFocus="this.blur()">
</map>
