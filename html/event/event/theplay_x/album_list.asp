...
function download(idx){
	...
	window.open(file_url+"/common/event_download.asp?event_seq=2&idx="+idx,"filedownload","width=1,height=1,top=100000,left=100000");
}
...
function big_pic(filename){
	window.open("/common/zoom.asp?path=http://www.curitel.com/upload/event_playx/"+filename,"image","scrollbars=yes");
}
//-->
</script>
...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/event/theplay_x/album_list.asp">
					<tr>
	...
	<tr><td height="13"></td></tr>
		...
		<td width="597" valign="top" style="padding:0 0 15 0">
			<table width="597" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td valign="top">
					<table width="537" height="100%" border="0" cellpadding="0" cellspacing="0" style="margin:0 0 0 33">
                        <tr>
					...
					<!-- #####Contents Start ##### -->
					<table width="557" cellpadding="0" cellspacing="0" border="0" style="margin:25 0 0 33">
						<tr>
					           <td>
						       <IMG SRC="img/album01.jpg" WIDTH=537 HEIGHT=184 ></td>
						</tr>
						<tr>
							
					           <td> <IMG SRC="img/album02.jpg" ALT="" WIDTH=537 HEIGHT=175 border="0"></td>
						</tr>
						<tr>
					           <td WIDTH=537 HEIGHT=658 style="background:url(img/play_bg02.gif) no-repeat" style="padding:25 0 0 39" valign="top">
								<table cellspacing=0 cellpadding=0 border=0 width=474>
									<tr>
										<td style="padding=8 0 0 13" width="379"><img src="img/subtit01.gif"></td>
										<td width="95" style="padding=0 0 8 0" align="right" ></td>
									</tr>
									<tr>
										<td colspan=2>
											<table width="474" border="0" cellpadding="0" cellspacing="0" background="/img/community/bg_search03.gif">
											  <form name="photo_search" method="post" action="album_list.asp" onsubmit="return photocheck(this)">
												  <tr> 
													<td width="10"><img src="/img/community/bg_search01.gif" width="10" height="51"></td>	
													<td width="119"><img src="img/search_img.gif" width="119" height="24" border="0"></a></td>
													<td style="padding:0 5 0 0"><input name="sword" class="input03" type="text" style="width:100" value="">&nbsp;<input type="image" src="/img/bbs/btn/btn_search.gif" width="46" height="17" alt="" border="0" align="absmiddle" style="height:17;width:46"></td>
													<td class="8">자신의 핸드폰 번호, <br>가장 마지막 4자리로 검색해 주세요</td>
									...
									<tr><td colspan=2 align="center">
										...
										<table cellspacing=0 cellpadding=0 border=0 width="474">	
											...
											<tr>
												...
												<td width="147" height="133" style="background:url(img/play_bg01.gif) no-repeat left top" valign="top" style="padding:8 15 8 15"><img src="http://file.curitel.com/upload/event_playx/8837.jpg" border=1 bordercolor=#CCCCCC width="120" height="90">
												<table width="120"  cellspacing=0 cellpadding=0 border=0>
													<tr>
														<td><img src="img/btn_icon01.gif">8837</td>
														<td align=right valign="bottom"><a href="javascript:download(326)"><img src="img/btn_down.gif"></a>&nbsp;<a href="javascript:big_pic('8837.jpg')"><img src="img/btn_big.gif"></a>
													</tr>
												</table>
												</td>

												<td width="147" height="133" style="background:url(img/play_bg01.gif) no-repeat left top" valign="top" style="padding:8 15 8 15"><img src="http://file.curitel.com/upload/event_playx/5486.jpg" border=1 bordercolor=#CCCCCC width="120" height="90">
												<table width="120"  cellspacing=0 cellpadding=0 border=0>
													<tr>
														<td><img src="img/btn_icon01.gif">5486</td>
														<td align=right valign="bottom"><a href="javascript:download(325)"><img src="img/btn_down.gif"></a>&nbsp;<a href="javascript:big_pic('5486.jpg')"><img src="img/btn_big.gif"></a>
													</tr>
												</table>
												</td>

												<td width="147" height="133" style="background:url(img/play_bg01.gif) no-repeat left top" valign="top" style="padding:8 15 8 15"><img src="http://file.curitel.com/upload/event_playx/1759.jpg" border=1 bordercolor=#CCCCCC width="120" height="90">
												<table width="120"  cellspacing=0 cellpadding=0 border=0>
													<tr>
														<td><img src="img/btn_icon01.gif">1759</td>
														<td align=right valign="bottom"><a href="javascript:download(324)"><img src="img/btn_down.gif"></a>&nbsp;<a href="javascript:big_pic('1759.jpg')"><img src="img/btn_big.gif"></a>
													</tr>
												</table>
												</td>
											...
											<tr>
												...
												<td width="147" height="133" style="background:url(img/play_bg01.gif) no-repeat left top" valign="top" style="padding:8 15 8 15"><img src="http://file.curitel.com/upload/event_playx/0931.jpg" border=1 bordercolor=#CCCCCC width="120" height="90">
												<table width="120"  cellspacing=0 cellpadding=0 border=0>
													<tr>
														<td><img src="img/btn_icon01.gif">931</td>
														<td align=right valign="bottom"><a href="javascript:download(323)"><img src="img/btn_down.gif"></a>&nbsp;<a href="javascript:big_pic('0931.jpg')"><img src="img/btn_big.gif"></a>
													</tr>
												</table>
												</td>

												<td width="147" height="133" style="background:url(img/play_bg01.gif) no-repeat left top" valign="top" style="padding:8 15 8 15"><img src="http://file.curitel.com/upload/event_playx/0139.jpg" border=1 bordercolor=#CCCCCC width="120" height="90">
												<table width="120"  cellspacing=0 cellpadding=0 border=0>
													<tr>
														<td><img src="img/btn_icon01.gif">139</td>
														<td align=right valign="bottom"><a href="javascript:download(322)"><img src="img/btn_down.gif"></a>&nbsp;<a href="javascript:big_pic('0139.jpg')"><img src="img/btn_big.gif"></a>
													</tr>
												</table>
												</td>

												<td width="147" height="133" style="background:url(img/play_bg01.gif) no-repeat left top" valign="top" style="padding:8 15 8 15"><img src="http://file.curitel.com/upload/event_playx/31460.jpg" border=1 bordercolor=#CCCCCC width="120" height="90">
												<table width="120"  cellspacing=0 cellpadding=0 border=0>
													<tr>
														<td><img src="img/btn_icon01.gif">3140</td>
														<td align=right valign="bottom"><a href="javascript:download(321)"><img src="img/btn_down.gif"></a>&nbsp;<a href="javascript:big_pic('31460.jpg')"><img src="img/btn_big.gif"></a>
													</tr>
												</table>
												</td>
											...
											<tr>
												...
												<td width="147" height="133" style="background:url(img/play_bg01.gif) no-repeat left top" valign="top" style="padding:8 15 8 15"><img src="http://file.curitel.com/upload/event_playx/8110.jpg" border=1 bordercolor=#CCCCCC width="120" height="90">
												<table width="120"  cellspacing=0 cellpadding=0 border=0>
													<tr>
														<td><img src="img/btn_icon01.gif">8110</td>
														<td align=right valign="bottom"><a href="javascript:download(320)"><img src="img/btn_down.gif"></a>&nbsp;<a href="javascript:big_pic('8110.jpg')"><img src="img/btn_big.gif"></a>
													</tr>
												</table>
												</td>

												<td width="147" height="133" style="background:url(img/play_bg01.gif) no-repeat left top" valign="top" style="padding:8 15 8 15"><img src="http://file.curitel.com/upload/event_playx/9008.jpg" border=1 bordercolor=#CCCCCC width="120" height="90">
												<table width="120"  cellspacing=0 cellpadding=0 border=0>
													<tr>
														<td><img src="img/btn_icon01.gif">9008</td>
														<td align=right valign="bottom"><a href="javascript:download(319)"><img src="img/btn_down.gif"></a>&nbsp;<a href="javascript:big_pic('9008.jpg')"><img src="img/btn_big.gif"></a>
													</tr>
												</table>
												</td>

												<td width="147" height="133" style="background:url(img/play_bg01.gif) no-repeat left top" valign="top" style="padding:8 15 8 15"><img src="http://file.curitel.com/upload/event_playx/2376.jpg" border=1 bordercolor=#CCCCCC width="120" height="90">
												<table width="120"  cellspacing=0 cellpadding=0 border=0>
													<tr>
														<td><img src="img/btn_icon01.gif">2376</td>
														<td align=right valign="bottom"><a href="javascript:download(318)"><img src="img/btn_down.gif"></a>&nbsp;<a href="javascript:big_pic('2376.jpg')"><img src="img/btn_big.gif"></a>
													</tr>
												</table>
												</td>
									...
									<tr><td height="2" bgcolor=#D7D7D7 colspan=2></td></tr>
									<tr><td colspan=2 align="center"><br><img src=/img/bbs/btn/btn_pre.gif width='54' height='17' alt='' border='0' align='absmiddle' hspace='26'>&nbsp;<b>|1|</b>&nbsp;<a href=album_list.asp?page=2&sword=>|2|</a>&nbsp;<a href=album_list.asp?page=3&sword=>|3|</a>&nbsp;<a href=album_list.asp?page=4&sword=>|4|</a>&nbsp;<a href=album_list.asp?page=5&sword=>|5|</a>&nbsp;<a href=album_list.asp?page=6&sword=>|6|</a>&nbsp;<a href=album_list.asp?page=7&sword=>|7|</a>&nbsp;<a href=album_list.asp?page=8&sword=>|8|</a>&nbsp;<a href=album_list.asp?page=9&sword=>|9|</a>&nbsp;<a href=album_list.asp?page=10&sword=>|10|</a>&nbsp;<a href=album_list.asp?page=11&sword=><img src=/img/bbs/btn/btn_next.gif width='54' height='17' alt='' border='0' align='absmiddle' hspace='26'></a></td></tr>
								</table>
							   </td>
						</tr>
					</table>
