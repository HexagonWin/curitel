...
<!--
	u655="/html/event/culture/october/index.asp"; //왼쪽3
//-->
</SCRIPT>
...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/event/index.asp">
					<tr>
...
<div id="rpath" style="position:absolute;visibility:visible;left:232;top:185;width:596;height:15;z-index:10;"> 
		<table cellpadding="0" cellspacing="0" border="0" align="right">
				<tr>
						<td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a> > Event</td>
				</tr>
		</table>
</div>
	...
	<!-- LeftMenu -->
		...
		<tr>
			<td valign="top">
						...
						<tr>
					       <td align="center">
							<script language="JavaScript">flash('/inc/flash/left/left_event.swf?html_Num=00','100','300');</script>
							<!--<script language="JavaScript">flash('/inc/flash/left/left_event.swf?html_Num=00','100','300');</script>
							<!-- <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100" height="300">
					               <param name="movie" value="/inc/flash/left/left_event.swf?html_Num=00">
					               <param name="quality" value="high">
					               <embed src="/inc/flash/left/left_event.swf?html_Num=00" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100" height="300"></embed></object> --></td>
						</tr>
...
-->
	...
	<!-- #####Contents##### -->
	<div class="box" style="margin:377 0 20 0;">
	
	<!-- 정기 문화 이벤트 --
		
		<div class="mb10"><img src="/img/event/auction_new/event_txt01.gif"></div>
		<div class="mb20"><a href='culture/index.asp'><img src="/img/event/auction_new/img_event0403.jpg"></a></div>
	<!--// 정기 문화 이벤트 -->
		<div class="mb10">
			<img src="/img/event/auction_new/event_txt02.gif"><br>
			<img src="/img/event/auction_new/event_txt03.gif" style="margin:13 0 0 16">
		</div>
	<!-- 행운경매 시작 -->
...
<!-- 큐리타임이 아닐경우 -->
<div id="SubFlash" style="position:absolute;left:197px;top:201px;width:632px; height:461px; z-index:0">
<script language="JavaScript">flash('/inc/flash/event/event_061218.swf','632','378','1');</script>
</div>
	<!--이벤트 공지사항-->
	
<script>
	function goNoticeView(nIdx){
		location.href="/html/event/notice/view.asp?idx="+nIdx;
	}
</script>
<div id="Notice" style="position:absolute;left:553px;top:245px; height:85px; z-index:5">
<table width="245" cellpadding="0" cellspacing="0" border="0">
	<tr>
		<td colspan="2" height="21" valign="top"><img src="/img/event/title02.gif" width="156" height="14" alt="" border="0"></td>
	</tr>

		<tr>
			<td width="55" height="21">06.11.06</td>
			<td><a href="javascript:goNoticeView(57)">제7차 정기문화이벤트 당첨자 발표</a<</td>
		</tr>
		<tr><td colspan="2" background="/img/event/dotline.gif" height="1"></td></tr>

		<tr>
			<td width="55" height="21">06.10.09</td>
			<td><a href="javascript:goNoticeView(56)">제6차 정기문화이벤트 당첨자 발표</a<</td>
		</tr>
		<tr><td colspan="2" background="/img/event/dotline.gif" height="1"></td></tr>

		<tr>
			<td width="55" height="21">06.09.05</td>
			<td><a href="javascript:goNoticeView(55)">제5차 정기문화이벤트 당첨자 발표</a<</td>
		</tr>
		<tr><td colspan="2" background="/img/event/dotline.gif" height="1"></td></tr>
