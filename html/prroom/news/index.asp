...
<!--
	...
	function MM_openBrWindow(theURL,winName,features) { //v2.0
		window.open(theURL,'pop','width=800,height=600,left=150,top=150,scrollbars=yes,resizable=yes,');
	}
//-->
</SCRIPT>
</head>
...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/prroom/news/index.asp">
					<tr>
...
<div id="rpath" style="position:absolute;visibility:visible;left:232;top:185;width:596;height:15;z-index:10;"> 
      ...
      <td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a>
        > <a href="/html/prroom/index.asp">PR Room</a> > News</td>
				</tr>
		</table>
</div>
			...
			<table width="148" height="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td valign="top">
						...
						<tr>							
					       <td align="center">
							<script language="JavaScript">flash('/inc/flash/left/left_prroom.swf?html_Num=20','100','250');</script>
							<!-- <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100" height="220">
					               <param name="movie" value="/inc/flash/left/left_prroom.swf?html_Num=20">
					               <param name="quality" value="high">
					               <embed src="/inc/flash/left/left_prroom.swf?html_Num=20" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100" height="220"></embed></object> --></td>
						</tr>
			...
			<table width="597" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td valign="top" class="ctsmgn">
						...
						<tr>
							<td><img src="/img/prroom/subimg02.gif" width="537" height="97" alt="" border="0"></td>
						</tr>
						<tr>
							<td height="1"></td>
						</tr>
						...
						<tr>
							...
							<input name="search_value" type="text" style="width:120" value="" > <input type="image" src="/img/bbs/btn/btn_search.gif" alt="" border="0" align="absmiddle"></a>
							</td>
						</tr>
						<tr><td colspan="4" height="3"></td></tr>
						<tr align="center">
							<td class="field01" height="25" width=30>번호</td>
							<td class="field02" width=345>제목</td>
							<!--<td class="field02" width=80>출처</td>-->
							<td class="field03" width=75>
						...
						<tr  bgcolor="#f4f6f7"  >
							<td height="26">111</td>
							<td>
								<a href="view.asp?idx=408&page=1">팬택앤큐리텔 A1406PT, 일일 판매량 5천대 돌파하며 고공행진</a>
									&nbsp;<img src="new.gif" width=22 height=9>
							</td>
							<td>2007.01.04</td>
						</tr>
						...
						<tr  >
							<td height="26">110</td>
							<td>
								<a href="view.asp?idx=409&page=1">팬택계열, KTF와 WCDMA폰 공급 전략적 제휴</a>
									&nbsp;<img src="new.gif" width=22 height=9>
							</td>
							<td>2007.01.10</td>
						</tr>
						...
						<tr  bgcolor="#f4f6f7"  >
							<td height="26">109</td>
							<td>
								<a href="view.asp?idx=386&page=1">‘팬택-au’ A1406PT로 휴대폰 사용법 익히세요!</a>
									&nbsp;<img src="new.gif" width=22 height=9>
							</td>
							<td>2006.11.28</td>
						</tr>
						...
						<tr  >
							<td height="26">108</td>
							<td>
								<a href="view.asp?idx=384&page=1">큐리텔 12.5mm 메가 슬림 슬라이드폰 출시 </a>
									&nbsp;<img src="new.gif" width=22 height=9>
							</td>
							<td>2006.11.21</td>
						</tr>
						...
						<tr  bgcolor="#f4f6f7"  >
							<td height="26">107</td>
							<td>
								<a href="view.asp?idx=383&page=1">터치 센서 기술로 디자인의 군더더기를 걷어냈다.</a>
									&nbsp;<img src="new.gif" width=22 height=9>
							</td>
							<td>2006.11.15</td>
						</tr>
						...
						<tr  >
							<td height="26">106</td>
							<td>
								<a href="view.asp?idx=380&page=1">팬택앤큐리텔, 佛 최대 이통사 오렌지에 3G폰 공급</a>
									&nbsp;<img src="new.gif" width=22 height=9>
							</td>
							<td>2006.11.07</td>
						</tr>
						...
						<tr  bgcolor="#f4f6f7"  >
							<td height="26">105</td>
							<td>
								<a href="view.asp?idx=368&page=1">팬택계열, 아르헨티나 시장 공략 잰걸음</a>
									&nbsp;<img src="new.gif" width=22 height=9>
							</td>
							<td>2006.09.26</td>
						</tr>
						...
						<tr  >
							<td height="26">104</td>
							<td>
								<a href="view.asp?idx=377&page=1">A1406PT, 일본 KDDI社 모델 중 판매순위 2위 등극</a>
									&nbsp;<img src="new.gif" width=22 height=9>
							</td>
							<td>2006.11.01</td>
						</tr>
						...
						<tr  bgcolor="#f4f6f7"  >
							<td height="26">103</td>
							<td>
								<a href="view.asp?idx=365&page=1">팬택계열, 美 GSM사업 안정화 궤도 올라</a>
									&nbsp;<img src="new.gif" width=22 height=9>
							</td>
							<td>2006.09.11</td>
						</tr>
						...
						<tr  >
							<td height="26">102</td>
							<td>
								<a href="view.asp?idx=348&page=1">팬택계열, 땅끝나라 칠레 상륙</a>
									&nbsp;<img src="new.gif" width=22 height=9>
							</td>
							<td>2006.08.07</td>
						</tr>
						...
						<tr><td colspan="3" height="5" bgcolor="#eaeaea"></td></tr>
						<tr align="center"><td height="42" colspan="4">
					<table width=530 cellspacing=1 cellpadding=0 style="border:0px;padding:0;">
						<tr>
							<td align=center>
										<table width='100%' align='center' border='0'>		<tr> 			<td width='100%' align='center'><div align='center'>			&nbsp;&nbsp;&nbsp;&nbsp;	<b>|1|</b>	<a href=index.asp?search_key=&search_value=&page=2>|2|</a>	<a href=index.asp?search_key=&search_value=&page=3>|3|</a>	<a href=index.asp?search_key=&search_value=&page=4>|4|</a>	<a href=index.asp?search_key=&search_value=&page=5>|5|</a>	<a href=index.asp?search_key=&search_value=&page=6>|6|</a>	<a href=index.asp?search_key=&search_value=&page=7>|7|</a>	<a href=index.asp?search_key=&search_value=&page=8>|8|</a>	<a href=index.asp?search_key=&search_value=&page=9>|9|</a>	<a href=index.asp?search_key=&search_value=&page=10>|10|</a>			&nbsp;<a href=index.asp?search_key=&search_value=&page=11><img src='/img/bbs/btn/btn_next.gif' width='54' height='17' alt='' border='0' align='absmiddle' hspace='26'></a>			</div></td> 		</tr>	</table>
							</td>
						</tr>
						</table>
