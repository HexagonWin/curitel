...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/prroom/ad/tvcf_sketch.asp">
					<tr>
...
<div id="rpath" style="position:absolute; left:232; top:185; width:596; height:15; z-index:10; visibility: visible;">
		<table cellpadding="0" cellspacing="0" border="0" align="right">
				<tr>
      <td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a> > <a href="/html/prroom/index.asp">pr room</a> > <a href="/html/prroom/ad/index.asp">AD갤러리</a> > TV CF</td>
		</tr>
		</table>
</div>
			...
			<table width="148" height="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td valign="top">
						...
						<tr>							
					       <td align="center">
							<script language="JavaScript">flash('/inc/flash/left/left_prroom.swf?html_Num=33','100','250');</script>
							<!-- <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100" height="220">
					               <param name="movie" value="/inc/flash/left/left_prroom.swf?html_Num=33">
					               <param name="quality" value="high">
					               <embed src="/inc/flash/left/left_prroom.swf?html_Num=33" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100" height="220"></embed></object> --></td>
						</tr>
	...
	<tr><td height="13"></td></tr>
		...
		<td width="597" valign="top">
            ...
            <table width="557" cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td><img src="/img/prroom/subimg09.gif" width="537" height="97" alt="" border="0"></td>
							</tr>
							<tr>
								<td height="1"></td>
							</tr>
							...
							<tr>
								<td height="25" valign="top" style="padding:0 0 0 8"><img src="/img/prroom/main_tit06.gif" width="79" height="13"></td>
							</tr>
							<tr>
								<td style="padding:0 0 0 44"><table border="0" cellspacing="0" cellpadding="3">
										<tr align="center" valign="top">



											<td width="155"><a href="tvcf_view.asp?idx=21"><img src="http://file.curitel.com/upload/PRroom/AD/Grabbed Frame 6(2).jpg" width="188" height="154" style="border:10 solid #E2E2E2"></a><br> 
											<table width="208" border="0" cellspacing="0" cellpadding="0" style="margin:10 0 20 0">
													<tr>
														<td width="111">310만화소 큐리텔 디카폰 PH-K1000V CF</td>
														<td><font color="#F84600"><a href="javascript:PrSketch(21)"><img src="/img/prroom/btn_play.gif" align="right" style="padding:0 5 0 0"></a></font> </td>
													</tr>
												</table></td>

												<td width="15"><img src="/img/b.gif" width=1 height=180 style="background:#DDD"></td>


											<td width="155"><a href="tvcf_view.asp?idx=20"><img src="http://file.curitel.com/upload/PRroom/AD/111(4).gif" width="188" height="154" style="border:10 solid #E2E2E2"></a><br> 
											<table width="208" border="0" cellspacing="0" cellpadding="0" style="margin:10 0 20 0">
													<tr>
														<td width="111">310만화소 큐리텔 디카폰 PH-K1000V CF</td>
														<td><font color="#F84600"><a href="javascript:PrSketch(20)"><img src="/img/prroom/btn_play.gif" align="right" style="padding:0 5 0 0"></a></font> </td>
													</tr>
												</table></td>
											...
											<td width="155"><a href="tvcf_view.asp?idx=18"><img src="http://file.curitel.com/upload/PRroom/AD/PG-K600V_2.jpg" width="188" height="154" style="border:10 solid #E2E2E2"></a><br> 
											<table width="208" border="0" cellspacing="0" cellpadding="0" style="margin:10 0 20 0">
													<tr>
														<td width="111">PG-K6000V - 댄싱퀸 보아의 CF 촬영현장</td>
														<td><font color="#F84600"><a href="javascript:PrSketch(18)"><img src="/img/prroom/btn_play.gif" align="right" style="padding:0 5 0 0"></a></font> </td>
													</tr>
												</table></td>
											...
											<td width="155"><a href="tvcf_view.asp?idx=17"><img src="http://file.curitel.com/upload/PRroom/AD/Grabbed Frame 11.jpg" width="188" height="154" style="border:10 solid #E2E2E2"></a><br> 
											<table width="208" border="0" cellspacing="0" cellpadding="0" style="margin:10 0 20 0">
													<tr>
														<td width="111">S4 - 윤도현의 화장실CF 촬영현장</td>
														<td><font color="#F84600"><a href="javascript:PrSketch(17)"><img src="/img/prroom/btn_play.gif" align="right" style="padding:0 5 0 0"></a></font> </td>
													</tr>
												</table></td>
