...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/product/index.asp">
					<tr>
...
<div id="rpath" style="position:absolute;visibility:visible;left:232;top:185;width:596;height:216;z-index:10;">
		<table cellpadding="0" cellspacing="0" border="0" align="right">
				<tr>
						<td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a> > Product</td>
				</tr>
		</table>
</div>
<table width="829" height="800" cellspacing="0" cellpadding="0" border="0" class="mubg_gra">
	<tr>
		<td width="77"  valign="bottom"><img src="/b.gif" width="1" height="1"></td>
			...
			<table width="148" height="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td valign="top">
						...
						<tr>
					       <td align="center">
							<script language="JavaScript">flash('/inc/flash/left/left_product.swf?html_Num=00','100','350');</script>
							<!-- <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100" height="367">
					               ...
					               <embed src="/inc/flash/left/left_product.swf?html_Num=00" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100" height="367"></embed></object> --></td>
						</tr>
						<tr><td align="center">
	...
	<tr><td height="13"></td></tr>
		...
		<td width="597" valign="top">
			<table width="597" cellpadding="0" cellspacing="0" border="0">
				<tr><td height="1" ><img src="/img/w.gif" width="7" height="1"></td></tr>
				<tr>
					<td valign="top">
						<table width="557" cellpadding="0" cellspacing="0" border="0">
							<tr><td height="355"></td></tr>
							<!--<tr><td><img src="/img/product/title01.gif" width="143" height="13" alt="" border="0" hspace="58"></td></tr>-->
							<tr>
								<td height="500" valign="top" class="ctsmgn">
								<!-- #####Contents##### -->
								<table width="557" cellpadding="0" cellspacing="0" border="0">
									<!--<tr>
										<td>
										<!-- 이달의베스트 --
										<iframe src="/html/product/best80.asp" scrolling="No" width="100%" height="175" frameborder="0"></iframe>
									<!-- 이달의베스트 --
										</td>
									</tr>
									...
									<tr>
										...
										<table width="100%" cellpadding="0" cellspacing="0">
											<tr>
												<td><img src="/img/product/title02.gif" height="13" alt="" border="0" hspace="25"></td>
												<td valign="bottom" rowspan="2"><a href="/html/product/search/search02.asp" onfocus="this.blur()"><img src="/img/product/img_fitphone.gif" width="181" height="189" alt="" border="0"></a></td>
											</tr>
											<tr>
												<td valign="bottom" style="padding:0 0 3 0"><a href="/html/product/compare/index.asp" onfocus="this.blur()"><img src="/img/product/img_mania.gif" width="383" height="182" alt="" border="0" style="border-bottom:1px solid #D1D1D1"></a></td>
											</tr>
										</table>
										<!-- 매니아체험관 -->
										</td>
									...
									<!--
									<tr><td height="20"></td></tr>
									<tr><td height="26" valign="top"><img src="/img/product/title03.gif" width="109" height="13" alt="" border="0" hspace="25"></td></tr>
									<tr>
										<td style="padding:0 0 0 33">
										<table width="519" cellpadding="0" cellspacing="0">
											<tr>
												<td style="border:1px solid #C3C6C8;border-right:none;padding:8" bgcolor="#A7A7A7"
												 height="64">
													<!--include file="inner_selModel.asp"--
												</td>
												<td width="248" style="border:1px solid #C3C6C8;border-left:none"><a href="javascript:download('product/down/pc_sync/PC Sync PG-K6000V_Setup_V315.exe')" onfocus="this.blur()"><img src="/img/product/txt_nowon.gif" width="248" height="64" alt="" border="0"></a></td>
											</tr>
										</table>
										</td>
									</tr>-->
...
<div id="SubFlash" style="position:absolute;left:250px;top:226px;width:148px; height:40px; z-index:0;">
<a href="http://www.curitel.com/html/product/lineup/feature.asp?service=SKT&page=1&serial_no=118"><img src="/img/product/mainimg.jpg"></a>
<!--
    <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="613" height="333">
        <param name="movie" value="/inc/flash/product/main.swf">
        <param name="quality" value="high"><param name=wmode value=transparent>
        <embed src="/inc/flash/product/main.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="613" height="333"></embed></object>-->
</div>
