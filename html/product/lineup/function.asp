...
<script language="javascript" src="/inc/js/product/OpMenu03.js"></script>
</head>
...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/product/lineup/function.asp">
					<tr>
    ...
    <table cellpadding="0" cellspacing="0" border="0" align="right">
        <tr> 
            <td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a> 
                > <a href="/html/product/index.asp">Product</a>  > 제품소개 >  >  > 제품기능</td>
        </tr>
    </table>
</div>
								...
								<table width="590" cellpadding="0" cellspacing="0">
                                        <tr valign="top"> 
                                            <td width="448" height="200"><table width="425" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <tr> 
                                                        <td><img src="/img/product/lineup/tit_function.gif" width="435" height="50"></td>
                                                    </tr>
                                                    <tr>
                                                        <td headers="1" class="pdtline"></td>
                                                    </tr>
                                                    ...
                                                    <tr> 
                                                        <td style="padding:11;line-height:14pt">	
												<!-----------------------------------content body------------------------------------->
