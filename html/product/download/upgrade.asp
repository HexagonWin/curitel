...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/product/download/upgrade.asp">
					<tr>
...
<tr>
	<td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a> > <a href="/html/product/index.asp">Product</a> > <a href="/html/product/download/index.asp">다운로드</a> > Self Upgrade</td>
</tr>
</table>
</div>
			...
			<table width="148" height="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td valign="top">
						...
						<tr>							
					       <td align="center">
							<script language="JavaScript">flash('/inc/flash/left/left_product.swf?html_Num=41','100','350');</script>
							<!-- <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100" height="350">
					               <param name="movie" value="/inc/flash/left/left_product.swf?html_Num=41">
					               <param name="quality" value="high"><param name=wmode value=transparent>
					               <embed src="/inc/flash/left/left_product.swf?html_Num=41" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100" height="350"></embed></object> --></td>
						</tr>
						<tr><td align="center" style="padding:0 0 0 3"><a href="/html/help/support/faq_category.asp?pidx=7&idx=13"><img src="/img/help/download/btn_faq.gif"></a></td></tr>
				...
				<tr>
					<td valign="top" class="ctsmgn">
						...
						<table width="557" cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td><img src="/img/product/download/subimg08.gif" width="537" height="97"></td>
							</tr>
							<tr><td height="1" colspan="2"></td></tr>
							<tr><td height="26" colspan="2">
									<table width="537" height="100%" cellpadding="0" cellspacing="0">
										<tr><td bgcolor="#F6F8F9"></td></tr>
									</table>
								</td></tr>
							<tr>
								<td style="padding:20 0 11 10"><img src="/img/product/download/upgrade_txt.gif"></td>
							</tr>
 							<tr>
								<td style="padding:0 0 11 19">
								- 이용가능 OS : Windows 2000, Windows Xp<br>
								&nbsp;&nbsp;&nbsp;(XP media edition의 경우 FAQ 를 참고바랍니다)<br>
								- Internet Explorer : Ver 6.0 이상권장(Internet Explorer만 지원합니다)<br><br>

								컴퓨터 권장사양 <br><br>

								1. Pentium III 1Ghz 이상의 CPU<br>
								&nbsp;&nbsp;&nbsp;AMD Duron Athlon 이상의 CPU<br>
								</td>
							</tr>
							<tr>
								<td style="padding:0 0 0 10"><img src="/img/product/download/upgrade_txt3.gif"></td>
							</tr>
							<tr>
								<td style='padding:0 0 10 10'>

								<div style='margin:0 10 5 0' align=right>
								<a href="javascript:" onclick="javascript:window.open('/html/help/download/pop_more.asp','pop_more','toolbar=0, menubar=0, resizable=0, scrollbars=0, status=0, width=300,height=360,top=100,left=100')">
								<img src="/img/help/download/more.gif"></a>
								</div>

								<table width=540 cellpadding=0 cellspacing=0 border=0>

								<tr height=30 align=center class=b>
									<td bgcolor=#A9C7E7 width=110>모델명</td>
									<td rowspan=2 width=1></td>
									<td bgcolor=#A9C7E7>canU701D</td>
									<td bgcolor=#A9C7E7>PT-K2700</td>
									<td bgcolor=#A9C7E7>PT-K1800</td>
									<td bgcolor=#A9C7E7>PT-K1700</td>
									<td bgcolor=#A9C7E7>PT-K2800</td>
								</tr>
								<tr height=30 align=center>
									<td bgcolor=#EFEFEF>소프트웨어 버젼</td>
									<td bgcolor=#EFEFEF>M107</td>
									<td bgcolor=#EFEFEF>Ver.1.15</td>
									<td bgcolor=#EFEFEF>M10</td>
									<td bgcolor=#EFEFEF>M08_04</td>
							...
							<tr><td style="padding:10 10 0 19">
							위 등록된 모델이 아닌 다른 휴대폰 모델의 경우 Self upgrade를 이용할수 없습니다. Self upgrade를 지원하는 모델 이후에 출시된 휴대폰이라고 하여도 서비스 지원이 안될수 있으니 위 이용 가능 모델을 꼭! 참고하여 이용 부탁드립니다.
							</td></tr>
							<tr>
								<td style="padding:10 0 11 10"><img src="/img/product/download/upgrade_txt4.gif"></td>
							</tr>
							<tr>
								<td style="padding:0 0 11 19">
								고객님의 사용하시고 있는 휴대폰의 현재 S/W 버전정보를 확인하시고 S/W 버전이 다를 경우 <br>
								Self Upgrade Service를 이용하시면 됩니다. 확인방법은 다음과 같습니다. <br><br>

								휴대폰의 [메뉴] 버튼   >   메뉴의 [환경설정]   >   [휴대폰 정보]   >   모델정보 및 S/W 버전확인

								</td>
							</tr>
							<tr>
								<td style="padding:10 0 11 10"><img src="/img/product/download/upgrade_txt5.gif"></td>
							</tr>
							<tr>
								<td style="padding:0 0 0 19">
								① Self Upgrade를 위해 핸드폰과 USB Cable을 준비하시고 업그레이드 중에 단말기의 배터리가 <br>
								 방전되지 않도록 충분한 충전상태를 확인해 주세요.<br><br>

								② 아래의 Self Upgrade 시작 버튼을 누르시면 바로 Self Upgrade가 시작되며, 별도의 프로그램설치<br>
								과정 없이 휴대폰 S/W의업그레이드가 가능합니다. <br>
							...
							<tr>
								<td style="padding:0 0 11 10" align=right><a href="javascript:confirmLogin();"><img src="/img/help/download/btn_selfupgrade.gif"></a> &nbsp;<a href="javascript:download('product/down/USB/Curitel_USB_driver_ver4_22.zip')"><img src="/img/help/download/btn_usbdriver.gif" width="148" height="30"></td>
							</tr>
		
							<tr>
								<td style="padding:10 0 11 10"><img src="/img/product/download/upgrade_txt6.gif"></td>
							</tr>
							<tr>
							<td bgcolor=#EFEFEF style='padding:10'>
							<b>Self Upgrade 진행 중 비 정상적으로 업그레이드 서비스가 종료 되었을 경우에는 아래의 <br>
							절차에 따라 단말기를 복구해 주세요.</b><br><br>

							① 단말기 상태를 확인합니다. (긴급 다운로드 모드) <br>
							② 사용자 PC를 재 부팅 하고 큐리텔 홈페이지에 다시 접속합니다.  <br>
							③ 단말기에서 USB cable 을 제거 합니다. <br>
							④ 단말기에서 배터리를 제거하고 다시 결합합니다. <br>
							⑤ 단말기를 다시 켭니다. <br>
							⑥ 단말기에 USB Cable을 연결합니다. 분리되지 않도록 정확하게 연결합니다. <br>
