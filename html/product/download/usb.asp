...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/product/download/usb.asp">
					<tr>
			...
			<table width="148" height="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td valign="top">
						...
						<tr>							
					       <td align="center">
							<script language="JavaScript">flash('/inc/flash/left/left_product.swf?html_Num=44','100','350');</script>
							<!-- <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100" height="350">
					               <param name="movie" value="/inc/flash/left/left_product.swf?html_Num=44">
					               <param name="quality" value="high"><param name=wmode value=transparent>
					               <embed src="/inc/flash/left/left_product.swf?html_Num=44" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100" height="350"></embed></object> --></td>
						</tr>
				...
				<tr> 
					<td valign="top" class="ctsmgn"> 
						...
						<table width="557" cellpadding="0" cellspacing="0" border="0">
							<tr> 
								<td><img src="/img/product/download/subimg03.gif" width="537" height="97"></td>
							</tr>
							...
							<tr> 
								<td style="padding:20 0 11 10"><img src="/img/help/download/txt_usb.gif" border="0">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td style="padding:0 0 25 0">
			<img src="/img/product/download/txt_usb02.gif" border="0" align="absmiddle"><br>
	...
	<tr><td colspan=2 align="right" height="97" style="padding:0 35 0 0;background:url(/img/product/download/txt_tapi.gif) no-repeat left top"><a href="javascript:download('product/down/USB/SetTAPI.zip')"><img src="/img/btn/btn_tapi.gif" border="0"></a></td></tr>
	...
	<!--tr>
		<td colspan=2 height="35" style="padding:10 0 0 15" valign=top><img src="/img/product/download/title_model.gif"></td>
							...
							<tr> 
								<td style="padding:0 0 0 8"> 
									<!-- 제품 목록 -->
									<!--iframe src="/html/product/download/if_usb.asp?sector=product" scrolling="No" frameborder="0" width="557" height="200"></iframe--> 
									<!-- 제품 목록 -->
								</td>
							</tr>
							<!---------------------- hardcoding ---------------------------->
									...
									<table width="557" border="0" cellspacing="0" cellpadding="0">
										...
										<tr> 
											<td> <table border=0 width="533">
													<tr> 
														<td colspan=4 height=25 valign=top><img src="/img/product/download/title_usbmodel.gif"></td>
													</tr>
													<tr> 
										...
										<tr> 
											<td> <table border=0 width="533">
													<tr> 
														<td colspan=4 height=25 valign=top><img src="/img/product/download/title_sktusb.gif"></td>
													</tr>
													<tr> 
							...
							<!--tr> 
								<td style="padding:0 0 0 0" ><table width="533" cellpadding="0" cellspacing="0">
										<tr> 
											<td height="35" style="padding:0 0 0 6"><img src="/img/product/download/title04.gif" width="157" height="14" alt="" border="0"></td>
										</tr>
									</table>
									<table width="533" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 0 6" bgcolor="#F2F2F2">
										<tr> 
...
<!-- 							<tr> 
							...
							<tr> 
								<td style="padding:0 0 0 8" ><table width="533" cellpadding="0" cellspacing="0">
										<tr> 
											<td height="35" style="padding:0 0 0 6"><img src="/img/product/download/title06.gif" width="87" height="13" alt="" border="0"></td>
											<td align="right">  -->
												<!-- <img src="/img/btn/btn_smmore.gif" width="33" height="7" hspace="6"> -->
<!-- 											</td>
										</tr>
									</table>
