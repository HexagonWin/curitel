...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/product/search/search_result.asp">
					<tr>
...
<div id="rpath" style="position:absolute;visibility:visible;left:232;top:185;width:596;height:15;z-index:10;">  
		<table cellpadding="0" cellspacing="0" border="0" align="right">
				<tr>						
		            <td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a> > <a href="/html/product/index.asp">Product</a> > <a href=/html/product/search/index.asp>제품검색</a> > 기능별 제품검색</td>
				</tr>
		</table>
</div>
			...
			<table width="597" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td valign="top" class="ctsmgn">
							<!-- #####Contents##### -->
							<script>		alert('잘못된 데이터가 전달 되어졌습니다. 다시 시도해 주세요');		location.href='index.asp'</script>
							<!-- #####//Contents##### -->
					</td>
				</tr>
			</table>
