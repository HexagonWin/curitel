...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/product/compare/index.asp">
					<tr>
...
<div id="rpath" style="position:absolute;visibility:visible;left:232;top:197;width:596;height:15;z-index:10;">
		<table cellpadding="0" cellspacing="0" border="0" align="right">
				<tr>
						<td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a> > <a href="/html/product/index.asp">Product</a> > 제품비교</td>
				</tr>
		</table>
</div>
			...
			<table width="148" height="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td valign="top">						<table width="148" cellspacing="0" cellpadding="0" border="0">
						<tr>							
					       <td align="center">
							<script language="JavaScript">flash('/inc/flash/left/left_product.swf?html_Num=40','100','350');</script>
							<!-- <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100" height="350">
					               <param name="movie" value="/inc/flash/left/left_product.swf?html_Num=40">
					               <param name="quality" value="high"><param name=wmode value=transparent>
					               <embed src="/inc/flash/left/left_product.swf?html_Num=40" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100" height="350"></embed></object> --></td>
						</tr>
...
</table><!--<iframe src="/inc/asp/left/l_inforoom1.asp" width="124"  scrolling="No" frameborder="0" allowTransparency="true"></iframe>-->
<SCRIPT LANGUAGE="JavaScript">
<!--
	function scheck(){
...
<script>
	function setP_list(p_list, img_list){
		var df = getDF();
		df.p_list.value = p_list;
		df.img_list.value = img_list;
	...
	function chgImg(){
		...
		var cnt = 0;
		var split_img_list = df.img_list.value.split(space);

		for(var i=0; i<(split_img_list.length-1); i++){	
			var chgimg = eval("document.all.p_img_" + (i+1));
			chgimg.innerHTML = "<img src='http://file.curitel.com/upload/product/img/"+split_img_list[i]+"' width='60' height='120'>";				
			cnt += 1;
		}
		
		var temp_cnt = (4-cnt);
		for(var i=0; i<temp_cnt; i++){
			var chgimg = eval("document.all.p_img_" + (cnt+1));
			chgimg.innerHTML = "<img src='/img/common/pdt_none.gif' width='124' height='136'>";					
			cnt++;
		}
...
//		alert(df.c_list.value);
	}
	//  가지고 있는 조건 리스트에 해당 조건이 있는 지 검사
	...
	function getDF(){
		return document.ins_form;
	}
</script>
<form name="ins_form" action="compare_result.asp"  method="post">
  ...
  <table width="557" cellpadding="0" cellspacing="0" border="0">
    <tr> 
      <td><img src="/img/product/compare/subimg00.gif" width="537" height="97" alt="" border="0"></td>
    </tr>
    <tr> 
      <td height="1"></td>
    </tr>
    ...
    <tr> 
      <td><img src="/img/product/compare/txt_compare.gif" width="537" height="66" alt="" border="0"></td>
    </tr>
     <tr> 
         <td><img src="/img/common/plusline.gif" width="557" height="11" alt="" border="0" vspace="2"></td>
     </tr>
    <tr> 
      <td height="78" valign="top" style="padding:6 0 0 0"><img src="/img/product/search/step01.gif" width="47" height="47" alt="" border="0" align="absmiddle" hspace="13"><img src="/img/product/compare/txt_step01.gif" width="285" height="13" alt="" border="0"></td>
    </tr>



    <tr> 
      <td><img src="/img/product/compare/txt_compare03.gif" width="537" height="26" alt="" border="0"></td>
    </tr>
    <tr> 
      <td style="padding:0 0 0 8"> 
        ...
        <table cellpadding="0" cellspacing="0">
          <tr align="center"> 
            <td width="124" height="136" class="pdt_bg02"><div id="p_img_1"><img src='/img/common/pdt_none.gif' width='124' height='136'></div></td>
            <td width="10"></td>
            <td width="124" class="pdt_bg02"><div id="p_img_2"><img src='/img/common/pdt_none.gif' width='124' height='136'></div></td>
            <td width="10"></td>
            <td width="124" class="pdt_bg02"><div id="p_img_3"><img src='/img/common/pdt_none.gif' width='124' height='136'></div></td>
            <td width="10"></td>
            <td width="124" class="pdt_bg02"><div id="p_img_4"><img src='/img/common/pdt_none.gif' width='124' height='136'></div></td>
          </tr>
        </table>
        <!-- selectProduct -->
      </td>
    ...
    <tr> 
      <td height="37" align="right" style="padding:0 19 0 0"><a href="javascript:goSearch()"><img src="/img/btn/btn_compare.gif" width="70" height="19" alt="" border="0"></a></td>
    </tr>



    <tr> 
      <td style="padding:0 0 0 14" height="370"><iframe src="/html/product/compare/if_compare.asp?serial_no=" scrolling="No" frameborder="0" width="530" height="500"></iframe></td>
    </tr>
	<tr> 
      <td height="1" class="li_dotline"></td>
    </tr>
