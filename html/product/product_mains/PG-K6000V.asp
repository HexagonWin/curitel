...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/product/product_mains/PG-K6000V.asp">
					<tr>
...
<div id="rpath" style="position:absolute;visibility:visible;left:232;top:197;width:596;height:15;z-index:10;"> 
    <table cellpadding="0" cellspacing="0" border="0" align="right">
      ...
      <td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a> 
        > <a href="/html/product/index.asp">Product</a> > <a href="/html/product/lineup/index.asp">제품소개</a> > <a href="/html/product/lineup/lgt.asp">LGT</a> > PG-K6000V
<td>
        </tr>
    </table>
</div>
    ...
    <tr> 
		...
		<table width="232" height="100%" cellpadding="0" cellspacing="0" border="0">
		    <tr> 
				...
				<img src="/img/product/lineup/model02/mainleftimg.jpg" width="63" height="639" alt="" border="0"></td>
				<td valign="top" align="center"> 
					...
					<table width="155" cellpadding="0" cellspacing="0">
						<tr>
							<td style="padding:29 0 0 0"><!-- 제품이름 ---><img src="/img/product/lineup/model02/PG-K6000V.jpg" width="155" height="38" alt="" border="0"></td></tr>
						<tr>
			    ...
			    <tr> 
			        <td valign="top" class="pdtctsmgn"> 
			            ...
			            <table width="590" cellpadding="0" cellspacing="0" border="0">
			                <tr>
			                <td><img src="/img/product/lineup/model02/mainimg01.jpg" width="594" height="307" alt="" border="0"><br>
							<img src="/img/product/lineup/model02/mainimg02.jpg" alt="" width="594" height="332" border="0" usemap="#Map"><br><img src="/img/product/lineup/model02/mainimg03.jpg" width="594" height="255" alt="" border="0"></td>
			            </tr>
                        </table>
                        <!-- #####//Contents##### -->
                    </td>
...
<map name="Map">
  <area shape="rect" coords="464,285,586,321" href="/html/product/lineup/feature.asp?serial_no=58">
</map>
<script language='JavaScript'>
<!-- 
adURL="http://ad.realmedia.co.kr/RealMedia/ads/adstream_jx.ads/www.curitel.com/goods@x01"; 
document.write("<SCR"+"IPT LANG"+"UAGE='JavaScr"+"ipt1.1' SRC='"+adURL+"?"+(document.referrer.split("/"))[2]+"'></SCR"+"IPT>"); 
//-->
</SCRIPT>
</body>
</html>