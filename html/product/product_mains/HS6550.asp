...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/product/product_mains/HS6550.asp">
					<tr>
...
<div id="rpath" style="position:absolute;visibility:visible;left:232;top:197;width:596;height:15;z-index:10;"> 
    <table cellpadding="0" cellspacing="0" border="0" align="right">
      ...
      <td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a> 
        > <a href="/html/product/index.asp">Product</a> > <a href="/html/product/lineup/index.asp">제품소개</a> > <a href="/html/product/lineup/lgt.asp">LGT</a>> HS6500<td>
        </tr>
    </table>
</div>
<table width="829" height="800" cellspacing="0" cellpadding="0" border="0">
    <tr> 
		...
		<table width="232" height="100%" cellpadding="0" cellspacing="0" border="0">
		    <tr> 
		        <td valign="top" style="padding:50 0 0 0"><!--좌측 상단 이미지 : -->
				<img src="/img/product/lineup/model08/mainleftimg.jpg" width="77"></td>
				<td valign="top" align="center"> 
					...
					<table width="155" cellpadding="0" cellspacing="0">
						<tr>
							<td style="padding:29 0 0 0"><!-- 제품이름 ---><img src="/img/product/lineup/model08/LGT-HS6500.jpg" width="155" height="38" alt="" border="0"></td></tr>
						<tr>
			    ...
			    <tr> 
			        <td valign="top" class="pdtctsmgn"> 
			            ...
			            <table width="590" cellpadding="0" cellspacing="0" border="0">
			                <tr>
			                <td><img src="/img/product/lineup/model08/mainimg01.jpg" width="589"><br>
							<img src="/img/product/lineup/model08/mainimg02.jpg" width="589" border="0" usemap="#Map"></td>
			            </tr>
                        </table>
                        <!-- #####//Contents##### -->
                    </td>
...
<map name="Map">
  <area shape="rect" coords="507,309,568,331" href="/html/product/lineup/feature.asp?serial_no=59" onFocus="this.blur()">
</map>
</body>
</html>