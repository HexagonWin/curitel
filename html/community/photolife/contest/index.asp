...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/community/photolife/contest/index.asp">
					<tr>
...
<div id="rpath" style="position:absolute;visibility:visible;left:232;top:197;width:596;height:15;z-index:10;">
		<table cellpadding="0" cellspacing="0" border="0" align="right">
				<tr>
						<td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a> > <a href="/html/community/index.asp">Community</a> > <a href="/html/community/photolife/index.asp">포토라이프</a> > 포토 컨테스트</td>
				</tr>
		</table>
</div>
...
<table width="530" border="0" cellpadding="0" cellspacing="0" background="/img/community/bg_search03.gif">
          ...
          <td style="padding:26 0 8 0"><a href="best.asp"><img src="/img/community/photolife/more.gif" width="35" height="9" hspace="25" vspace="7" border="0" align="right"></a><img src="/img/community/photolife/contest/tit_best01.gif"  height="21" border="0"></td>
			</tr>
			<tr>
		 ...
		 <table width="510" border="0" cellspacing="0" cellpadding="0">
              <tr valign="top"> 
                ...
                <td width="151" class="photo"> 
                  ...
                  <table border="0" cellspacing="0" cellpadding="0">
                    <tr valign="top"> 
                      <td height="95"><a href="/html/community/photolife/contest/contest03_view.asp?idx=22873"><img src="http://file.curitel.com/upload/ct_photo/2005113014565465(5114).jpg" width="130" height="96" border="0"></a></td>
                    </tr>
                    <tr> 
                      <td height="27" style="padding:45 0 0 8"><img src="/img/common/ico_hit.gif" width="13" height="11" align="absmiddle"> 
                        <font color="#FF622C">천명훈 코스프레</font></td>
                    </tr>
                    <tr> 
                      <td height="55" style="padding:5 0 0 11"> <img src="/img/common/orgdot.gif" alt="" width="5" height="5" border="0" align="absmiddle"> 
                        2006-03-16<br> <img src="/img/common/orgdot.gif" width="5" height="5" alt="" border="0" align="absmiddle"> 
                        Curian : matthew68<br><img src="/img/common/orgdot.gif" width="5" height="5" alt="" border="0" align="absmiddle">모델명 : 싸이월드<br><img src="/img/common/orgdot.gif" width="5" height="5" alt="" border="0" align="absmiddle">추천수 : 1</td>
                    </tr>
                  </table> 
			...
			<tr>
	          <td height="27" valign="top"><!-- <a href="#"><img src="/img/community/photolife/more.gif" width="35" height="9" hspace="25" vspace="7" border="0" align="right"></a> --><img src="/img/community/photolife/contest/tit_best02.gif" width="184" height="22"></td>
			</tr>
			<tr>
			  <td class="pad8">
				<!----- 추천수 베스트 포토 시작 --->
				...
				<table width="530" border="0" cellspacing="0" cellpadding="0">
				  <tr valign="top"> 
					...
					<td width="267"><table width="262" border="0" cellpadding="0" cellspacing="0" background="/img/community/bg_cgray03.gif">
						<tr> 
						  <td height="5"><img src="/img/community/bg_cgray01.gif" width="262" height="5"></td>
						</tr>
						<tr> 
						  <td style="padding:4 8"> 
							...
							<table width="100%" cellpadding="0" cellspacing="0">
							  <tr> 
								<td width="90" height="69" valign="top" style="background:url(/img/community/rgray_frame.gif) no-repeat left top"><a href="contest01_view.asp?idx=22919"><img src="http://file.curitel.com/upload/ct_photo/목련뽀사시.JPG" width="80" height="59" hspace="5" vspace="5" border="0"></a></td>
								<td valign="top" style="padding:4 0 0 10"><b>하얀 목련이 필때면...</b><br> <img src="/img/b.gif" width="1" height="3"><br> 
								  <img src="/img/common/orgdot.gif" alt="" width="5" height="5" vspace="2" border="0" align="absmiddle"> 2006-03-22<br>
	                              <img src="/img/common/orgdot.gif" width="5" height="5" alt="" border="0" align="absmiddle"> Curian : coneto<br>
								  <img src="/img/common/orgdot.gif" width="5" height="5" alt="" border="0" align="absmiddle"> 모델명 : ㅇ21<br>
						...
						<tr> 
						  <td height="5"><img src="/img/community/bg_cgray02.gif" width="262" height="5"></td>
						</tr>
					  </table></td>
					...
					<td width="267"><table width="262" border="0" cellpadding="0" cellspacing="0" background="/img/community/bg_cgray03.gif">
						...
						<tr> 
						  <td style="padding:4 8"> 
							...
							<table width="100%" cellpadding="0" cellspacing="0">
							  <tr> 
								<td width="90" height="69" valign="top" style="background:url(/img/community/rgray_frame.gif) no-repeat left top"><a href="contest01_view.asp?idx=22918"><img src="http://file.curitel.com/upload/ct_photo/꽃1.jpg" width="80" height="59" hspace="5" vspace="5" border="0"></a></td>
								<td valign="top" style="padding:4 0 0 10"><b>붉은 꽃</b><br> <img src="/img/b.gif" width="1" height="3"><br> 
								  <img src="/img/common/orgdot.gif" alt="" width="5" height="5" vspace="2" border="0" align="absmiddle"> 2006-03-22<br>
	                              <img src="/img/common/orgdot.gif" width="5" height="5" alt="" border="0" align="absmiddle"> Curian : coneto<br>
								  <img src="/img/common/orgdot.gif" width="5" height="5" alt="" border="0" align="absmiddle"> 모델명 : ㅇ21<br>
								  <img src="/img/common/orgdot.gif" width="5" height="5" alt="" border="0" align="absmiddle"> 추천수 : 2 </td>
					...
					<td width="267"><table width="262" border="0" cellpadding="0" cellspacing="0" background="/img/community/bg_cgray03.gif">
						...
						<tr> 
						  <td style="padding:4 8"> 
							...
							<table width="100%" cellpadding="0" cellspacing="0">
							  <tr> 
								<td width="90" height="69" valign="top" style="background:url(/img/community/rgray_frame.gif) no-repeat left top"><a href="contest01_view.asp?idx=22920"><img src="http://file.curitel.com/upload/ct_photo/손애자(1283).jpg" width="80" height="59" hspace="5" vspace="5" border="0"></a></td>
								<td valign="top" style="padding:4 0 0 10"><b>Crazy Worl...</b><br> <img src="/img/b.gif" width="1" height="3"><br> 
								  <img src="/img/common/orgdot.gif" alt="" width="5" height="5" vspace="2" border="0" align="absmiddle"> 2006-03-22<br>
	                              <img src="/img/common/orgdot.gif" width="5" height="5" alt="" border="0" align="absmiddle"> Curian : sook5054<br>
								  <img src="/img/common/orgdot.gif" width="5" height="5" alt="" border="0" align="absmiddle"> 모델명 : P1<br>
								  <img src="/img/common/orgdot.gif" width="5" height="5" alt="" border="0" align="absmiddle"> 추천수 : 0 </td>
							  </tr>
							</table>
							<!-- 포토1 끝-->
						  </td>
					...
					<td width="267"><table width="262" border="0" cellpadding="0" cellspacing="0" background="/img/community/bg_cgray03.gif">
						...
						<tr> 
						  <td style="padding:4 8"> 
							...
							<table width="100%" cellpadding="0" cellspacing="0">
							  <tr> 
								<td width="90" height="69" valign="top" style="background:url(/img/community/rgray_frame.gif) no-repeat left top"><a href="contest01_view.asp?idx=22917"><img src="http://file.curitel.com/upload/ct_photo/개나리(2).jpg" width="80" height="59" hspace="5" vspace="5" border="0"></a></td>
								<td valign="top" style="padding:4 0 0 10"><b>개나리 노오란~!</b><br> <img src="/img/b.gif" width="1" height="3"><br> 
								  <img src="/img/common/orgdot.gif" alt="" width="5" height="5" vspace="2" border="0" align="absmiddle"> 2006-03-22<br>
	                              <img src="/img/common/orgdot.gif" width="5" height="5" alt="" border="0" align="absmiddle"> Curian : coneto<br>
								  <img src="/img/common/orgdot.gif" width="5" height="5" alt="" border="0" align="absmiddle"> 모델명 : ㅇ21<br>
								  <img src="/img/common/orgdot.gif" width="5" height="5" alt="" border="0" align="absmiddle"> 추천수 : 0 </td>
          ...
          <td height="27" valign="top"><a href="newphoto.asp"><img src="/img/community/photolife/more.gif" width="35" height="9" hspace="25" border="0" align="right"></a><img src="/img/community/photolife/contest/tit_new.gif" width="143" height="22"></td>
			</tr>
			<tr>
			  <td class="pad8">
				<!----- 새로운 포토 시작 --->
