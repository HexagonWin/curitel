...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/community/photolife/play/say.asp">
					<tr>
...
> <a href="/html/community/index.asp">Community</a> > <a href="/html/community/photolife/index.asp">포토라이프</a>
> 포토 놀이터 > 포토 카툰</td>
</tr>
</table>
</div>
...
<!-- LeftMenu -->
	...
	<td valign="top">
						...
						<tr>
					       <td align="center">
							<script language="JavaScript">flash('/inc/flash/left/left_community02.swf?html_Num=21','100','250');</script>
							<!-- <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100" height="250">
					               <param name="movie" value="/inc/flash/left/left_community02.swf?html_Num=21">
					               <param name="quality" value="high">
					               <embed src="/inc/flash/left/left_community02.swf?html_Num=21" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100" height="250"></embed></object> --></td>
						</tr>
...
<!-- #####Contents##### -->
	...
	<td height="26">
		...
		<tr><td><img src="/img/community/photolife/subimg01.gif" width="537" height="97" alt="" border="0"></td></tr>
	...
	<tr>
	<td style="padding:19 0 4 10"><img src="/img/community/photolife/play/t_info01.gif"></td>
	</tr>
	<tr>
	<td style="padding:0 0 10 0"><img src="/img/common/plusline.gif" width="557" height="11" alt="" border="0" vspace="2"></td>
	</tr>
	<tr>
	<td class="pad8">
		...
		<img src="/img/community/photolife/play/btn_say.gif" width="110" height="28" hspace="7" border="0"></a></td>
		<td align="right" style="padding:0 5 0 0">
		<form style="margin:0" onsubmit="return searchBrd(this)" target=say action="if_list.asp">
		<select name="ktype" style="width:60">
		<option value='1'>제목
		<option value='2'>내용 </select>
		<input name="kword" type="text" style="width:120">
		<input type=image src="/img/bbs/btn/btn_search.gif" width="46" height="17" style="height:17" alt="" border="0" align="absmiddle"></td>
	...
	<tr>
	<td style="padding:18 0 7 0">
	<!-------------- View 시작 ---------->
<table width="540" border="0" cellspacing="0" cellpadding="0">
<tr> 
<td colspan="5"><img src="/img/community/photolife/frame_t.gif" width="540" height="19"></td>
</tr>
<tr valign="top"> 
<td width="30" background="/img/community/photolife/frame_lbg.gif"><img src="/img/community/photolife/frame_l02.gif" width="30" height="258"></td>
<td width="301"> 


	<table width="290" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr> 
	<td height="39" colspan="2" valign="top" class="orange_b" style="padding:14 0 0 2">[제목] 
	결혼 축하합니다~</td>
	</tr>
...
<!--3-->
	...
	<!--말풍선--->
	<div id=divimg style="position:absolute;z-index:1;"> 
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">

		<tr> 
		<td height="100"><img src="/img/community/photolife/play/num1.gif" width="11" height="29"></td>
		<td><img src="http://file.curitel.com/upload/ct_cartoon_board/사용자 지정 1(1).jpg" class=cutimg id=cutimg1 style="display:block"></td>
		<td align="right"><img src="http://file.curitel.com/upload/ct_cartoon_board/사용자 지정 2.jpg" class=cutimg id=cutimg2 style="display:block"></td>
		<td align="right"><img src="/img/community/photolife/play/num2.gif" width="11" height="29"></td>
		</tr>
		
		<tr id=imgtr4> 
		<td height="100"><img src="/img/community/photolife/play/num3.gif" width="11" height="29"></td>
		<td><img src="http://file.curitel.com/upload/ct_cartoon_board/사용자 지정 3(1).jpg"  class=cutimg id=cutimg3 style="display:block"></td>
		<td align="right"><img src="http://file.curitel.com/upload/ct_cartoon_board/사용자 지정 4(1).jpg" class=cutimg id=cutimg4 style="display:block"></td>
		<td align="right"><img src="/img/community/photolife/play/num4.gif" width="11" height="29"></td>
		</tr>
		
		</table>
	</div>
	<div id=divwbox style="position:absolute;z-index:2;"> 
		<table border=0 cellpadding=0 cellspacing=0>
		<tr> 
		<td width="11"></td>
		<td class=itd> 
		<div class=wbox id=wbox1 style="display:block;background-image:url(/img/community/photolife/balloon01.gif);margin:60 0 0 5"> 
			<table class=wtable>
			<tr> 
			<td id=wtd1 class=p8>떨리는 웨딩 촬영</td>
			</tr>
			</table>
		</div></td>
		<td class=itd> 
		<div class=wbox id=wbox2 style="display:block;background-image:url(/img/community/photolife/balloon02.gif);margin:60 0 0 40"> 
			<table class=wtable>
			<tr> 
			<td id=wtd2 class=p8>약간 실감난다~</td>
			</tr>
			</table>
		</div></td>
		<td width="11"></td>
		...
		<td width="11"></td>
		<td class=itd> 
		<div class=wbox id=wbox3 style="display:block;background-image:url(/img/community/photolife/balloon01.gif);margin:60 0 0 5"> 
			<table class=wtable>
			<tr> 
			<td id=wtd3 class=p8>이뿌게~</td>
			</tr>
			</table>
		</div></td>
		<td class=itd> 
		<div class=wbox id=wbox4 style="display:block;background-image:url(/img/community/photolife/balloon02.gif);margin:60 0 0 40"> 
			<table class=wtable>
			<tr> 
			<td id=wtd4 class=p8>행복하게 살아~</td>
			</tr>
			</table>
		</div></td>
		<td width="11"></td>
...
<td width="17" background="/img/community/photolife/frame_mbg02.gif"></td>
<td width="180" bgcolor="#E5E5E5">
	
	<table width="180" border="0" cellspacing="0" cellpadding="0">
	<tr>
	<td style='cursor:hand' onclick=location.href='say_view.asp?idx=1188'><img src="/img/community/photolife/play/img_best01.gif" width="180"></td>
	</tr>

	<!-- <tr> 
	<td height="18" valign="top" bgcolor="#F5F5F5" style="padding-left:6;letter-spacing:-1"><b>[제목] 
	방앗간에서 생긴 일 ^^;;</b></td>
	</tr>
	<tr> 
	<td height="2" bgcolor="#F5F5F5"><img src="/img/community/photolife/tit_bar.gif" width="180" height="2"></td>
	</tr> -->

	<tr> 
	<td bgcolor="#F5F5F5" style='cursor:hand' onclick=location.href='say_view.asp?idx=1188'>
	<div style="height:120;width:170;padding:0 2 2 2;overflow-x:hidden;overflow-y:auto;">
	<font style='font:10pt'>행복하게 살아야해~</font></div>
	</td>
	</tr>
	<tr> 
	<td><img src="/img/community/photolife/frame_b02.gif" width="180" height="7"></td>
	</tr>
	<tr> 
	<td height="7"></td>
	</tr>
	<tr> 
	<td><img src="/img/community/photolife/bul.gif" width="11" height="5" align="absmiddle">
	Curian 
	: <font class="orange">hujiee</font><br> 
	<img src="/img/community/photolife/bul.gif" width="11" height="5" vspace="7" align="absmiddle">등록일 
	: 2006-10-12<br> 

	
	<img src="/img/community/photolife/bul.gif" width="11" height="5" align="absmiddle">모델: 
	PH-K2000<br> 
	
	<img src="/img/community/photolife/bul.gif" width="11" height="5" vspace="7" align="absmiddle">추천수 
	: 0</td>
	</tr>
	</table></td>
<td width="12" background="/img/community/photolife/frame_rbg.gif">&nbsp;</td>
</tr>
<tr> 
<td colspan="5"><img src="/img/community/photolife/frame_b.gif" width="540" height="19"></td>
</tr>
	...
	<tr><!--- 새로운 포토세이 --->
	<td style="padding:18 0 7 6"><img src="/img/community/photolife/play/tit_new02.gif" width="200" height="13"></td>
	</tr>
	<tr>
	<td style="padding:0 0 0 6">
	<iframe src="if_list.asp" scrolling="no" width="537" height="445" frameborder="0" name="say"></iframe></td>
	</tr>
	</table>
