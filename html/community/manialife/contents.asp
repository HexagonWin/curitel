...
<link rel="STYLESHEET" type="text/css" href="/inc/css/phone_new.css">
...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		<td width="77" !height="77" valign="top" style="background:url(/img/phone/titleleftbg.gif) repeat-x left top">
			<!-- SubTitle -->
			<DIV id=divMenu 
			style="position:absolute;VISIBILITY: hidden; WIDTH: 836px; POSITION: absolute;HEIGHT: 65px;z-index:1"> 
					...
					<tr> 
						<td width="589" background="/img/phone/titleleftbg.gif" align="center" valign="top" style="padding:2 0 0 0">
		...
		<input type=hidden name=rurl value="/html/community/manialife/contents.asp">
					<tr>
...
<input type=hidden name=rurl value="/html/community/manialife/contents.asp">
						...
						<td align="right" valign="top" width="87" background="/img/phone/titleleftbg.gif">
					...
					<!-- <embed src=/inc/flash/rollbar_1.swf?uid=0 wmode=transparent width=77 height=65> -->
						...
						<td width="164" align="right" background="/img/phone/titleleftbg.gif"><a href="/html/phone/index.asp" onfocus="this.blur()"><img src="/img/phone/channel_title.gif" width="164" height="65" alt="" border="0"></a></td>
					</tr>
					</table>
			</DIV>
		</td>
		<td width="162"></td>
			<td width="590" height="78" valign="top" style="padding:2 0 0 0">
				<script language="JavaScript">flash('/inc/flash/phone/submenu.swf?html_Num=50','589','51','1');</script>
				<!-- <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="589" height="51"><param name=wmode value=transparent>
					<param name="movie" value="/inc/flash/phone/submenu.swf?html_Num=50">
					<param name="quality" value="high">
					<embed src="/inc/flash/phone/submenu.swf?html_Num=50" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="589" height="51"></embed></object> --></td>
	</tr>
	<tr> 
...
<div id="rpath" style="position:absolute;visibility:visible;left:232;top:197;width:596;height:15;z-index:10;"> 
		<table cellpadding="1" cellspacing="0" border="0" align="right">
				<tr> 
						<td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a> > <a href="/html/phone/index.asp">Phone Deco</a> > 매니아 컨텐츠</td>
				</tr>
		</table>
</div>
<table width="834" height="800" cellspacing="0" cellpadding="0" border="0" class="mubg_gra">
	<tr>
		<td width="77"></td>
			...
			<table width="148" height="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td valign="top">
						...
						<tr>							
					       <td align="center">
							<script language="JavaScript">flash('/inc/flash/left/left_phone05.swf?html_Num=20','100','100');</script>
							<!-- <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100" height="100">
					               <param name="movie" value="/inc/flash/left/left_phone05.swf?html_Num=20">
					               <param name="quality" value="high">
					               <embed src="/inc/flash/left/left_phone05.swf?html_Num=20" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100" height="100"></embed></object> --></td>
						</tr>
...
<option value='13'>광고</option>
	...
	<tr><td height="13"></td></tr>
		...
		<!-- #####Contents##### -->
            <table width="557" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 0 5">
                <tr> 
                    <td height="26">
						<table width="537" height="100%" border="0" cellpadding="0" cellspacing="0">
							<tr><td><img src="/img/community/manialife/subimg02_1.gif" alt="" border="0"></td></tr>
				...
				<tr>
					<td><img src="/img/community/manialife/img_contents_1.gif"  alt="" border="0"></td>
				</tr>
			<tr>
			  
			  <td><iframe src="http://phonedeco.curitel.com/contents/iframe/maniaList.jsp" scrolling="no" width="100%" height="850" frameborder="0" name="mania"></iframe></td>
			</tr>
		  </table>
		  <!-- #####//Contents##### -->
		</td>
