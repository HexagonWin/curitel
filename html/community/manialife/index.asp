...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/community/manialife/index.asp">
					<tr>
...
<div id="rpath" style="position:absolute;visibility:visible;left:232;top:197;width:596;height:15;z-index:10;"> 
		<table cellpadding="0" cellspacing="0" border="0" align="right">
				<tr> 
						<td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a> > <a href="/html/community/index.asp">Community</a> > 매니아라이프</td>
				</tr>
		</table>
</div>
			...
			<table width="148" height="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td valign="top">
						...
						<tr>							
					       <td align="center">
							<script language="JavaScript">flash('/inc/flash/left/left_community05.swf?html_Num=00','100','100');</script>
							<!-- <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100" height="100">
					               <param name="movie" value="/inc/flash/left/left_community05.swf?html_Num=00">
					               <param name="quality" value="high">
					               <embed src="/inc/flash/left/left_community05.swf?html_Num=00" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100" height="100"></embed></object> --></td>
						</tr>
            ...
            <table width="557" cellpadding="0" cellspacing="0" border="0">
                <tr> 
                    <td height="26"> <table width="537" height="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr> 
                                <td><img src="/img/community/manialife/subimg00.gif" width="536" height="97" alt="" border="0"></td>
                            </tr>
                        </table></td>
                </tr>
				<tr>
                    <td valign="top"><img src="/img/community/manialife/mainimg02.jpg" width="537" height="349" alt="" border="0"></td>
                </tr>
                <tr> 
                    
                    <td><iframe src="http://phonedeco.curitel.com/contents/iframe/mania.jsp" scrolling="no" width="100%" height="240" frameborder="0" name="mania"></iframe></td>
                </tr>
