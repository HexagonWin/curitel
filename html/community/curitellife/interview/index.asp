...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/community/curitellife/interview/index.asp">
					<tr>
...
<div id="rpath" style="position:absolute;visibility:visible;left:232;top:197;width:596;height:15;z-index:10;"> 
		<table cellpadding="0" cellspacing="0" border="0" align="right">
				<tr> 
						...
						> <a href="/html/community/curitellife/method/index.asp">큐리안라이프</a> > 큐리안 인터뷰</td>
				</tr>
		</table>
</div>
			...
			<table width="148" height="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td valign="top">
						...
						<tr>
					       <td align="center">
							<script language="JavaScript">flash('/inc/flash/left/left_community01.swf?html_Num=20','100','300');</script>
							<!-- <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100" height="300">
					               <param name="movie" value="/inc/flash/left/left_community01.swf?html_Num=20">
					               <param name="quality" value="high">
					               <embed src="/inc/flash/left/left_community01.swf?html_Num=20" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100" height="300"></embed></object> --></td>
						</tr>
	...
	<tr><td height="13"></td></tr>
		...
		<!-- #####Contents##### -->			    
            <table width="557" cellpadding="0" cellspacing="0" border="0">
	            <tr> 
	            	<td height="26">
						<table width="537" height="100%" border="0" cellpadding="0" cellspacing="0">
							<tr><td><img src="/img/community/curitellife/subimg02.gif" width="536" height="97" alt="" border="0"></td></tr>
                ...
                <tr> 
                    <td style="padding:20 0 10 0"><img src="/img/community/curitellife/interview/txt_selcurian.gif" width="556" height="43" alt="" border="0"></td>
                </tr>

				<tr>
                    <td height="20" align="right" valign="bottom" style="padding:0 19 0 0">

		<a href="javascript:confirmLogin()"><img src="/img/btn/btn_curianapply.gif" alt="" border="0"></a>  <a href="lastcurian.asp"><img src="/img/btn/btn_lastcurian.gif" alt="" border="0"></a>

					</td>
                </tr>
				<tr>
					<td height="30" valign="top"><img src="/img/community/curitellife/title03.gif" width="198" height="21" alt="" border="0"></td>
				</tr>
				<tr>
					<td class="pad8">					
						<!--//-->
						<table width="537" cellpadding="0" cellspacing="0">
                            <tr> 
                                <td width="155" align="center" height="100" valign="top"><table width="155" height="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr> 
                                            <td height="159" align="center" valign="top" style="background:url(/img/community/curitellife/bg_curian.gif) no-repeat left top;padding:32 2 1 3"><a href="theme_view.asp?idx=1540" onFocus="this.blur()"><img src="http://file.curitel.com/upload/ct_curian/1(10).jpg" width="120" height="96"></a></td>
                                        </tr>
                                        <tr> 
                                ...
                                <td width="5"></td>
                                <td width="377" valign="top"> <table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0">
                                        <tr> 
                                            <td height="13" valign="top"><a href="/html/community/curitellife/interview/weekely_view.asp"><img src="/img/community/curitellife/squ_pink01.gif" width="377" height="13" alt="" border="0"></a></td>
                                        </tr>
                                        <tr> 
                                            <td background="/img/community/curitellife/squ_pink02.gif" valign="top" style="padding:0 0 0 8"> 
                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                    <tr> 
                                                        <td valign="top" class="9"><img src="/img/community/curitellife/interview/obj_curian.gif" width="103" height="27" align="absmiddle">&nbsp;<font color="#FF622C"><b>스포츠가 좋아요</b></font></td>
                                                    </tr>
                                                    <tr> 
                                                        <td height="1" bgcolor="#FFDAEC"></td>
                                                    </tr>
                                                    <tr> 
                                                        <td valign="top" style="padding:13"> 
                                                            <a href="theme_view.asp?idx=1540" onFocus="this.blur()"><font class="9">깔끔하고 심플함</a></td>
                                                    </tr>
                                                    <tr> 
                                                        <td valign="top" style="padding:0 0 0 11"> 
                                                            <!--/-->
				...
				<tr><td height="45" style="padding:7 0 0 0"><img src="/img/community/curitellife/interview/title04.gif" width="296" height="13" alt="" border="0"></td></tr>
                <tr> 
                    <td class="pad8">
					
						<table width="529" border="0" cellspacing="0" cellpadding="0">
<form name=searchfrm action=index.asp method=get style="margin:0">
                            <tr> 
                                <td width="11"><img src="/img/community/movielife/broadcasting/edge01.gif" width="11" height="51"></td>
                                <td width="507" align="center" background="/img/community/movielife/broadcasting/edge03.gif"><img src="/img/community/curitellife/mit_curian.gif" width="58" height="20" alt="" border="0" align="absmiddle"> 
                                    <select name="stheme" style="width:253">
                                        <option value="">큐리안 테마 선택</option>

			<option value="1">유별난 이상형</option>

			<option value="2">카리스마 두 얼굴</option>

			<option value="3">최고 vs 최악</option>

			<option value="4">복수는 나의 것</option>

			<option value="5">나의 요리비법</option>

			<option value="6">1인 영화제</option>

			<option value="7">낭만데이트</option>

			<option value="8">내 핸펀 이야기</option>

			<option value="9">사건사고 베스트5</option>

			<option value="10">작심삼일 열전</option>

			<option value="11">고백 스토리</option>

			<option value="12">땡땡이의 추억</option>

			<option value="13">졸음퇴치법</option>

			<option value="14">살떨리는 다이어트</option>

			<option value="15">말한마디</option>

			<option value="16">휴가명당</option>

			<option value="17">추천!레크레이션</option>

			<option value="18">내고향 25시</option>

			<option value="19">시험 시험 시험</option>

			<option value="20">나의 괴짜 친구</option>

			<option value="21">꼭한번만나고싶다</option>

			<option value="22">이런문자 받아봤니?</option>

			<option value="23">여행이 준 선물</option>

			<option value="24">스포츠가 좋아요</option>
			...
			<option value="30"></option>
                                    ...
                                    </select>&nbsp;&nbsp;<input type="text" name="suid" class="input03" style="width:100" value=""> 
                                    <input type=image src="/img/btn/btn_search02.gif" width="46" style="height:17" height="17" hspace="6" align="absmiddle">
                                </td>
...
<SCRIPT LANGUAGE="JavaScript">
<!--
	document.searchfrm.stheme.value = "";
//-->
</SCRIPT>				
					</td>
                </tr>
                <tr> 
                    <td class="pad8">
					 <table width="530" cellpadding="0" cellspacing="0">
                            ...
                            <tr bgcolor='#F4F6F7'> 
                                <td height=75><A HREF="theme_view.asp?idx=1544&page=1"><img src="http://file.curitel.com/upload/ct_curian/0001 (31).jpg" width="80" height="59" class="imgbdr"></a></td>
                                <td style="padding:5 0"><font color="#FF8A00" class="9"><b>[큐리안 테마 : 스포츠가 좋아요]</b></font><br>
                                    <A HREF="theme_view.asp?idx=1544&page=1">둥글게 산다~~
모난구석이 없네^^</A> [0]</td>
                                <td width="150"> <img src="/img/common/orgdot.gif" width="5" height="5" alt="" border="0" align="absmiddle"> Curian : juno615
								<br> <img src="/img/common/orgdot.gif" width="5" height="5" alt="" border="0" align="absmiddle"> 
                                    Level : 큐리안 패밀리<br> <img src="/img/common/orgdot.gif" width="5" height="5" alt="" border="0" align="absmiddle"> 
                                    공감 : 0</td>
                            </tr>
                            <tr> 
                                <td class="bbsline" colspan="3" height="1"></td>
                            ...
                            <tr > 
                                <td height=75><A HREF="theme_view.asp?idx=1543&page=1"><img src="http://file.curitel.com/upload/ct_curian/ㅁㅁ.dik" width="80" height="59" class="imgbdr"></a></td>
                                <td style="padding:5 0"><font color="#FF8A00" class="9"><b>[큐리안 테마 : 스포츠가 좋아요]</b></font><br>
                                    <A HREF="theme_view.asp?idx=1543&page=1">단순한것</A> [0]</td>
                                <td width="150"> <img src="/img/common/orgdot.gif" width="5" height="5" alt="" border="0" align="absmiddle"> Curian : d4708d
								<br> <img src="/img/common/orgdot.gif" width="5" height="5" alt="" border="0" align="absmiddle"> 
                                    Level : 큐리안 패밀리<br> <img src="/img/common/orgdot.gif" width="5" height="5" alt="" border="0" align="absmiddle"> 
                                    공감 : 0</td>
                            </tr>
                            ...
                            <tr bgcolor='#F4F6F7'> 
                                <td height=75><A HREF="theme_view.asp?idx=1542&page=1"><img src="http://file.curitel.com/upload/ct_curian/13791.JPG" width="80" height="59" class="imgbdr"></a></td>
                                <td style="padding:5 0"><font color="#FF8A00" class="9"><b>[큐리안 테마 : 졸음퇴치법]</b></font><br>
                                    <A HREF="theme_view.asp?idx=1542&page=1">투박하면서도 잘 보면 귀여워 ^^</A> [0]</td>
                                <td width="150"> <img src="/img/common/orgdot.gif" width="5" height="5" alt="" border="0" align="absmiddle"> Curian : daeng2000
								<br> <img src="/img/common/orgdot.gif" width="5" height="5" alt="" border="0" align="absmiddle"> 
                                    Level : 큐리안 패밀리<br> <img src="/img/common/orgdot.gif" width="5" height="5" alt="" border="0" align="absmiddle"> 
                                    공감 : 0</td>
                            </tr>
                            ...
                            <tr > 
                                <td height=75><A HREF="theme_view.asp?idx=1541&page=1"><img src="http://file.curitel.com/upload/ct_curian/사짱.jpg" width="80" height="59" class="imgbdr"></a></td>
                                <td style="padding:5 0"><font color="#FF8A00" class="9"><b>[큐리안 테마 : 여행이 준 선물]</b></font><br>
                                    <A HREF="theme_view.asp?idx=1541&page=1">cool~하니까</A> [0]</td>
                                <td width="150"> <img src="/img/common/orgdot.gif" width="5" height="5" alt="" border="0" align="absmiddle"> Curian : kanta
								<br> <img src="/img/common/orgdot.gif" width="5" height="5" alt="" border="0" align="absmiddle"> 
                                    Level : 큐리안 패밀리<br> <img src="/img/common/orgdot.gif" width="5" height="5" alt="" border="0" align="absmiddle"> 
                                    공감 : 0</td>
                            </tr>
                            ...
                            <tr bgcolor='#F4F6F7'> 
                                <td height=75><A HREF="theme_view.asp?idx=1540&page=1"><img src="http://file.curitel.com/upload/ct_curian/1(10).jpg" width="80" height="59" class="imgbdr"></a></td>
                                <td style="padding:5 0"><font color="#FF8A00" class="9"><b>[큐리안 테마 : 스포츠가 좋아요]</b></font><br>
                                    <A HREF="theme_view.asp?idx=1540&page=1">깔끔하고 심플함</A> [0]</td>
                                <td width="150"> <img src="/img/common/orgdot.gif" width="5" height="5" alt="" border="0" align="absmiddle"> Curian : lovekino99
								<br> <img src="/img/common/orgdot.gif" width="5" height="5" alt="" border="0" align="absmiddle"> 
                                    Level : 큐리안 매니아<br> <img src="/img/common/orgdot.gif" width="5" height="5" alt="" border="0" align="absmiddle"> 
                                    공감 : 3</td>
                            </tr>
                            <tr> 
                                <td class="bbsline" colspan="3" height="1"></td>
