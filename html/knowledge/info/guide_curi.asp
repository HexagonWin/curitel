...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/knowledge/info/guide_curi.asp">
					<tr>
...
<div id="rpath" style="position:absolute;visibility:visible;left:232;top:185;width:596;height:15;z-index:10;">  
		<table cellpadding="0" cellspacing="0" border="0" align="right">
				<tr> 
						<td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a> > <a href=/html/knowledge/index.asp>지식 Room</a> > 지식 활동별 Curi 안내</td>
				</tr>
		</table>
</div>
...
//-->
	...
	<input type="image" src="/img/bbs/btn/btn_search.gif" width="46" height="17" border="0" align="absmiddle" style="height:17"><!--&nbsp;<a href="/html/knowledge/info/myquestion.asp"><img src="/img/btn/ans.gif" width="70" border="0" align="absmiddle"></a>--></td>
                    ...
                    <tr> 
                      <td> 
					  	  <img src="/img/my/action/room/guide_curi01.gif" width="536" height="101" alt="" border="0"><br>
                      </td>
                    </tr>
					<tr><td height=30></td></tr>
					<tr>
						<td><img src="/img/my/action/room/guide_curi02.gif" width="118" height="27" alt="" border="0"></td>
					</tr>
					<tr>
						<td>
								<table cellpadding=5 cellspacing=1 border=0 width=530 bgcolor=#B9D7E1>
								<tr><td colspan=4 height=1></td></tr>
								<tr align=center bgcolor=#E0EFF3>
									<td style="color:#2D738A"><b>대분류</b></td>
									<td style="color:#2D738A"><b>소분류</b></td>
									<td style="color:#2D738A"><b>내용</b></td>
									<td style="color:#2D738A"><b>획득 Curi</b></td>
								</tr>
								<tr align=center bgcolor=white>
									<td style="color:#2D738A" rowspan=3 bgcolor=#F8FBFD>지식 Room</td>
									<td rowspan=3>&nbsp;</td>
									<td align=left>&nbsp;- 답변 등록시</td>
									<td>1</td>
								</tr>
								<tr align=center bgcolor=white>
									<td align=left>&nbsp;- 답변이 지식으로 선정시</td>
									<td>3</td>
								</tr>
								<tr align=center bgcolor=white>
									<td align=left>&nbsp;- 불법게시물 신고자 (관리자가 승인 후)</td>
									<td>1</td>
								</tr>
								</table>
						</td>
					...
					<tr><td height=30></td></tr>
					<tr>
						<td><img src="/img/my/action/room/guide_curi03.gif" width="118" height="27" alt="" border="0"></td>
					</tr>
					<tr>
						<td>
								<table cellpadding=5 cellspacing=1 border=0 width=530 bgcolor=#B9D7E1>
								...
								<tr align=center bgcolor=white>
									<td style="color:#2D738A" rowspan=2 bgcolor=#F8FBFD>지식 Room</td>
									<td rowspan=2>&nbsp;</td>
									<td align=left>&nbsp;- 질문 후, 채택기간 내 질문 방치</td>
									<td>5</td>
								</tr>
								<tr align=center bgcolor=white>
									<td align=left>&nbsp;- 신고당한 사람 (관리자 승인 후)</td>
									<td>10</td>
								</tr>
								</table>
						</td>
