...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/knowledge/info/guide_room.asp">
					<tr>
...
<div id="rpath" style="position:absolute;visibility:visible;left:232;top:185;width:596;height:15;z-index:10;">  
		<table cellpadding="0" cellspacing="0" border="0" align="right">
				<tr> 
						<td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a> > <a href=/html/knowledge/index.asp>지식 Room</a> > 지식 Room 이용안내</td>
				</tr>
		</table>
</div>
					...
					<td valign="top">
						...
						<!--tr>							
					       <td align="center"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100" height="100">
					               <param name="movie" value="/inc/flash/left/left_knowledge.swf?html_Num=00">
					               <param name="quality" value="high">
					               <embed src="/inc/flash/left/left_knowledge.swf?html_Num=00" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100" height="100"></embed></object></td>
						</tr-->
      ...
      <table width="557" cellpadding="0" cellspacing="0" border="0">
        <tr> 
          <td height="26"> <table width="537" height="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td><img src="/img/knowledge/subimg00_1.gif"></td>
              </tr>
              <tr>
                <td height="1"></td>
              </tr>
	...
	<input type="image" src="/img/bbs/btn/btn_search.gif" width="46" height="17" border="0" align="absmiddle" style="height:17"><!--&nbsp;<a href="/html/knowledge/info/myquestion.asp"><img src="/img/btn/ans.gif" width="70" border="0" align="absmiddle"></a>--></td>
        ...
        <tr> 
		  ...
		  <table width="530" border="0" cellspacing="0" cellpadding="0">
              <tr> 
              <tr> 
                <td height="29" background="/img/common/tabbg.gif"> <a href="/html/knowledge/info/guide_room.asp"><img src="/img/my/action/room/guide_tab01_o.gif" height="29" hspace=0 align=left></a> 
                  <a href="/html/knowledge/info/guide_room02.asp"><img src="/img/my/action/room/guide_tab02.gif" height="29" hspace="1" align=left></a> 
                </td>
              </tr>
              <tr>
                <td height="6"></td>
        ...
        <tr> 
          <td><img src="/img/my/action/room/guide_room_t01.gif" width="536" height="86" alt="" border="0"></td>
        </tr>
        <!--
		<tr>
        ...
        <tr> 
          <td><img src="/img/my/action/room/guide_room_t02.gif" width="265" height="32" alt="" border="0"></td>
        </tr>
        <tr> 
          <td> 
            <!--라운드 첫번째--
              ...
              <tr> 
                ...
                <td> 
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td style="padding:10 0 0 12"><img src="/img/my/action/room/guide_room_t03.gif" width="157" height="23" hspace=0></td>
                    </tr>
                    <tr> 
                      <td style="padding:0 0 15 12"> 평소에 알고 싶었던 작은 궁금증에서부터 전문적인 
                        지식까지 모르는 것을 질문할 수 있습니다. <br>
                        큐리텔 회원님들의 질문에 대해 직접 답변을 올려 유익한 정보와 지식을 나눌 수 있습니다.<br> 
                      </td>
                    </tr>
                    <tr> 
                      <td><img src="/img/my/action/room/guide_room_t04.gif" width="94" height="19" hspace=12></td>
                    </tr>
                    <tr> 
                      <td>
					  <table width="533" cellpadding="0" cellspacing="0" border="0" bgcolor="#F2F2F2">
                          ...
                          <tr> 
                            <td height="50"></td>
                            <td style="padding:5 30">
							<table width="100%" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td><font style="font-size:7pt">&#149;</font> 
                                    제품관련</td>
                                  <td><font style="font-size:7pt">&#149;</font> 
                                    프로그램/악세서리</td>
                                  <td><font style="font-size:7pt">&#149;</font> 
                                ...
                                <tr> 
                                  <td colspan=3><font style="font-size:7pt">&#149;</font> 
                                    A/S 및 서비스 센터</td>
                                </tr>
                              </table></td>
                            <td></td>
            ...
            <!--//라운드 첫번째--
                  ...
                  <!-- #####//Contents End ##### -->
				     ...
				     <tr> 
                      <td style="padding-top:15"><img src="/img/my/action/room/guide_room_t04_1.gif" hspace=12></td>
                    </tr>

					<tr><td style="padding-left:7">
						<table width="530" cellpadding="0" cellspacing="0" border="0" bgcolor="#F2F2F2">
						<tr> 
							<td width="3"><img src="/img/common/gredge01.gif" width="3" height="3" alt="" border="0"></td>
