...
<tr> 
	<td width="77" !height="77" valign="top" style="background:url(/img/phone/titleleftbg.gif) repeat-x left top">
		...
		<input type=hidden name=rurl value="/html/phone/emoticon/index.asp">
					<tr>
...
<input type=hidden name=rurl value="/html/phone/emoticon/index.asp">
	...
	<td width="162"></td>
		<td width="590" height="63" valign="top" style="padding:2 0 0 0">
			<script language="JavaScript">flash('/inc/flash/phone/submenu.swf?html_Num=40','589','51','1');</script>
			<!-- <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="589" height="51"><param name=wmode value=transparent>
                <param name="movie" value="/inc/flash/phone/submenu.swf?html_Num=40">
                <param name="quality" value="high">
                <embed src="/inc/flash/phone/submenu.swf?html_Num=40" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="589" height="51"></embed></object> --></td>
</tr>
</table>
<script>menuInit()</script>
<table width="829" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><iframe src="http://sms2.curitel.com/usr/emo/index.vw?cp_id=curitel" scrolling="no" width="829" height="1100" frameborder="0" name="emoticon"></iframe></td>
  </tr>
</table>
<!-- QuickMenu -->
