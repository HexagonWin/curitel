...
<tr> 
	<td width="77" !height="77" valign="top" style="background:url(/img/phone/titleleftbg.gif) repeat-x left top">
		...
		<input type=hidden name=rurl value="/html/phone/coolzone/index.asp">
					<tr>
...
<input type=hidden name=rurl value="/html/phone/coolzone/index.asp">
					...
					<td width="164" align="right"><a href="/html/phone/index.asp" onfocus="this.blur()"><img src="/img/phone/channel_title.gif" width="164" height="65" alt="" border="0"></a></td>
				</tr>
				</table>
		</DIV>
	</td>
	<td width="162"></td>
		<td width="590" height="63" valign="top" style="padding:2 0 0 0">
...
<table width="829" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>
	<div style='position:absolute;margin:17 0 0 85;'>
							<table width="148" cellspacing="0" cellpadding="0" border="0">
						<tr>							
					       <td align="center">
							<script language="JavaScript">flash('/inc/flash/left/left_phone05.swf?html_Num=10','100','100');</script>
							<!-- <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100" height="100">
					               <param name="movie" value="/inc/flash/left/left_phone05.swf?html_Num=10">
					               <param name="quality" value="high">
					               <embed src="/inc/flash/left/left_phone05.swf?html_Num=10" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100" height="100"></embed></object> --></td>
						</tr>
...
<option value='13'>광고</option>
	...
	<iframe src="http://phonedeco.curitel.com/contents/socoolZone.jsp" scrolling="no" width="829" height="1350" frameborder="0" name="phone"></iframe></td>
  </tr>
</table>
<!-- QuickMenu -->
