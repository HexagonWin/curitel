...
<tr> 
	<td width="77" height="77" valign="top" style="background:url(/img/help/titleleftbg.gif) repeat-x left top">
		...
		<input type=hidden name=rurl value="/html/help/download/editor.asp">
					<tr>
...
<tr>
	<td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a> > <a href="/html/help/index.asp">HELP DESK</a> > <a href="/html/help/download/index.asp">다운로드</a> > Image Editor</td>
</tr>
</table>
</div>
					...
					<td valign="top">
						...
						<tr>
					       <td align="center">
							...
							<script language="JavaScript">flash('/inc/flash/left/left_help.swf?html_Num=46&ismonitoring=','100','350');</script>
							<!-- <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100" height="367">
					               <param name="movie" value="/inc/flash/left/left_help.swf?html_Num=46&ismonitoring=">
					               <param name="quality" value="high">
					               <embed src="/inc/flash/left/left_help.swf?html_Num=46&ismonitoring=" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100" height="367"></embed></object> -->
				...
				<tr>
					<td valign="top" class="ctsmgn">
						...
						<table width="557" cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td><img src="/img/help/download/subimg05.gif" width="537" height="97"></td>
							</tr>
							...
							<tr>
								<td style="padding:20 0 11 10"><img src="/img/help/download/txt_img.gif"></td>
							</tr>
...
<!-- 							<tr>
								<td><img src="/img/help/download/txt_editor.gif" width="385" height="73" alt="" border="0" align="absmiddle"><a href="#"><img src="/img/btn/downditor02.gif" width="128" height="30" alt="" border="0" hspace="22"></a></td>
							</tr> -->
							<tr><td style="padding:0 0 0 0"><iframe src="/html/product/download/if_editor.asp?sector=help" scrolling="No" frameborder="0" width="557" height="285"></iframe>
							</td></tr>
							<tr><td><img src="/img/common/plusline.gif" width="557" height="11" alt="" border="0" vspace="10"></td></tr>
						</table>
						<!-- #####//Contents End ##### -->
