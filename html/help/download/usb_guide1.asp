...
<tr> 
	<td width="77" height="77" valign="top" style="background:url(/img/help/titleleftbg.gif) repeat-x left top">
		...
		<input type=hidden name=rurl value="/html/help/download/usb_guide1.asp">
					<tr>
					...
					<td valign="top">
						...
						<tr>
					       <td align="center">
							...
							<script language="JavaScript">flash('/inc/flash/left/left_help.swf?html_Num=44&ismonitoring=','100','350');</script>
							<!-- <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100" height="367">
					               <param name="movie" value="/inc/flash/left/left_help.swf?html_Num=44&ismonitoring=">
					               <param name="quality" value="high">
					               <embed src="/inc/flash/left/left_help.swf?html_Num=44&ismonitoring=" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100" height="367"></embed></object> -->
				...
				<tr> 
					<td valign="top" class="ctsmgn"> 
						...
						<table width="557" cellpadding="0" cellspacing="0" border="0">
							<tr> 
								<td><img src="/img/help/download/subimg03_1.gif" width="537" height="97"></td>
							</tr>
							<tr> 
							...
							<tr> 
								...
								<tr>
									<td width=236>
									<a href="usb_guide1.asp"><img src="/img/help/download/tab001_o.gif"></a><a href="usb_guide2.asp"><img src="/img/help/download/tab002.gif"></a><br>
									</td>
									<td style="background:url(/img/help/guide/line.gif) repeat-x 0px 24px;padding:0 0 3 0" align=right><a href="usb.asp"><img src="/img/btn/btn_driver_dwn.gif"></a></td>
								</tr>
								</table>
								<!-- //Window 2000/ xp 메뉴 -->
								</td>
							...
							<tr>
								...
								2. HELP DESK > 다운로드의 USB Driver를 클릭합니다.<br>
								<img src="/img/help/download/usb_img002.gif" width=430 height=312><br><br><br>

								3. CURITEL USB DRIVER DOWNLOAD 버튼을 클릭합니다.<br>
								<img src="/img/help/download/usb_img003.gif"><br><br><br>

								4. 아래와 같은 팝업창이 나타나며 저장 버튼을 클릭합니다.<br>
								<img src="/img/help/download/usb_img004.gif"><br><br><br>

								5. 저장할 위치를 선택한후 저장 버튼을 클릭합니다..<br>
								<img src="/img/help/download/usb_img005.gif"><br><br><br>

								6. 다운 받은 파일을 더블클릭 하여 압축을 푼뒤 USB driver 설치 마법사를 실행합니다.<br>
								<img src="/img/help/download/usb_img006.gif"><br><br><br>

								기존 드라이버가 설치가 되었을 경우 아래와 같은 창이 나타나며 예를 눌러 삭제를 시행합니다.<br>
								<img src="/img/help/download/usb_img006_1.gif"><br><br><br>

								설치 후 확인 버튼을 눌러 꼭 컴퓨터를 재부팅 합니다.<br>
								<img src="/img/help/download/usb_img006_2.gif"><br><br><br>

								7. 6 번 창에서 다음 버튼을 누르면 아래와 같이 USB CABLE와 휴대폰 분리를 <br>
								&nbsp;&nbsp;&nbsp;안내하는 창이 나타납니다.
								(컴퓨터 케이블과 휴대폰 케이블을 분리합니다.)<br>
								<img src="/img/help/download/usb_img007.gif"><br><br><br>

								8. 설치 위치를 선택합니다. (설치 위치는 기본 설정을 권장합니다.)<br>
								<img src="/img/help/download/usb_img008.gif"><br><br><br>

								9. 설치 준비가 완료되었으며 설치를 실행합니다.<br>
								<img src="/img/help/download/usb_img010.gif"><br><br><br>


								10. 설치 완료 화면이 나타납니다.<br>
								<img src="/img/help/download/usb_img011.gif"><br><br><br>

								11. USB CABLE와 휴대폰을 연결 합니다. 새로운 하드웨어를 발견했음을 나타내며<br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3가지 화면 확인이 가능합니다. <br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(아래 화면이 나타나지 않을경우 15번으로..)<br>
								<img src="/img/help/download/usb_img034.gif"><br><br><br>

								12. 드라이버 설치를 위한 프로그램 위치에 대해서 묻게 됩니다.  <br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(아래와 같은 단계가 나타나지 않을수도 있음)<br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;위치를 물을 경우 C:\Program Files\CURITEL\Curitel Packet Service 로 위치를 설정합니다.<br>
								<img src="/img/help/download/usb_img035.gif"><br><br><br>

								13. 언제나 위치 설정을 물을때는 C:\Program Files\CURITEL\Curitel Packet Service 로 위치를  <br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;설정합니다.<br><br>

								14. 정상적으로 설치가 완료되면 시작버튼 > 제어판 > 시스템 > 하드웨어 > 장치관리자를 통해 아래와 <br>
								...
								15. 설치시 11번과 같이 자동으로 화면이 나타나지 않을 경우 직접 내 컴퓨터 > 시스템 > 하드웨어 > <br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;장치관리자를 통해 설치가 실행되지 않은 드라이버를 선택하여 설치하시기 바랍니다. <br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;노란색 원에 ! 표가 나타나는 것은 설치가 정상적으로 되지 않은 부분으로 수동적으로 설치 <br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;해주셔야 합니다. 아래 화면은 컴퓨터 환경 마다 틀릴수가 있습니다. <br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(아래와 같은 화면이 나타나지 않을 경우 케이블과 휴대폰을 분리 후 다시 연결 바랍니다.)<br>
								<img src="/img/help/download/usb_img014.gif" width=512 height=362><br><br><br>

								16. 노란색 원에 ! 표가 나타나있는 드라이버를 선택 마우스 오른쪽 버튼으로 등록정보(속성)을 <br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;확인합니다<br>
								<img src="/img/help/download/usb_img015.gif" width=512 height=371><br><br><br>

								17. 아래와 같은 화면이 나타나며 드라이버 다시 설치를 선택합니다.<br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(어떤 장치인가에 따라서 아래 화면은 틀릴수 있습니다)<br>
								<img src="/img/help/download/usb_img016.gif" width=375 height=340><br><br><br>

								18. 장치 드라이버 업그레이드 화면이 나타납니다.<br>
								<img src="/img/help/download/usb_img017.gif" width=470 height=302><br><br><br>

								19. 장치에 적절한 드라이버 검색을 선택 합니다.<br>
								...
								21. 위치지정을 12번과 같이 해 줍니다.<br>
								<img src="/img/help/download/usb_img020.gif" width=400 height=154><br><br><br>

								22. USB CABLE와 휴대폰을 연결뒤 아래와 같이 새로운 하드웨어를 설치합니다.<br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(아래의 화면은 환경에 따라 틀릴수 있습니다)<br>
								<img src="/img/help/download/usb_img036.gif"><br><br><br>

								23. 설치가 완료 됨을 확인합니다.<br>
								<img src="/img/help/download/usb_img022.gif" width=469 height=301><br><br><br>

								24. 14번 화면을 확인합니다.<br><br>

								<span style="color:#EA000A">※ USB DRIVER 완전 삭제후 재설치를 원하실 때는….</span><br><br>

								1. 시작버튼 > 제어판 > 프로그램 추가 제거를 통해 curitel 프로그램을 선택 변경 제거 버튼을 <br>
								&nbsp;&nbsp;&nbsp;실행합니다.<br>
								<img src="/img/help/download/usb_img037.gif"><br><br><br>

								2. 아래와 같은 제거 확인 화면이 나타납니다.<br>
								<img src="/img/help/download/usb_img038.gif"><br><br><br>

								3. 휴대폰과 컴퓨터가 CABLE로 연결되어 있을 경우 삭제가 되지 않으며 연결을 분리합니다.<br>
								<img src="/img/help/download/usb_img039.gif"><br><br><br>

								4. 제거 후 재부팅 화면이 나타나며 삭제가 완료됩니다.<br>
								<img src="/img/help/download/usb_img040.gif"><br><br><br>

								<!--<b>※ 좀 더 자세한 사항은 콜센터 1544-4424, 1577-4424로 문의하여 주시기 바랍니다.</b>-->
