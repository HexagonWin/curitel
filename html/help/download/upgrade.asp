...
<tr> 
	<td width="77" height="77" valign="top" style="background:url(/img/help/titleleftbg.gif) repeat-x left top">
		...
		<input type=hidden name=rurl value="/html/help/download/upgrade.asp">
					<tr>
...
<tr>
	<td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a> > <a href="/html/help/index.asp">HELP DESK</a> > <a href="/html/help/download/index.asp">다운로드</a> > Self Upgrade</td>
</tr>
</table>
</div>
					...
					<td valign="top">
						...
						<tr>
					       <td align="center">
							...
							<script language="JavaScript">flash('/inc/flash/left/left_help.swf?html_Num=41&ismonitoring=','100','350');</script>
							<!-- <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100" height="367">
					               <param name="movie" value="/inc/flash/left/left_help.swf?html_Num=41&ismonitoring=">
					               <param name="quality" value="high">
					               <embed src="/inc/flash/left/left_help.swf?html_Num=41&ismonitoring=" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100" height="367"></embed></object> -->
				...
				<tr>
					<td valign="top" class="ctsmgn">
						...
						<table width="557" cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td><img src="/img/help/download/subimg08.gif" width="537" height="97"></td>
							</tr>
							...
							<tr>
								<td style="padding:20 0 11 10"><img src="/img/help/download/upgrade_txt.gif"></td>
							</tr>
 							<tr>
							...
							<tr>
								<td style="padding:0 0 0 10"><img src="/img/help/download/upgrade_txt3.gif"></td>
							</tr>
							<tr>
								<td style='padding:0 0 10 10'>

								<div style='margin:0 10 5 0' align=right>
								<a href="javascript:" onclick="javascript:window.open('pop_more.asp','pop_more','toolbar=0, menubar=0, resizable=0, scrollbars=0, status=0, width=300,height=360,top=100,left=100')">
								<img src="/img/help/download/more.gif"></a>
								</div>

								<table width=540 cellpadding=0 cellspacing=0 border=0>
								<tr height=30 align=center class=b>
									<td bgcolor=#D5DD4D width=110>모델명</td>
									<td rowspan=2 width=1></td>
									<td bgcolor=#D5DD4D>PT-K2700</td>
									<td bgcolor=#D5DD4D>PT-K1800</td>
									<td bgcolor=#D5DD4D>PT-K1700</td>
									<td bgcolor=#D5DD4D>PT-K2800</td>
									<td bgcolor=#D5DD4D>PT-S200</td>
								</tr>
							...
							<tr>
								<td style="padding:10 0 11 10"><img src="/img/help/download/upgrade_txt4.gif"></td>
							</tr>
							<tr>
								<td style="padding:0 0 11 19">
							...
							<tr>
								<td style="padding:10 0 11 10"><img src="/img/help/download/upgrade_txt5.gif"></td>
							</tr>
							<tr>
							...
							<tr>
								<td style="padding:10 0 11 10"><img src="/img/help/download/upgrade_txt6.gif"></td>
							</tr>
							<tr>
