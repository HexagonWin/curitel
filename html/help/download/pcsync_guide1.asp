...
<tr> 
	<td width="77" height="77" valign="top" style="background:url(/img/help/titleleftbg.gif) repeat-x left top">
		...
		<input type=hidden name=rurl value="/html/help/download/pcsync_guide1.asp">
					<tr>
					...
					<td valign="top">
						...
						<tr>
					       <td align="center">
							...
							<script language="JavaScript">flash('/inc/flash/left/left_help.swf?html_Num=43&ismonitoring=','100','350');</script>
							<!-- <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100" height="367">
					               <param name="movie" value="/inc/flash/left/left_help.swf?html_Num=43&ismonitoring=">
					               <param name="quality" value="high">
					               <embed src="/inc/flash/left/left_help.swf?html_Num=43&ismonitoring=" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100" height="367"></embed></object> -->
				...
				<tr> 
					<td valign="top" class="ctsmgn"> 
						...
						<table width="557" cellpadding="0" cellspacing="0" border="0">
							<tr> 
								<td><img src="/img/help/download/subimg02_1.gif" width="537" height="97"></td>
							</tr>
							<tr> 
							...
							<tr> 
								...
								<table width="537" height="100%" cellpadding="0" cellspacing="0">
										<tr> 
							...
							<tr> 
								<td style="padding:20 0 11 0">
								<!-- Window 2000/ xp 메뉴-->
								<table width=537 cellpadding=0 cellspacing=0 border=0 height=26>
								<tr>
									<td width=236>
									<a href="pcsync_guide1.asp"><img src="/img/help/download/tab001_o.gif"></a><a href="pcsync_guide2.asp"><img src="/img/help/download/tab002.gif"></a><br>
									</td>
									<td style="background:url(/img/help/guide/line.gif) repeat-x 0px 24px;padding:0 0 3 0" align=right><a href="pcsync.asp"><img src="/img/btn/btn_pcsync_dwn.gif"></a></td>
								</tr>
								</table>
								<!-- //Window 2000/ xp 메뉴 -->
								</td>
							...
							<tr>
								<td>
								<div style="color:#EF4730" class="b">※ USB Cable과 휴대폰은 연결하지 않은 상태에서 설치를 시작합니다.</div><br>

								1. 큐리텔 사이트 (http://www.curitel.com)에 접속하여 HELP DESK 메뉴를 클릭합니다<br>
								<img src="/img/help/download/usb_img001.gif" width=430 height=312><br><br><br>

								2. HELP DESK > 다운로드의 PC-Sync를 클릭합니다.<br>
								<img src="/img/help/download/usb_img002.gif" width=430 height=312><br><br><br>

								3. 해당 모델에 PC Sync 버튼을 클릭 합니다.<br>
								&nbsp;&nbsp;&nbsp;(다운로드를 하실 때는 다운로드 받고자하는 윈도우만 활성화 시키고 다른 윈도우는 닫아둡니다.<br>
								&nbsp;&nbsp;&nbsp;버튼을 누른 뒤 4 번과 같은 창이 나타날 때까지 기다립니다)<br>
								<img src="/img/help/download/pcsync_img001.gif" width=430 height=312><br><br><br>

								4. 저장 버튼을 누릅니다.<br>
								(아래 화면은 모델에 따라 파일 이름이 달라질 수 있습니다.)<br>
								<img src="/img/help/download/pcsync_img002.gif" width=370 height=214><br><br><br>

								5. 저장할 위치를 선택합니다.<br>
								(아래 화면은 모델에 따라 파일 이름이 달라질 수 있습니다.)<br>
								<img src="/img/help/download/pcsync_img003.gif" width=524 height=257><br><br><br>

								6. 저장이 완료되면 파일을 선택하고 압축을 풀어줍니다.<br>
								&nbsp;&nbsp;&nbsp;(아래 화면은 모델에 따라 파일 이름이 달라질 수 있습니다.)<br>
								<img src="/img/help/download/pcsync_img004.gif" width=369 height=358><br><br><br>

								7. 압축을 푼 후 실행 파일을 실행하면 아래와 같이 설치가 진행됩니다.<br>
								<img src="/img/help/download/pcsync_img005.gif" width=486 height=289><br><br><br>

								8. 설치 진행도중 아래와 같이 USB Driver 설치 파일이 나타나면 install을 눌러 설치합니다.<br>
								<img src="/img/help/download/usb_img006.gif" width=432 height=135><br><br><br>

								9. 새로운 프로그램을 설치하는 도중 아래와 같은 화면이 나타나면 예를 선택하고 계속을 클릭합니다.<br>
								<img src="/img/help/download/usb_img008.gif" width=412 height=240><br><br><br>

								10. USB Driver 설치가 완료되었다는 메세지가 뜹니다. 확인 버튼을 클릭하세요.
								<img src="/img/help/download/usb_img007.gif" width=280 height=95><br><br><br>

								11. 피시싱크 설치 완료 메시지가 나타납니다. 완료를 눌러 설치를 완료합니다.<br>
								<img src="/img/help/download/pcsync_img006.gif" width=476 height=284><br><br><br>

								12. USB Cable과 휴대폰을 연결합니다. 새 하드웨어가 아래와 같이 발견됩니다.<br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(아래 화면은 모델에 따라 파일 이름이 달라질 수 있습니다.)<br>
								<img src="/img/help/download/pcsync_img007.gif" width=364 height=80><br><br><br>

								13. 새로운 프로그램을 설치하는 도중 아래와 같은 화면이 나타나면 예를 선택하고 계속을 클릭합니다.<br>
								<img src="/img/help/download/usb_img008.gif" width=412 height=240><br><br><br>

								14. 1분 혹은 2~30 초 뒤에 12번과 13번과 같은 화면이 2~3회 반복 나타납니다.<br><br>

								15. 정상적으로 설치가 완료되면 시작버튼 > 제어판 > 시스템 > 하드웨어 > 장치관리자를 통해 아래와 <br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;같은 3가지 curitel 드라이버 확인이 가능합니다. <br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(curitel packet service, curitel usb composite device, curitel packet service diagnositc serial <br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;port(wdm)<br><br>

								※ 모델에 따라 curitel packet service diagnostic serial port는 나타나지 않을수 있으며 <br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;com4의 경우 숫자가 틀릴수 있습니다. <br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(S7000V, S2/S2M, S4, S6500, S2700, S1500, S5500M 나타나지 않음) <br>
								<img src="/img/help/download/usb_img012.gif" width=512 height=361><br><br><br>

								※ 모뎀이 두개가 설치되어 있을 경우 큐리텔 모뎀을 제외한 나머지 모뎀을 사용안함으로 설정한 후<br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;이용하시기 바랍니다.<br>
								<img src="/img/help/download/pcsync_img010.gif" width=510 height=357><br><br><br>

								16. 설치시 12번, 13번같이 자동으로 화면이 나타나지 않을 경우, 혹은 15번과 같이 장치들이 확인되지 <br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;않는다면 직접 내컴퓨터 > 시스템 > 하드웨어 > 장치관리자를 통해 설치가 실행되지 않은 드라이버<br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;를 선택하여 설치해야 합니다. 노란색 원에 ! 표가 나타나는 것은 설치가 정상적으로 되지 않은 <br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;것으로 수동으로 설치해야 합니다. 아래 화면은 컴퓨터 환경마다 달라질 수 있습니다. <br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(아래와 같은 화면이 나타나지 않을 경우 케이블과 휴대폰을 분리후 다시 연결 바랍니다)<br>
								<img src="/img/help/download/usb_img014.gif" width=512 height=362><br><br><br>

								17. 노란색 원에 ! 표가 나타나있는 드라이버를 선택 마우스 오른쪽 버튼으로 등록정보(속성)을 <br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;확인합니다<br>
								<img src="/img/help/download/usb_img015.gif" width=512 height=371><br><br><br>

								18. 아래와 같은 화면이 나타나며 드라이버 다시 설치를 선택합니다.<br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(어떤 장치인가에 따라서 아래 화면은 틀릴수 있습니다)<br>
								<img src="/img/help/download/usb_img016.gif" width=375 height=340><br><br><br>

								19. 장치 드라이버 업그레이드 화면이 나타납니다.<br>
								<img src="/img/help/download/usb_img017.gif" width=470 height=302><br><br><br>

								20. 장치에 적절한 드라이버 검색을 선택 합니다.<br>
								<img src="/img/help/download/usb_img018.gif" width=470 height=302><br><br><br>

								21. 위치지정을 선택합니다.<br>
								<img src="/img/help/download/usb_img019.gif" width=470 height=302><br><br><br>

								22. 위치지정을 C:\Program Files\CURITEL\Curitel Packet Service로 입력합니다.<br>
								<img src="/img/help/download/usb_img020.gif" width=400 height=154><br><br><br>

								23. USB CABLE와 휴대폰을 연결뒤 아래와 같이 새로운 하드웨어를 발견했음을 나타내며<br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;예 버튼을 누릅니다.<br>
								<img src="/img/help/download/usb_img021.gif" width=412 height=240><br><br><br>

								24. 설치가 완료 됨을 확인합니다.<br>
								<img src="/img/help/download/usb_img022.gif" width=469 height=301><br><br><br>

								25. 15번 화면을 확인합니다.<br><br><br>

								<span style="color:#EA000A">※ 피시싱크를 완전히 삭제후 재설치 하기 위해서는…</span><br><br>

								1. 시작 > 제어판 > 프로그램 추가/제거를 통해 큐리텔에 관련된 모든 파일을 삭제합니다. <br>
								&nbsp;&nbsp;&nbsp;그 후 1번부터 다시 재설치하시기 바랍니다. <br>
								&nbsp;&nbsp;&nbsp;(추가 제거가 안될 경우 2번참고)<br>
								<img src="/img/help/download/pcsync_img008.gif" width=499 height=381><br><br><br>

								2. 프로그램 추가/제거를 통해 삭제가 되지 않는다면 다운로드 받았던 설치 파일을 다시 실행합니다. <br>
								&nbsp;&nbsp;&nbsp;피시싱크가 설치되어 있는 상태에서 다운받았던 설치파일을 실행하면 아래와 같이 삭제가 가능한 <br>
								&nbsp;&nbsp;&nbsp;창이 나타나며 삭제를 실행한 뒤 다시 설치를 실행하여 1번부터 재설치 하시기 바랍니다.<br>
								&nbsp;&nbsp;&nbsp;(설치된 드라이버에 따라 아래 화면은 달라질 수 있습니다.)<br>
								<img src="/img/help/download/pcsync_img009.gif" width=486 height=289><br><br>

								<b>※ 좀 더 자세한 사항은 콜센터 1544-4424, 1577-4424로 문의하여 주시기 바랍니다.</b><br>
