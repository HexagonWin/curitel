...
<tr> 
	<td width="77" height="77" valign="top" style="background:url(/img/help/titleleftbg.gif) repeat-x left top">
		...
		<input type=hidden name=rurl value="/html/help/download/player.asp">
					<tr>
...
<tr>
	<td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a> > <a href="/html/help/index.asp">HELP DESK</a> > <a href="/html/help/download/index.asp">다운로드</a> > 동영상 Player</td>
</tr>
</table>
</div>
					...
					<td valign="top">
						...
						<tr>
					       <td align="center">
							...
							<script language="JavaScript">flash('/inc/flash/left/left_help.swf?html_Num=47&ismonitoring=','100','350');</script>
							<!-- <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100" height="367">
					               <param name="movie" value="/inc/flash/left/left_help.swf?html_Num=47&ismonitoring=">
					               <param name="quality" value="high">
					               <embed src="/inc/flash/left/left_help.swf?html_Num=47&ismonitoring=" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100" height="367"></embed></object> -->
				...
				<tr>
					<td valign="top" class="ctsmgn">
						...
						<table width="557" cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td><img src="/img/help/download/subimg07.gif" width="537" height="97"></td>
							</tr>
							...
							<tr>
								<td style="padding:20 0 11 10"><img src="/img/help/download/txt_player02.gif"></td>
							</tr>
...
<!-- 							<tr>
								<td><img src="/img/help/download/txt_viewer.gif" width="400" height="65" alt="" border="0" align="absmiddle"><a href="#"><img src="/img/btn/downviewer.gif" width="128" height="30" alt="" border="0"></a></td>
							</tr> -->
							<tr><td style="padding:0 0 0 0"><iframe src="/html/product/download/if_player.asp?sector=help" scrolling="No" frameborder="0" width="557" height="350"></iframe>
							</td></tr>
							<tr><td><img src="/img/common/plusline.gif" width="557" height="11" alt="" border="0" vspace="10"></td></tr>
