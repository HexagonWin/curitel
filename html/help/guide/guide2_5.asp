...
<tr> 
	<td width="77" height="77" valign="top" style="background:url(/img/help/titleleftbg.gif) repeat-x left top">
		...
		<input type=hidden name=rurl value="/html/help/guide/guide2_5.asp">
					<tr>
					...
					<td valign="top" class="ctsmgn">
						...
						<tr>
							<td style="padding:20 0 0 0;" height=26>
								...
								<tr>
									<td align=center>
									<img src="/img/help/guide/ttbox2_5.gif" width="510" height="144" usemap=#Map_box><br><br>
<map name="Map_box">
	...
	<area shape="rect" coords="8,116,111,134" href="guide2_5.asp">
								...
								<tr>
									...
									<img src="/img/help/guide/tt02_5.gif"><br><br>
									핸즈프리는 자석에 고무를 씌운 뒤 차량에 부착 후 배터리에 철 조각을 접착하여 자력으로 휴대폰을 거치해 놓는 방식으로 일반적으로 자력이 매우 강합니다.<br><br>

									따라서 자석 거치대에 휴대폰을 부착할 경우 슬라이드 또는 폴더를 닫아도 열린 것으로 인식하거나 열어도 닫힌 것으로 인식할 수 있습니다. 또한, 통화 중 거치대에서 휴대폰을 분리할 경우 전화가 끊어질 수도 있습니다.<br><br>

									(폴더나 슬라이드에는 일반적으로 자력의 성격을 띤 센서가 내장되어 있고, 반대쪽에 자력센서를 감지하는 센서가 있어서 폴더나 슬라이드를 닫을 경우 센서에서 자력을 감지하여 닫힌 것을 인식하게 되는 원리로 핸즈프리 사용시 위와 같은 현상이 발생할 수 있습니다.) 
