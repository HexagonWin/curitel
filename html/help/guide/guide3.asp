...
<tr> 
	<td width="77" height="77" valign="top" style="background:url(/img/help/titleleftbg.gif) repeat-x left top">
		...
		<input type=hidden name=rurl value="/html/help/guide/guide3.asp">
					<tr>
					...
					<td valign="top" class="ctsmgn">
						...
						<tr>
							<td style="padding:20 0 0 0;" height=26>
								...
								<tr>
									<td width=472>
									<a href="index.asp"><img src="/img/help/guide/tab1.gif"></a><a href="guide2.asp"><img src="/img/help/guide/tab2.gif"></a><a href="guide3.asp"><img src="/img/help/guide/tab3_o.gif"></a><a href="guide4.asp"><img src="/img/help/guide/tab4.gif"></a><br>
									</td>
								...
								<tr>
									...
									<img src="/img/help/guide/txt03_1.gif" width="388" height="70"><br>
									환경오염과 자원낭비의 원인입니다.<br>
									㈜팬택&큐리텔에서는 친 환경 문화 실현을 위해 폐 휴대폰 수거에 앞장서고 있습니다.<br>
									가까운 큐리텔 서비스센터로 가지고 오시면 책임지고 환경 친화적으로 재활용하겠습니다.<br><br>

									폐 휴대폰은 다음과 같이 재활용 됩니다.<br><br>
									<img src="/img/help/guide/img_3.gif" width="537" height="154"><br>
									</td>
								</tr>
								</table>
