...
<tr> 
	<td width="77" height="77" valign="top" style="background:url(/img/help/titleleftbg.gif) repeat-x left top">
		...
		<input type=hidden name=rurl value="/html/help/guide/guide1_3.asp">
					<tr>
					...
					<td valign="top">
						...
						<tr>
					       <td align="center">
							...
							<script language="JavaScript">flash('/inc/flash/left/left_help.swf?html_Num=00&ismonitoring=','100','367');</script>
					...
					<td valign="top" class="ctsmgn">
						...
						<tr>
							<td style="padding:20 0 0 0;" height=26>
								...
								<tr>
									<td width=472>
									<a href="index.asp"><img src="/img/help/guide/tab1_o.gif"></a><a href="guide2.asp"><img src="/img/help/guide/tab2.gif"></a><a href="guide3.asp"><img src="/img/help/guide/tab3.gif"></a><a href="guide4.asp"><img src="/img/help/guide/tab4.gif"></a><br>
									</td>
								...
								<tr>
									<td align=center>
									<img src="/img/help/guide/ttbox1_3.gif" width="510" height="95" usemap=#Map_box><br><br>
<map name="Map_box">
	<area shape="rect" coords="8,12,113,30" href="index.asp">
	<area shape="rect" coords="8,38,96,56" href="guide1_2.asp">
	<area shape="rect" coords="8,64,135,82" href="guide1_3.asp">
</map>
								...
								<tr>
									...
									<img src="/img/help/guide/tt01_3.gif"><br><br>
									<b>&#149; 운전중 휴대폰 사용에 대한 관련 법규 또는 도로 안전 수칙을 숙지하시고 지켜주십시오.</b><br><br>
 

									<b>&#149; 운전중 휴대폰 사용은 매우 위험하므로 가능한 사용하지 말 것을 권고합니다. </b><br><br>


									<b>&#149; <span style="width:540;margin:-1 0 3 0;vertical-align:top;">운전중에 꼭 통화가 필요한 경우에는 반드시 관련 법규를 준수하시고 핸즈프리나 이어마이크를 사용한 간단한 통화를 권장합니다. 최근의 연구 결과는 운전중 휴대폰 사용이 운전자의 주의를 분산시켜 교통사고의 위험이 높아짐을 입증하고 있으므로 반드시 안전한 곳에 차를 세우고 통화하세요.</span></b><br><br>


									<b>&#149; 휴대폰은 잡기 편한 위치에 두세요. </b><br>
									- 시선을 도로에서 떼지 않고 잡을 수 있는 위치에 두세요. <br>
									- <span style="width:540;margin:-1 0 3 0;vertical-align:top;">운전에 방해가 되는 위치나, 에어백이 장착된 차량에서 에어백 팽창범위 내, 또는 유사시 신체에 직접적인 손상을 줄 우려가 있는 위치를 피하여 설치하십시오.</span><br><br>


									<b>&#149; 만약 전화를 받기 힘든 상황이면 전화를 받지 말고 음성사서함으로 연결되도록 해 두십시오 </b><br><br>


									<b>&#149; <span style="width:540;margin:-1 0 3 0;vertical-align:top;">운전중에 통화를 하게 되면 통화하는 상대방에게 운전중임을 알리고 통화를 짧게 끝내도록 하세요.</span></b><br><br>


									<b>&#149; 운전 도중에 휴대폰을 조작하거나 전화번호를 찾지 마세요. </b><br><br>


									<b>&#149; 분별있게 전화를 하고 신호를 지키세요. </b><br>
									- 가능하면 차가 정지한다든지 신호등에 걸려 있을 때 전화를 하세요. <br><br>


									<b>&#149; 신경질적이거나 감정적인 대화를 피하도록 하세요. </b><br>
									- <span style="width:540;margin:-1 0 3 0;vertical-align:top;">전화하는 상대에게 자신이 운전을 하고 있다는 것을 알리고 도로에서 시선을 집중시키지 못할만한 심각한 통화는 사고의 원인이 될 수 있습니다.</span><br>
