...
<tr> 
	<td width="77" height="77" valign="top" style="background:url(/img/help/titleleftbg.gif) repeat-x left top">
		...
		<input type=hidden name=rurl value="/html/help/accessory/index.asp">
					<tr>
...
<tr> 
	<td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a> > <a href="/html/help/index.asp">HELP DESK</a> > 액세서리</td>
</tr>
</table>
</div>
					...
					<td valign="top">
						...
						<tr>
					       <td align="center">
							...
							<script language="JavaScript">flash('/inc/flash/left/left_help.swf?html_Num=50&ismonitoring=','100','350');</script>
							<!-- <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100" height="367">
					               <param name="movie" value="/inc/flash/left/left_help.swf?html_Num=50&ismonitoring=">
					               <param name="quality" value="high">
					               <embed src="/inc/flash/left/left_help.swf?html_Num=50&ismonitoring=" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100" height="367"></embed></object> -->
				...
				<tr>
					<td valign="top" class="ctsmgn">
						...
						<table width="537" cellpadding="0" cellspacing="0" border="0">
						  <tr>
							<td><img src="/img/help/accessory/subimg00.gif" width="537" height="97" alt="" border="0"></td>
						  </tr>
						  <tr>
						  ...
						  <tr>		
			                <td style="padding:20 0 11 10"><img src="/img/help/accessory/tis_02.gif"></td>
						  </tr>
						  <tr>
							<td align="right"> 
							  <!--- 검색 --->
							<script>
	function accSearch(){
		form = document.accSearch;
		if(!form.a_type.value){
			alert("액세사리 종류를 선택하세요");
			return;
		}
		form.action = "model.asp"
		form.submit();
	}
</script>

<form name="accSearch" method="post">
							  <table width="529" cellpadding="0" cellspacing="0" border="0">
								<tr> 
								  <td><img src="/img/common/gredge01.gif" width="5" height="5" alt="" border="0"></td>
								  <td width="523" height="5" colspan="2" background="/img/common/grabg01.gif"><img src="/img/b.gif" width="1" height="1"></td>
								  <td><img src="/img/common/gredge02.gif" width="5" height="5" alt="" border="0"></td>
								</tr>
								<tr> 
								  <td background="/img/common/grabg02.gif" height="5"><img src="/img/b.gif" width="1" height="1"></td>
								  <td width="124" height="37" align="center" bgcolor="#F1F1F1"><img src="/img/help/accessory/t_model.gif" width="84" height="20"></td>
								  <td width="395" bgcolor="#F1F1F1">
									<select name="a_type" style="width:160">										
									  <option value="">액서서리종류</option>
									  <option value='45'>Bluetooth Stereo Ear Phone<br>(4극 Ear Jack)</option><option value='27'>이어잭 젠더<br>(14핀 핸즈프리용)</option><option value='25'>이어잭 젠더<br>(4극)</option><option value='23'>Stereo Ear Phone <br> (14극, 12극)</option><option value='22'>Stereo Ear Phone (HS8000용)</option><option value='21'>이어폰<br>(4핀 Ear Jack 귀걸이용)</option><option value='20'>TV-OUT CABLE<br>(PH-L4000V용)</option><option value='18'>Mono Ear Phone<br> (3핀 Ear Jack)</option><option value='17'>SD카드 홀더</option><option value='16'>TV-OUT CABLE<br>(PH-S3000V, S5000V용)</option>
									</select> 
									<select name="acc_service" style="width:100">
									  <option value="">통신사</option>
									  <option value="SKT">SKT</option>
									  <option value="KTF">KTF</option>
									  <option value="LGT">LGT</option>
									</select> 
<!--								<select name="select3" style="width:190">
									  <option>모델명</option>
									</select>
-->
									<a href="javascript:accSearch()"><img src="/img/btn/btn_search02.gif" align="absmiddle"></a></td>
								...
								<tr> 
								  ...
								  <td height="5" colspan="2"  background="/img/common/grabg04.gif"><img src="/img/b.gif" width="1" height="1"></td>
						...
						<!--- 액서서리 리스트 --->	
							...
							<iframe src="/html/product/accessory/if_index.asp?sector=help" scrolling="No" frameborder="0" width="548" height="630"></iframe>
							</table>
						<!--- 액서서리 리스트 끝 --->	
			            <!-- #####//Contents End ##### -->
					</td>
