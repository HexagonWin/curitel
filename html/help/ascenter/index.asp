...
function searchTxt(frm)
{
     if(frm.sword.value=="" || frm.sword.value==" +++센터 이름을 입력하세요+++ ")
     {
          alert("센터명을 입력하세요 ~");
          frm.sword.focus();
          return false;
...
<tr> 
	<td width="77" height="77" valign="top" style="background:url(/img/help/titleleftbg.gif) repeat-x left top">
		...
		<input type=hidden name=rurl value="/html/help/ascenter/index.asp">
					<tr>
			...
			<table width="597" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td valign="top" class="ctsmgn">
						...
						<tr><td><img src="/img/help/ascenter/subimg01.gif" width="537" height="97"></td></tr>
						...
						<tr valign=top>
							<td width=199><img src="/img/help/ascenter/main_img01.gif" width="199" height="155" alt="" border="0"></td>
							<td width=358>
								<table cellpadding=0 cellspacing=0 border=0 width=100%>
								<tr><td><img src="/img/help/ascenter/main_t01.gif" width="225" height="49" alt="" border="0"></td></tr>
								<form method=post action="center_list.asp" onsubmit="return searchTxt(this)">
								<tr valign=top>
									<td style="padding:0 0 0 11" height=25 valign=top>
										<input type="text" name="sword" class="input_g" style="width:225" onFocus="this.value=''" value=" +++센터 이름을 입력하세요+++ ">
										<input type=image src="/img/bbs/btn/btn_search.gif" align=absmiddle>
									</td>
								</tr>
								     <input type=hidden name=scategory value="title">
								</form>
								<tr><td  height=11 class=line></td></tr>
								<tr><td><img src="/img/help/ascenter/main_t02.gif" width="230" height="24" alt="" border="0"></td>
								</tr>
								<tr>
									<td style="padding:0 0 0 6" height=40 valign=top>
										<table cellpadding=6 cellspacing=0 border=0 bgcolor=#F2F2F2>
										<tr>
											<td  style="padding:6 5"><input type="text" name="" style="color:#707070;width:322;height:19;border:1px solid #CCCCCC;font-size:8pt" value="‘바로 여러분 가까이 항상 대기 하겠습니다. 큐리텔 콜센터 : 1544-4424’"></td>
										</tr>
										</table>
									</td>
								</tr>
						...
						<tr>
							<td><img src="/img/help/ascenter/main_tit01.gif" width="192" height="14" alt="" border="0"></td>
						</tr>
                      ...
                      <td width=220 align="center"> <img src="/img/help/ascenter/main_img02.gif" alt="" width="140" height="197" border="0" usemap="#map"><br>
										<map name="map">
                          <area alt="" coords="11,29,61,61" href="areacenter_list.asp?sido=경기" onFocus="this.blur()">
                                        
                          <area alt="" coords="86,23,130,54" href="areacenter_list.asp?sido=강원" onFocus="this.blur()">
                                        
                          <area alt="" coords="87,98,134,129" href="areacenter_list.asp?sido=경북" onFocus="this.blur()">
                                        
                          <area alt="" coords="7,80,45,105" href="areacenter_list.asp?sido=충남" onFocus="this.blur()">
                                        
                          <area shape="rect" coords="49,87,82,120" href="areacenter_list.asp?sido=충북" onFocus="this.blur()">
                                        
                          <area shape="rect" coords="18,124,57,154" href="areacenter_list.asp?sido=전북" onFocus="this.blur()">
                                        
                          <area alt="" coords="69,139,122,172" href="areacenter_list.asp?sido=경남" onFocus="this.blur()">
                                        
                          <area alt="" coords="12,163,56,194" href="areacenter_list.asp?sido=전남" onFocus="this.blur()">
                                        <!-- area alt="" coords="60,143,103,169" href="#전라북도"-->
                                    </map>
									</td>
                                             <form name=zipcode onsubmit="return search(this)" action="areacenter_list.asp" method=post>
									<td width=310>
										<table cellpadding=0 cellspacing=0 border=0>
											<tr>
												<td style="padding:10 0 0 0"><img src="/img/help/ascenter/main_img03.gif" width="302" height="98" alt="" border="0"></td>
											</tr>
     										<tr>
												<td bgcolor=#F2F2F2 style="padding:6 20;border-left:6px solid white;border-right:6px solid white">
						...
						<!--
						<tr>
							<td class="line" height=11></td>
						</tr>
						<tr><td height=10></td></tr>
						<tr><td><img src="/img/help/ascenter/main_tit02.gif" width="218" height="14" alt="" border="0"></td></tr>
						<tr><td height=15></td></tr>
						<tr>
						-->
							<td>
