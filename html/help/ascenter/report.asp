...
function sendData()
{
	...
	if ( frm.sword.value == "" || frm.sword.value.length == 0){
...
<tr> 
	<td width="77" height="77" valign="top" style="background:url(/img/help/titleleftbg.gif) repeat-x left top">
		...
		<input type=hidden name=rurl value="/html/help/ascenter/report.asp">
					<tr>
...
<tr>
	<td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a> > <a href="/html/help/index.asp">HELP DESK</a> > <a href="/html/help/ascenter/index.asp">전국 서비스센터</a> > A/S 센터 탐방기</td>
</tr>
</table>
</div>
<table width="829" height="800" cellspacing="0" cellpadding="0" border="0" class="mubg_gra">
	<tr>
		<td width="77"><img src="/b.gif" width="77" height="1"></td>
					...
					<td valign="top">
						...
						<tr>
					       <td align="center">
							...
							<script language="JavaScript">flash('/inc/flash/left/left_help.swf?html_Num=32&ismonitoring=','100','367');</script>
							<!-- <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100" height="367">
					               <param name="movie" value="/inc/flash/left/left_help.swf?html_Num=32&ismonitoring=">
					               <param name="quality" value="high">
					               <embed src="/inc/flash/left/left_help.swf?html_Num=32&ismonitoring=" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100" height="367"></embed></object> -->
			...
			<table width="597" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td valign="top" class="ctsmgn">
						...
						<tr><td><img src="/img/help/ascenter/subimg03.gif" width="537" height="97"></td></tr>
						<tr><td bgcolor=#ffffff height=2></td></tr>
						<tr><td bgcolor=#F6F8F9 height=26></td></tr>
						<tr><td height="23"></td></tr>
						<tr>
							<td align="right"><table width="530" border="0" cellspacing="0" cellpadding="0" style="margin-bottom:7">
                    <tr>
                      <td><img src="/img/help/ascenter/tit_as01.gif" width="96" height="14"></td>
                      <td align="right">

                   	  </td>
                    </tr>
                    <tr>
                      <td colspan="2"><img src="/img/help/ascenter/t_as01.gif" width="392" height="30" hspace="9" vspace="7"></td>
                    </tr>
                  </table>
                  <!------- LIST Start------------->
                  <table width="530" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
					  <td height="33" colspan="5" style="border-bottom:1px solid #c9c9c9;padding:0 8 0 0">
					  	<form name=searchFrm method=post >
					  	<table width="100%" border="0" cellspacing="0" cellpadding="0">
						  <tr>
							<td align="right"><select name="scategory" style="width:97">
								<option value='title'   >센타명
								<option value='address' >센타주소 </select> <input name="sword" type="text" style="width:120" value="">
							  <a href="javascript:sendData();"><img src="/img/bbs/btn/btn_search.gif" width="46" height="17" alt="" border="0" align="absmiddle"></a></td>
						  </tr>
						</table>
						</form>
						 </td>
							  ...
							  <table width="530" cellpadding="0" cellspacing="0" border="0">
								<tr><td bgcolor="#D4D4D4" colspan="5" height="1"></td></tr>
								<tr><td colspan="4" height="3"></td></tr>
								<tr align="center">
								  <td width="65" class="field01" height="25">지역</td>
								  <td width="150" class="field02">탐방센터</td>
								  <td width="100" class="field02">탐방고객</td>
								  <td width="205" class="field03"><table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0">
									  <tr>
										<td class="field02" align="center">탐방일시</td>
									  </tr>
									</table></td>
								</tr>
								<tr>
								...
								<tr bgcolor="#FFFFFF">
									<td align="center" colspan=4>데이타가 없습니다.</td>
								</tr>
								...
								<tr>
								  <td colspan="4" height="42" bgcolor="#f2f2f2" align=right>
								...
								<tr>
								  <td colspan="4" height="42">&nbsp;<b>|1|</b></td>
								</tr>
							  </table>
							  <!------- LIST End ------------->
							</td>
