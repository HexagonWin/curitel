...
<tr> 
	<td width="77" height="77" valign="top" style="background:url(/img/help/titleleftbg.gif) repeat-x left top">
		...
		<input type=hidden name=rurl value="/html/help/support/search_fast.asp">
					<tr>
			...
			<table width="597" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td valign="top" class="ctsmgn">
						...
						<tr valign=top>
							<td width=199><img src="/img/help/support/fsearch_img01.gif" alt="" border="0"></td>
							<td width=358>
								<table style="margin-top:4" cellpadding=0 cellspacing=0 border=0 width=100%>
								<tr>
									<td><img src="/img/help/support/fsearch_img02.gif" width="242" height="76" alt="" border="0"></td>
								</tr>
								<tr>
						...
						<tr><td style="padding:15 0 0 7">
							...
							<tr>
								<td height="35" colspan="4" style="border-bottom:1px solid #c9c9c9;padding:0 8 0 10;">
									<font class=em>&#149; ' +++질문을 입력하세요+++ '</font> 으로 검색한 결과입니다.
									</tr>
									</table>
								</td>
							</tr>
							...
							<tr bgcolor="#FFFFFF">
								<td align="center" colspan=4>데이타가 없습니다.  다른 검색어로 검색해 주십시오</td>
							</tr>
