...
<table width="829" cellpadding="0" cellspacing="0" border="0" class="mubg_gra">
	<tr> 
		...
		<input type=hidden name=rurl value="/html/socool/sympathy/index.asp">
					<tr>
...
<input type=hidden name=rurl value="/html/socool/sympathy/index.asp">
					...
					<td width="164" align="right"><a href="/html/socool/index.asp" onfocus="this.blur()"><img src="/img/socool/channel_title.gif" width="164" height="65" alt="" border="0"></a></td>
				</tr>
				</table>
			</DIV>
		</td>
...
<div id="rpath" style="position:absolute;visibility:visible;left:232;top:197;width:596;height:15;z-index:10;"> 
		<table cellpadding="0" cellspacing="0" border="0" align="right">
				<tr> 
						<td height="15" align="right" class="rpath"><a href="/html/index.asp">Home</a> > <a href="/html/socool/index.asp">So Cooooool</a> > 쿨하게 남기자</td>
				</tr>
		</table>
</div>
			...
			<table width="148" height="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td valign="top">
						...
						<tr>							
					       <td align="center">
							<script language="JavaScript">flash('/inc/flash/left/left_socool.swf?html_Num=20','100','100');</script>
							<!-- <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100" height="100">
					               <param name="movie" value="/inc/flash/left/left_socool.swf?html_Num=20">
					               <param name="quality" value="high">
					               <embed src="/inc/flash/left/left_socool.swf?html_Num=20" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100" height="100"></embed></object> --></td>
						</tr>
		...
		<td width="564" valign="top" class="ctsmgn">
				...
				<tr> 
					<td height="26">
						...
						<tr><td><img src="/img/socool/subimg01.gif" width="537" height="97"></td></tr>
						<tr><td height="1"></td></tr>
						<tr><td height="26" bgcolor="#F6F8F9"></td></tr>
						</table>
					</td>
				</tr>
				<tr><td height="95"><img src="/img/socool/txt_socool.gif" alt="" border="0"></td></tr>
				<tr>
					<td>
                            ...
                            <tr> 
								...
								<form style="margin:0">
                                    <select name="ktype" style="width:97">
                                        <option value=1>제목 </option>
                                        <option value=2>내용 </option>
										<option value=3>아이디 </option>
										</select> <input name="kword" type="text" style="width:120" value=""> 
                                    <input type=image src="/img/bbs/btn/btn_search.gif" width="46" style="height:17" height="17" alt="" border="0" align="absmiddle">
								</form>
                                </td>
                            </tr>
                            <tr> 
                            ...
                            <tr align="center"> 
                                ...
                                <td width="319" class="field02">제목</td>
                                <td width="61" class="field02">Curian</td>
                                <td width="62" class="field02">날짜</td>
                                <td width="55" class="field03"> <table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0">
                                        <tr> 
                            ...
                            <colgroup>
                            <col align="center" style="padding:0 2 0 2">
							...
							<tr bgcolor="" align=center> 
								<td height="26"><img src=/img/common/btn_notice.gif></td>
								<td><a href="javascript:;" onclick="window.open('/html/popup/notice_read2.asp?t=socool_board','','width=630,height=500,scrollbars=1')">
								<font color=3595B1><B>'쿨하게남기자'를 이용하시는 분께 알려드립니다.</B></font></a></td>
								<td><!-- m4 -->curitel</td>
								<td>2004.08.19</td>
								<td>1268</td>
							</tr>	
                            ...
                            <tr bgcolor="#ffffff"> 
                                <td height="26">383</td>
                                <td><a href="index_view.asp?idx=1322&p=1">벨소리..ㅠ0ㅠ</a></td>
                                <td>sungmo8625</td>
                                <td>2004.09.01</td>
                                <td>46</td>
                            </tr>
                            ...
                            <tr bgcolor="#f4f6f7"> 
                                <td height="26">382</td>
                                <td><a href="index_view.asp?idx=1321&p=1">정회원이 될 방법없나여?</a></td>
                                <td>dkfmajjang</td>
                                <td>2004.08.31</td>
                                <td>42</td>
                            </tr>
                            ...
                            <tr bgcolor="#ffffff"> 
                                <td height="26">381</td>
                                <td><a href="index_view.asp?idx=1313&p=1">좋아요~~[1]</a></td>
                                <td>liebed</td>
                                <td>2004.08.30</td>
                                <td>58</td>
                            </tr>
                            ...
                            <tr bgcolor="#f4f6f7"> 
                                <td height="26">380</td>
                                <td><a href="index_view.asp?idx=1312&p=1">올해도 공짜 스키행사 하나요?[1]</a></td>
                                <td>jskimking</td>
                                <td>2004.08.30</td>
                                <td>66</td>
                            </tr>
                            ...
                            <tr bgcolor="#ffffff"> 
                                <td height="26">379</td>
                                <td><a href="index_view.asp?idx=1310&p=1">큐리텔 좋아요.[1]</a></td>
                                <td>soraklaw</td>
                                <td>2004.08.30</td>
                                <td>67</td>
                            </tr>
                            ...
                            <tr bgcolor="#f4f6f7"> 
                                <td height="26">378</td>
                                <td><a href="index_view.asp?idx=1309&p=1">길음동 A／S센터를 다녀오고난후 큐리텔이미지</a></td>
                                <td>icicmity</td>
                                <td>2004.08.30</td>
                                <td>87</td>
                            </tr>
                            ...
                            <tr bgcolor="#ffffff"> 
                                <td height="26">377</td>
                                <td><a href="index_view.asp?idx=1308&p=1">S4에 대하여..</a></td>
                                <td>crykang71</td>
                                <td>2004.08.30</td>
                                <td>75</td>
                            </tr>
                            ...
                            <tr bgcolor="#f4f6f7"> 
                                <td height="26">376</td>
                                <td><a href="index_view.asp?idx=1303&p=1">PH-K1000V／VT 빨리 출시 부탁합니다.</a></td>
                                <td>snrnrp</td>
                                <td>2004.08.29</td>
                                <td>66</td>
                            </tr>
                            ...
                            <tr bgcolor="#ffffff"> 
                                <td height="26">375</td>
                                <td><a href="index_view.asp?idx=1299&p=1">큐리텔 촬영음이 너무 커요![1]</a></td>
                                <td>say1303</td>
                                <td>2004.08.29</td>
                                <td>77</td>
                            </tr>
                            ...
                            <tr bgcolor="#f4f6f7"> 
                                <td height="26">374</td>
                                <td><a href="index_view.asp?idx=1296&p=1">큐리텔 사용자의 후기....</a></td>
                                <td>wlgns2980</td>
                                <td>2004.08.29</td>
                                <td>86</td>
                            </tr>
                                ...
                                <td height="42" colspan="5">
									...
									<tr>
										...
										<td width=70% align=center>
											<img src='/img/bbs/btn/btn_pre.gif' width='54' height='17' alt='' border='0' align='absmiddle' hspace='26'>&nbsp;<b>|1|</b>&nbsp;<a href=index.asp?page=2&ktype=1&kword=>|2|</a>&nbsp;<a href=index.asp?page=3&ktype=1&kword=>|3|</a>&nbsp;<a href=index.asp?page=4&ktype=1&kword=>|4|</a>&nbsp;<a href=index.asp?page=5&ktype=1&kword=>|5|</a>&nbsp;<a href=index.asp?page=6&ktype=1&kword=>|6|</a>&nbsp;<a href=index.asp?page=7&ktype=1&kword=>|7|</a>&nbsp;<a href=index.asp?page=8&ktype=1&kword=>|8|</a>&nbsp;<a href=index.asp?page=9&ktype=1&kword=>|9|</a>&nbsp;<a href=index.asp?page=10&ktype=1&kword=>|10|</a>&nbsp;<a href=index.asp?page=11&ktype=1&kword=><img src='/img/bbs/btn/btn_next.gif' width='54' height='17' alt='' border='0' align='absmiddle' hspace='26'></a>
										</td>
										<td width=15% align=right>
										
										<a href="javascript:confirmLogin()">
																					
											<img src="/img/bbs/btn/btn_write.gif" width="65" height="19" border="0" align="absmiddle"></a><br>
										</td>
									</tr>
									</table>
								</td>
							...
							<!--게시판 끝-->
							<table border="0" cellpadding="0" cellspacing="0"><tr><td style="padding:20 0 0 0"><img src="/img/common/notice_community.gif" alt=""></td></tr></table>
						</td>
					</tr>
					</table>
				<!-- #####//Contents End ##### -->
...
<script>document.all.ktype.value="1"</script>
